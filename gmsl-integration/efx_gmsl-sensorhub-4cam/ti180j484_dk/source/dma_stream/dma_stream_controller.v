...
parameter	CSI_TX_HSP				= 8'd150;//8'd150;      //8'd50;//8'd200; //'d176; //8'd44;
parameter	CSI_TX_HBP				= 8'd150;//8'd200;     //8'd100;//8'd400; //'d592; //8'd148;
parameter	CSI_TX_HFP				= 8'd150;//8'd150;      //8'd50;//8'd200; //'d352; //8'd88;
