...
(
	...
	output 			out_valid,
	output 			out_de,
	output 	[nChannel-1:0] out_hs,
	output 	[nChannel-1:0] out_vs,
...
reg			r_de_1P;
reg	[nChannel-1:0]		r_hs_1P;
reg	[nChannel-1:0]		r_vs_1P;
reg			r_valid_1P;
reg [nChannel-1:0]   r_Channel_1P;

reg			r_de_2P;
reg	[nChannel-1:0]		r_hs_2P;
reg	[nChannel-1:0]		r_vs_2P;
reg			r_valid_2P;
...
//		r_p_cnt			<= 3'd1;
		...
		r_de_1P			<= 1'b0;
		r_hs_1P			<= {nChannel{1'b1}}; //1'b1;
		r_valid_1P		<= 1'b0;
		r_vs_1P			<= {nChannel{1'b1}}; //1'b1;
        r_Channel_1P    <= 'd1;
        
		r_de_2P			<= 1'b0;
		r_hs_2P			<= {nChannel{1'b1}}; //1'b1;
		r_valid_2P		<= 1'b0;
		r_vs_2P			<= {nChannel{1'b1}}; //1'b1;
        r_Channel_2P    <= 'd1;
	end	
	else
	begin
		r_de_1P			<= r_de;
	    r_hs_1P			<= {nChannel {r_hs}} & r_Channel;
		r_vs_1P			<= {nChannel {r_vs}} & r_Channel;
