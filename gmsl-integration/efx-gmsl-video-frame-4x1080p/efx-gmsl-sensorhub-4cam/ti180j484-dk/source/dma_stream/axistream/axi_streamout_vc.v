...
input 	[NUM_CHANNEL-1:0]	in_ch_id,
input 			in_valid,
input 			in_de,
input 			in_hs,
input 			in_vs,
...
localparam    NUM_CHANNEL = 2 ** CHANNEL_WIDTH;
...
(
  ...
  .we 		(r_line_in_1L),
  .re 		(r_line_in_2L),
  .data_in 	({in_ch_id, in_de, in_valid, in_hs, in_vs}			),
  .data_out ({w_ch_id_2L, w_de_2L, w_valid_2L, w_hsync_2L, w_vsync_2L}	)
 );
