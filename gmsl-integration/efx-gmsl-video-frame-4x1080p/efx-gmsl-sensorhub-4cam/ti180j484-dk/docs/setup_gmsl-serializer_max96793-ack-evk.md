...
2. Open ADI GMSL SerDes GUI on PC. In the main GUI, select **Tools** > **Other Config** > **SET CFG Pin Levels**.
    - If the Serializer is connected to STP cable, set CFG0 = 0 and CFG1 = 0, and click **Program Serializer**  
   (I2C Mode, Address 0x80, RoR; STP, 6Gbps, NRZ, Tunnel Mode)  
       If the Serializer is connected to Coaxial cable, set CFG0 = 0 and CFG1 = 4, and click **Program Serializer**  
