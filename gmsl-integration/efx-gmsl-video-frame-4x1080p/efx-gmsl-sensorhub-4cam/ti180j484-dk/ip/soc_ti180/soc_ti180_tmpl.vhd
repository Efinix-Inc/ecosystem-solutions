...
port (
    ...
    io_ddrMasters_0_r_payload_data : out std_logic_vector(511 downto 0);
    ...
    io_ddrMasters_0_w_payload_strb : in std_logic_vector(63 downto 0);
    io_ddrMasters_0_w_payload_data : in std_logic_vector(511 downto 0);
...
end component soc_ti180;

---------------------- End COMPONENT Declaration ------------
------------- Begin Cut here for INSTANTIATION Template -----
u_soc_ti180 : soc_ti180
port map (
