...
module axi_streamout_VirtualCh
#(
...
input 	in_hs,
input 	in_vs,
input   [nCHANNEL-1:0] in_channel,
input   [nCHANNEL-1:0] in_hs_ch,
input   [nCHANNEL-1:0] in_vs_ch,
...
output  wire [nCHANNEL-1:0] out_hsync_ch,
output  wire [nCHANNEL-1:0] out_vsync_ch,
...
wire [nCHANNEL-1:0]	w_hsync_ch_2L;
wire [nCHANNEL-1:0] w_vsync_ch_2L;
	...
	begin
		...
		START_LINE:
			begin
				...
				if(r_de_buffer) 
					r_de_buffer_count <= r_de_buffer_count +1'b1;
...
fifo 
#(
	.DATA_WIDTH(4 + nCHANNEL + nCHANNEL),
    .ADDR_WIDTH(13 )
)	   
inst_fifo_sync 
(
  ...
  .we 		(r_line_in_1L),
  .re 		(r_line_in_2L),
  .data_in 	({in_de, in_valid, in_hs, in_vs, in_hs_ch, in_vs_ch}			),
  .data_out ({w_de_2L, w_valid_2L, w_hsync_2L, w_vsync_2L, w_hsync_ch_2L, w_vsync_ch_2L }	)
 );
...
reg r_hsync_2L;
reg r_vsync_2L;
reg [nCHANNEL-1:0] r_hsync_ch_2L;
reg [nCHANNEL-1:0] r_vsync_ch_2L;
...
begin
	...
	begin
		...
		r_hsync_2L <= 1'b0;
		r_vsync_2L <= 1'b0;
        r_hsync_ch_2L <= {nCHANNEL{1'b0}};
        r_vsync_ch_2L <= {nCHANNEL{1'b0}};
    ...
    begin
        ...
        r_hsync_ch_2L <= w_hsync_ch_2L;
        r_vsync_ch_2L <= w_vsync_ch_2L;
    end
end
...
assign out_hsync_ch = r_hsync_ch_2L;
assign out_vsync_ch = r_vsync_ch_2L;
