...
port (
    ...
    ctrl_interrupts : out std_logic_vector(6 downto 0);
    ...
    dat6_o_tvalid : out std_logic;
    dat6_o_tready : in std_logic;
    dat6_o_tdata : out std_logic_vector(31 downto 0);
    dat6_o_tkeep : out std_logic_vector(3 downto 0);
    dat6_o_tdest : out std_logic_vector(3 downto 0);
    dat6_o_tlast : out std_logic;
    ...
    dat6_o_clk : in std_logic;
    dat6_o_reset : in std_logic;
    ...
    io_6_descriptorUpdate : out std_logic;
...
port map (
    ...
    dat6_o_tvalid => dat6_o_tvalid,
    dat6_o_tready => dat6_o_tready,
    dat6_o_tdata => dat6_o_tdata,
    dat6_o_tkeep => dat6_o_tkeep,
    dat6_o_tdest => dat6_o_tdest,
    dat6_o_tlast => dat6_o_tlast,
    ...
    dat6_o_clk => dat6_o_clk,
    dat6_o_reset => dat6_o_reset,
    ...
    io_6_descriptorUpdate => io_6_descriptorUpdate,
