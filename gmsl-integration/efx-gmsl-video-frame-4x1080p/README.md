# GMSL Integration: Per-Frame Mode 4x1080P
...
# Getting Start
### Configurating GMSL Sensor Hub (4 IMX219 Cameras)
...
* [Setup Guide: Video Grabber (HDMI) - ADI GMSL Deserializer (MAX96792A-BCK-EVK#)](efx-gmsl-video-grabber-hdmi/ti180j484-dk/docs/setup_gmsl-deserializer_max96792a-bck-evk.md)
...
1. Connecting the Sensor Hub Deserializer and Video Grabber Serializer using GMSL link cable, and connect a monitor with HDMI cable.  
