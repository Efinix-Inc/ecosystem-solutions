...
port (
    ...
    dat2_o_tdata : out std_logic_vector(7 downto 0);
    dat2_o_tkeep : out std_logic_vector(0 to 0);
    ...
    dat3_i_tdata : in std_logic_vector(7 downto 0);
    dat3_i_tvalid : in std_logic;
    dat3_i_tready : out std_logic;
    dat3_i_tkeep : in std_logic_vector(0 to 0);
    ...
    sg_rsp_channelId : in std_logic_vector(1 downto 0);
    ...
    sg_cmd_channelId : out std_logic_vector(1 downto 0)
);
end component dma_inst0;

---------------------- End COMPONENT Declaration ------------
------------- Begin Cut here for INSTANTIATION Template -----
u_dma_inst0 : dma_inst0
port map (
    clk => clk,
