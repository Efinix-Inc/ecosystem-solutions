...
## CFG PIN Settings
1. Connect the serializer board to the PC through USB and power up with 12V DC Supply.
2. Open ADI GMSL SerDes GUI on PC. In the main GUI, select **Tools** > **Other Config** > **SET CFG Pin Levels**.
    - If the Serializer is connected to STP cable, set CFG0 = 0 and CFG1 = 1, and click **Program Serializer**  
   (I2C Mode, Address 0x80, RoR; STP, 12Gbps, RAM4, Tunnel Mode)  
       If the Serializer is connected to Coaxial cable, set CFG0 = 0 and CFG1 = 5, and click **Program Serializer**  
   (I2C Mode, Address 0x80, RoR; Coaxial Cable, 12Gbps, RAM4, Tunnel Mode)  


    <img src="images/gmsl_4cam_sh_SerDesGUI_CFG-settings.png" alt="ADI GMSL Serializer (MAX96793) CFG Pin Levels GUI" width="200">  
...
5. On the ADI Serializer CSI-2 to GMSL Adapter, select S2 to 3V3 -> CAM 1. For details, refer to [AD-GMSLCAMRPI-ADP# Schematics](https://wiki.analog.com/_media/resources/eval/user-guides/02_075922a_top.pdf)
