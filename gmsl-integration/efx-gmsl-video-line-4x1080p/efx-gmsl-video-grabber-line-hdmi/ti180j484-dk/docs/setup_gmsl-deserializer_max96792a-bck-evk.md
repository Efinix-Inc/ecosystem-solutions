...
3. if the Deserializer is connected to STP cable , set CFG0 = 0 and CFG1 = 1, and click **Program Deserializer**  
   (I2C Mode, Address 0x80, RoR; STP, 12Gbps, RAM4, Tunnel Mode)  
   if the Deserializer is connected to Coaxial cable , set CFG0 = 0 and CFG1 = 5, and click **Program Deserializer**  
