...
1. **Prepare the daughter cards**  
   - Connect the HDMI Connector Daughter Card with a monitor. And attach onto FMC-to-QSE Adapter Card **J1**
...
3. **Connect the ADI GMSL Deserializer EVK**  
   - Use 22-pin FFC Cable (Type A) to connect IMX477 Camera Connector Daughter Card (**FPC1**, bottom connector) with the ADI GMSL Deserializer EVK (Adapter: **P8**) and insert it onto the Ti180J484 Development Board **P1**.  
...
4. **Configure jumper settings**  
   ...
   <img src="images/gmsl_4cam_vg_final-hw-setup.png" alt="Video Grabber Hardware Setup" width="800">  
...
5. **FPGA Configuration**  
   ...
   - Choose the efx-gmsl-video-grabber-line-hdmi-4x1080p_combined.hex in prebuild/efx-gmsl-video-line-4x1080p/quickstart folder (from release build)
