...
# Version: 2022.2.322.6.3
# Date: 2023-05-24 12:27
...
create_clock -period 3.7000 i_pixel_clk
create_clock -period 10.0000 rx_cfgclk
create_clock -period 50.0000 tx_escclk
create_clock -period 5.0 i_pixel_clk_tx
create_clock -period 10.0000 i_sys_clk
create_clock -period 10.0000 i_sd_clk
create_clock -period 10.0000 i_axi0_mem_clk
create_clock -period 5.8934  i_axi1_mem_clk
...
set_clock_groups -exclusive  -group {i_soc_clk} -group {i_axi0_mem_clk} -group {i_axi1_mem_clk} -group {jtag_inst1_TCK} -group {i_pixel_clk}  -group {i_pixel_clk_tx} -group {i_sys_clk} -group {i_hdmi_clk} -group {rx_cfgclk} -group {tx_escclk} -group {mipi_clk} -group {i_sys_clk_25mhz}


# GPIO Constraints
####################
create_clock -period <USER_PERIOD> [get_ports {i_osc5_ref_clk_mipi1}]
create_clock -period <USER_PERIOD> [get_ports {i_osc5_ref_clk_mipi2}]
create_clock -period <USER_PERIOD> [get_ports {i_osc5_ref_clk_mipi3}]
...
set_output_delay -clock i_sd_clk -reference_pin [get_ports {i_sd_clk~CLKOUT~333~610}] -max 0.079 [get_ports {sd_clk_hi}]
set_output_delay -clock i_sd_clk -reference_pin [get_ports {i_sd_clk~CLKOUT~333~610}] -min -0.045 [get_ports {sd_clk_hi}]
...
set_input_delay -clock i_sd_clk -reference_pin [get_ports {i_sd_clk~CLKOUT~333~605}] -max 0.691 [get_ports {sd_cmd_i}]
set_input_delay -clock i_sd_clk -reference_pin [get_ports {i_sd_clk~CLKOUT~333~605}] -min 0.461 [get_ports {sd_cmd_i}]
set_output_delay -clock i_sd_clk -reference_pin [get_ports {i_sd_clk~CLKOUT~333~606}] -max 0.079 [get_ports {sd_cmd_o}]
set_output_delay -clock i_sd_clk -reference_pin [get_ports {i_sd_clk~CLKOUT~333~606}] -min -0.045 [get_ports {sd_cmd_o}]
set_output_delay -clock i_sd_clk -reference_pin [get_ports {i_sd_clk~CLKOUT~333~606}] -max 0.061 [get_ports {sd_cmd_oe}]
set_output_delay -clock i_sd_clk -reference_pin [get_ports {i_sd_clk~CLKOUT~333~606}] -min -0.026 [get_ports {sd_cmd_oe}]
...
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.559 [get_ports {mipi_dphy_rx_inst1_ERR_SOT_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.040 [get_ports {mipi_dphy_rx_inst1_ERR_SOT_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.570 [get_ports {mipi_dphy_rx_inst1_ERR_SOT_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.046 [get_ports {mipi_dphy_rx_inst1_ERR_SOT_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.745 [get_ports {mipi_dphy_rx_inst1_ERR_SOT_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.163 [get_ports {mipi_dphy_rx_inst1_ERR_SOT_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.584 [get_ports {mipi_dphy_rx_inst1_ERR_SOT_SYNC_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.056 [get_ports {mipi_dphy_rx_inst1_ERR_SOT_SYNC_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.560 [get_ports {mipi_dphy_rx_inst1_RX_ACTIVE_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.040 [get_ports {mipi_dphy_rx_inst1_RX_ACTIVE_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.493 [get_ports {mipi_dphy_rx_inst1_RX_ACTIVE_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 0.995 [get_ports {mipi_dphy_rx_inst1_RX_ACTIVE_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.698 [get_ports {mipi_dphy_rx_inst1_RX_DATA_HS_LAN2[*]}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.132 [get_ports {mipi_dphy_rx_inst1_RX_DATA_HS_LAN2[*]}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.734 [get_ports {mipi_dphy_rx_inst1_RX_DATA_HS_LAN3[*]}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.156 [get_ports {mipi_dphy_rx_inst1_RX_DATA_HS_LAN3[*]}]
...
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.717 [get_ports {mipi_dphy_rx_inst1_RX_SKEW_CAL_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.145 [get_ports {mipi_dphy_rx_inst1_RX_SKEW_CAL_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.583 [get_ports {mipi_dphy_rx_inst1_RX_SKEW_CAL_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.056 [get_ports {mipi_dphy_rx_inst1_RX_SKEW_CAL_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.583 [get_ports {mipi_dphy_rx_inst1_RX_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.056 [get_ports {mipi_dphy_rx_inst1_RX_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.536 [get_ports {mipi_dphy_rx_inst1_RX_SYNC_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.024 [get_ports {mipi_dphy_rx_inst1_RX_SYNC_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.563 [get_ports {mipi_dphy_rx_inst1_RX_VALID_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.042 [get_ports {mipi_dphy_rx_inst1_RX_VALID_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.582 [get_ports {mipi_dphy_rx_inst1_RX_VALID_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.055 [get_ports {mipi_dphy_rx_inst1_RX_VALID_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.591 [get_ports {mipi_dphy_rx_inst1_STOPSTATE_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.060 [get_ports {mipi_dphy_rx_inst1_STOPSTATE_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -max 1.613 [get_ports {mipi_dphy_rx_inst1_STOPSTATE_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst1_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst1_WORD_CLKOUT_HS~CLKOUT~1~38}] -min 1.075 [get_ports {mipi_dphy_rx_inst1_STOPSTATE_LAN3}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst2_WORD_CLKOUT_HS [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst2_LP_CLK [get_ports {mipi_dphy_rx_inst2_LP_CLK}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst2_ESC_LAN0_CLK [get_ports {mipi_dphy_rx_inst2_ESC_LAN0_CLK}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst2_ESC_LAN1_CLK [get_ports {mipi_dphy_rx_inst2_ESC_LAN1_CLK}]
...
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.559 [get_ports {mipi_dphy_rx_inst2_ERR_SOT_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.040 [get_ports {mipi_dphy_rx_inst2_ERR_SOT_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.570 [get_ports {mipi_dphy_rx_inst2_ERR_SOT_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.046 [get_ports {mipi_dphy_rx_inst2_ERR_SOT_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.745 [get_ports {mipi_dphy_rx_inst2_ERR_SOT_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.163 [get_ports {mipi_dphy_rx_inst2_ERR_SOT_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.584 [get_ports {mipi_dphy_rx_inst2_ERR_SOT_SYNC_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.056 [get_ports {mipi_dphy_rx_inst2_ERR_SOT_SYNC_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.560 [get_ports {mipi_dphy_rx_inst2_RX_ACTIVE_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.040 [get_ports {mipi_dphy_rx_inst2_RX_ACTIVE_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.493 [get_ports {mipi_dphy_rx_inst2_RX_ACTIVE_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 0.995 [get_ports {mipi_dphy_rx_inst2_RX_ACTIVE_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.698 [get_ports {mipi_dphy_rx_inst2_RX_DATA_HS_LAN2[*]}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.132 [get_ports {mipi_dphy_rx_inst2_RX_DATA_HS_LAN2[*]}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.734 [get_ports {mipi_dphy_rx_inst2_RX_DATA_HS_LAN3[*]}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.156 [get_ports {mipi_dphy_rx_inst2_RX_DATA_HS_LAN3[*]}]
...
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.717 [get_ports {mipi_dphy_rx_inst2_RX_SKEW_CAL_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.145 [get_ports {mipi_dphy_rx_inst2_RX_SKEW_CAL_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.583 [get_ports {mipi_dphy_rx_inst2_RX_SKEW_CAL_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.056 [get_ports {mipi_dphy_rx_inst2_RX_SKEW_CAL_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.583 [get_ports {mipi_dphy_rx_inst2_RX_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.056 [get_ports {mipi_dphy_rx_inst2_RX_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.536 [get_ports {mipi_dphy_rx_inst2_RX_SYNC_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.024 [get_ports {mipi_dphy_rx_inst2_RX_SYNC_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.563 [get_ports {mipi_dphy_rx_inst2_RX_VALID_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.042 [get_ports {mipi_dphy_rx_inst2_RX_VALID_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.582 [get_ports {mipi_dphy_rx_inst2_RX_VALID_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.055 [get_ports {mipi_dphy_rx_inst2_RX_VALID_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.591 [get_ports {mipi_dphy_rx_inst2_STOPSTATE_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.060 [get_ports {mipi_dphy_rx_inst2_STOPSTATE_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -max 1.613 [get_ports {mipi_dphy_rx_inst2_STOPSTATE_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst2_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst2_WORD_CLKOUT_HS~CLKOUT~1~81}] -min 1.075 [get_ports {mipi_dphy_rx_inst2_STOPSTATE_LAN3}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst3_WORD_CLKOUT_HS [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst3_LP_CLK [get_ports {mipi_dphy_rx_inst3_LP_CLK}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst3_ESC_LAN0_CLK [get_ports {mipi_dphy_rx_inst3_ESC_LAN0_CLK}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst3_ESC_LAN1_CLK [get_ports {mipi_dphy_rx_inst3_ESC_LAN1_CLK}]
...
# set_input_delay -clock <CLOCK> -max 4.925 [get_ports {mipi_dphy_rx_inst3_RX_ULPS_ESC_LAN2}]
# set_input_delay -clock <CLOCK> -min 3.283 [get_ports {mipi_dphy_rx_inst3_RX_ULPS_ESC_LAN2}]
# set_input_delay -clock <CLOCK> -max 3.289 [get_ports {mipi_dphy_rx_inst3_RX_ULPS_ESC_LAN3}]
# set_input_delay -clock <CLOCK> -min 2.192 [get_ports {mipi_dphy_rx_inst3_RX_ULPS_ESC_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.559 [get_ports {mipi_dphy_rx_inst3_ERR_SOT_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.040 [get_ports {mipi_dphy_rx_inst3_ERR_SOT_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.570 [get_ports {mipi_dphy_rx_inst3_ERR_SOT_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.046 [get_ports {mipi_dphy_rx_inst3_ERR_SOT_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.745 [get_ports {mipi_dphy_rx_inst3_ERR_SOT_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.163 [get_ports {mipi_dphy_rx_inst3_ERR_SOT_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.584 [get_ports {mipi_dphy_rx_inst3_ERR_SOT_SYNC_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.056 [get_ports {mipi_dphy_rx_inst3_ERR_SOT_SYNC_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.560 [get_ports {mipi_dphy_rx_inst3_RX_ACTIVE_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.040 [get_ports {mipi_dphy_rx_inst3_RX_ACTIVE_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.493 [get_ports {mipi_dphy_rx_inst3_RX_ACTIVE_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 0.995 [get_ports {mipi_dphy_rx_inst3_RX_ACTIVE_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.698 [get_ports {mipi_dphy_rx_inst3_RX_DATA_HS_LAN2[*]}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.132 [get_ports {mipi_dphy_rx_inst3_RX_DATA_HS_LAN2[*]}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.734 [get_ports {mipi_dphy_rx_inst3_RX_DATA_HS_LAN3[*]}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.156 [get_ports {mipi_dphy_rx_inst3_RX_DATA_HS_LAN3[*]}]
...
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.717 [get_ports {mipi_dphy_rx_inst3_RX_SKEW_CAL_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.145 [get_ports {mipi_dphy_rx_inst3_RX_SKEW_CAL_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.583 [get_ports {mipi_dphy_rx_inst3_RX_SKEW_CAL_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.056 [get_ports {mipi_dphy_rx_inst3_RX_SKEW_CAL_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.583 [get_ports {mipi_dphy_rx_inst3_RX_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.056 [get_ports {mipi_dphy_rx_inst3_RX_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.536 [get_ports {mipi_dphy_rx_inst3_RX_SYNC_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.024 [get_ports {mipi_dphy_rx_inst3_RX_SYNC_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.563 [get_ports {mipi_dphy_rx_inst3_RX_VALID_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.042 [get_ports {mipi_dphy_rx_inst3_RX_VALID_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.582 [get_ports {mipi_dphy_rx_inst3_RX_VALID_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.055 [get_ports {mipi_dphy_rx_inst3_RX_VALID_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.591 [get_ports {mipi_dphy_rx_inst3_STOPSTATE_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.060 [get_ports {mipi_dphy_rx_inst3_STOPSTATE_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -max 1.613 [get_ports {mipi_dphy_rx_inst3_STOPSTATE_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst3_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst3_WORD_CLKOUT_HS~CLKOUT~1~525}] -min 1.075 [get_ports {mipi_dphy_rx_inst3_STOPSTATE_LAN3}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst4_WORD_CLKOUT_HS [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst4_LP_CLK [get_ports {mipi_dphy_rx_inst4_LP_CLK}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst4_ESC_LAN0_CLK [get_ports {mipi_dphy_rx_inst4_ESC_LAN0_CLK}]
create_clock -period 6.4000 -name mipi_dphy_rx_inst4_ESC_LAN1_CLK [get_ports {mipi_dphy_rx_inst4_ESC_LAN1_CLK}]
...
# set_input_delay -clock <CLOCK> -max 4.925 [get_ports {mipi_dphy_rx_inst4_RX_ULPS_ESC_LAN2}]
# set_input_delay -clock <CLOCK> -min 3.283 [get_ports {mipi_dphy_rx_inst4_RX_ULPS_ESC_LAN2}]
# set_input_delay -clock <CLOCK> -max 3.289 [get_ports {mipi_dphy_rx_inst4_RX_ULPS_ESC_LAN3}]
# set_input_delay -clock <CLOCK> -min 2.192 [get_ports {mipi_dphy_rx_inst4_RX_ULPS_ESC_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.559 [get_ports {mipi_dphy_rx_inst4_ERR_SOT_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.040 [get_ports {mipi_dphy_rx_inst4_ERR_SOT_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.570 [get_ports {mipi_dphy_rx_inst4_ERR_SOT_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.046 [get_ports {mipi_dphy_rx_inst4_ERR_SOT_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.745 [get_ports {mipi_dphy_rx_inst4_ERR_SOT_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.163 [get_ports {mipi_dphy_rx_inst4_ERR_SOT_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.584 [get_ports {mipi_dphy_rx_inst4_ERR_SOT_SYNC_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.056 [get_ports {mipi_dphy_rx_inst4_ERR_SOT_SYNC_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.560 [get_ports {mipi_dphy_rx_inst4_RX_ACTIVE_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.040 [get_ports {mipi_dphy_rx_inst4_RX_ACTIVE_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.493 [get_ports {mipi_dphy_rx_inst4_RX_ACTIVE_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 0.995 [get_ports {mipi_dphy_rx_inst4_RX_ACTIVE_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.698 [get_ports {mipi_dphy_rx_inst4_RX_DATA_HS_LAN2[*]}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.132 [get_ports {mipi_dphy_rx_inst4_RX_DATA_HS_LAN2[*]}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.734 [get_ports {mipi_dphy_rx_inst4_RX_DATA_HS_LAN3[*]}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.156 [get_ports {mipi_dphy_rx_inst4_RX_DATA_HS_LAN3[*]}]
...
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.717 [get_ports {mipi_dphy_rx_inst4_RX_SKEW_CAL_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.145 [get_ports {mipi_dphy_rx_inst4_RX_SKEW_CAL_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.583 [get_ports {mipi_dphy_rx_inst4_RX_SKEW_CAL_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.056 [get_ports {mipi_dphy_rx_inst4_RX_SKEW_CAL_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.583 [get_ports {mipi_dphy_rx_inst4_RX_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.056 [get_ports {mipi_dphy_rx_inst4_RX_SYNC_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.536 [get_ports {mipi_dphy_rx_inst4_RX_SYNC_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.024 [get_ports {mipi_dphy_rx_inst4_RX_SYNC_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.563 [get_ports {mipi_dphy_rx_inst4_RX_VALID_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.042 [get_ports {mipi_dphy_rx_inst4_RX_VALID_HS_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.582 [get_ports {mipi_dphy_rx_inst4_RX_VALID_HS_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.055 [get_ports {mipi_dphy_rx_inst4_RX_VALID_HS_LAN3}]
...
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.591 [get_ports {mipi_dphy_rx_inst4_STOPSTATE_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.060 [get_ports {mipi_dphy_rx_inst4_STOPSTATE_LAN2}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -max 1.613 [get_ports {mipi_dphy_rx_inst4_STOPSTATE_LAN3}]
set_input_delay -clock mipi_dphy_rx_inst4_WORD_CLKOUT_HS -reference_pin [get_ports {mipi_dphy_rx_inst4_WORD_CLKOUT_HS~CLKOUT~2~565}] -min 1.075 [get_ports {mipi_dphy_rx_inst4_STOPSTATE_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -max 2.671 [get_ports {mipi_dphy_tx_inst1_TX_REQUEST_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -min 0.328 [get_ports {mipi_dphy_tx_inst1_TX_REQUEST_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -max 2.629 [get_ports {mipi_dphy_tx_inst1_TX_REQUEST_ESC_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -min 0.263 [get_ports {mipi_dphy_tx_inst1_TX_REQUEST_ESC_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -max 2.556 [get_ports {mipi_dphy_tx_inst1_TX_ULPS_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -min 0.293 [get_ports {mipi_dphy_tx_inst1_TX_ULPS_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -max 2.410 [get_ports {mipi_dphy_tx_inst1_TX_ULPS_ESC_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -min 0.273 [get_ports {mipi_dphy_tx_inst1_TX_ULPS_ESC_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -max 2.395 [get_ports {mipi_dphy_tx_inst1_TX_ULPS_EXIT_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -min 0.386 [get_ports {mipi_dphy_tx_inst1_TX_ULPS_EXIT_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -max 2.491 [get_ports {mipi_dphy_tx_inst1_TX_ULPS_EXIT_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~35}] -min 0.306 [get_ports {mipi_dphy_tx_inst1_TX_ULPS_EXIT_LAN3}]
...
create_clock -period 6.4000 -name mipi_dphy_tx_inst2_SLOWCLK [get_ports {mipi_dphy_tx_inst2_SLOWCLK}]
...
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -max 1.764 [get_ports {mipi_dphy_tx_inst2_TX_DATA_HS_LAN2[*]}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -min 0.320 [get_ports {mipi_dphy_tx_inst2_TX_DATA_HS_LAN2[*]}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -max 1.695 [get_ports {mipi_dphy_tx_inst2_TX_DATA_HS_LAN3[*]}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -min 0.279 [get_ports {mipi_dphy_tx_inst2_TX_DATA_HS_LAN3[*]}]
...
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -max 1.394 [get_ports {mipi_dphy_tx_inst2_TX_WORD_VALID_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -min 0.273 [get_ports {mipi_dphy_tx_inst2_TX_WORD_VALID_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -max 1.590 [get_ports {mipi_dphy_tx_inst2_TX_WORD_VALID_HS_LAN3}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -min 0.241 [get_ports {mipi_dphy_tx_inst2_TX_WORD_VALID_HS_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -max 2.671 [get_ports {mipi_dphy_tx_inst2_TX_REQUEST_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -min 0.328 [get_ports {mipi_dphy_tx_inst2_TX_REQUEST_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -max 2.629 [get_ports {mipi_dphy_tx_inst2_TX_REQUEST_ESC_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -min 0.263 [get_ports {mipi_dphy_tx_inst2_TX_REQUEST_ESC_LAN3}]
...
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -max 1.804 [get_ports {mipi_dphy_tx_inst2_TX_REQUEST_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -min 0.213 [get_ports {mipi_dphy_tx_inst2_TX_REQUEST_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -max 1.680 [get_ports {mipi_dphy_tx_inst2_TX_REQUEST_HS_LAN3}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -min 0.193 [get_ports {mipi_dphy_tx_inst2_TX_REQUEST_HS_LAN3}]
...
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -max 1.545 [get_ports {mipi_dphy_tx_inst2_TX_SKEW_CAL_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -min 0.257 [get_ports {mipi_dphy_tx_inst2_TX_SKEW_CAL_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -max 1.520 [get_ports {mipi_dphy_tx_inst2_TX_SKEW_CAL_HS_LAN3}]
set_output_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -min 0.190 [get_ports {mipi_dphy_tx_inst2_TX_SKEW_CAL_HS_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -max 2.556 [get_ports {mipi_dphy_tx_inst2_TX_ULPS_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -min 0.293 [get_ports {mipi_dphy_tx_inst2_TX_ULPS_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -max 2.410 [get_ports {mipi_dphy_tx_inst2_TX_ULPS_ESC_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -min 0.273 [get_ports {mipi_dphy_tx_inst2_TX_ULPS_ESC_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -max 2.395 [get_ports {mipi_dphy_tx_inst2_TX_ULPS_EXIT_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -min 0.386 [get_ports {mipi_dphy_tx_inst2_TX_ULPS_EXIT_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -max 2.491 [get_ports {mipi_dphy_tx_inst2_TX_ULPS_EXIT_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~78}] -min 0.306 [get_ports {mipi_dphy_tx_inst2_TX_ULPS_EXIT_LAN3}]
...
set_input_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -max 2.610 [get_ports {mipi_dphy_tx_inst2_TX_READY_HS_LAN2}]
set_input_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -min 1.740 [get_ports {mipi_dphy_tx_inst2_TX_READY_HS_LAN2}]
set_input_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -max 2.543 [get_ports {mipi_dphy_tx_inst2_TX_READY_HS_LAN3}]
set_input_delay -clock mipi_dphy_tx_inst2_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst2_SLOWCLK~CLKOUT~2~78}] -min 1.695 [get_ports {mipi_dphy_tx_inst2_TX_READY_HS_LAN3}]
...
create_clock -period 6.4000 -name mipi_dphy_tx_inst3_SLOWCLK [get_ports {mipi_dphy_tx_inst3_SLOWCLK}]
...
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -max 1.764 [get_ports {mipi_dphy_tx_inst3_TX_DATA_HS_LAN2[*]}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -min 0.320 [get_ports {mipi_dphy_tx_inst3_TX_DATA_HS_LAN2[*]}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -max 1.695 [get_ports {mipi_dphy_tx_inst3_TX_DATA_HS_LAN3[*]}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -min 0.279 [get_ports {mipi_dphy_tx_inst3_TX_DATA_HS_LAN3[*]}]
...
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -max 1.394 [get_ports {mipi_dphy_tx_inst3_TX_WORD_VALID_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -min 0.273 [get_ports {mipi_dphy_tx_inst3_TX_WORD_VALID_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -max 1.590 [get_ports {mipi_dphy_tx_inst3_TX_WORD_VALID_HS_LAN3}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -min 0.241 [get_ports {mipi_dphy_tx_inst3_TX_WORD_VALID_HS_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -max 2.671 [get_ports {mipi_dphy_tx_inst3_TX_REQUEST_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -min 0.328 [get_ports {mipi_dphy_tx_inst3_TX_REQUEST_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -max 2.629 [get_ports {mipi_dphy_tx_inst3_TX_REQUEST_ESC_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -min 0.263 [get_ports {mipi_dphy_tx_inst3_TX_REQUEST_ESC_LAN3}]
...
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -max 1.804 [get_ports {mipi_dphy_tx_inst3_TX_REQUEST_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -min 0.213 [get_ports {mipi_dphy_tx_inst3_TX_REQUEST_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -max 1.680 [get_ports {mipi_dphy_tx_inst3_TX_REQUEST_HS_LAN3}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -min 0.193 [get_ports {mipi_dphy_tx_inst3_TX_REQUEST_HS_LAN3}]
...
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -max 1.545 [get_ports {mipi_dphy_tx_inst3_TX_SKEW_CAL_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -min 0.257 [get_ports {mipi_dphy_tx_inst3_TX_SKEW_CAL_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -max 1.520 [get_ports {mipi_dphy_tx_inst3_TX_SKEW_CAL_HS_LAN3}]
set_output_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -min 0.190 [get_ports {mipi_dphy_tx_inst3_TX_SKEW_CAL_HS_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -max 2.556 [get_ports {mipi_dphy_tx_inst3_TX_ULPS_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -min 0.293 [get_ports {mipi_dphy_tx_inst3_TX_ULPS_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -max 2.410 [get_ports {mipi_dphy_tx_inst3_TX_ULPS_ESC_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -min 0.273 [get_ports {mipi_dphy_tx_inst3_TX_ULPS_ESC_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -max 2.395 [get_ports {mipi_dphy_tx_inst3_TX_ULPS_EXIT_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -min 0.386 [get_ports {mipi_dphy_tx_inst3_TX_ULPS_EXIT_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -max 2.491 [get_ports {mipi_dphy_tx_inst3_TX_ULPS_EXIT_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~1~520}] -min 0.306 [get_ports {mipi_dphy_tx_inst3_TX_ULPS_EXIT_LAN3}]
...
set_input_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -max 2.610 [get_ports {mipi_dphy_tx_inst3_TX_READY_HS_LAN2}]
set_input_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -min 1.740 [get_ports {mipi_dphy_tx_inst3_TX_READY_HS_LAN2}]
set_input_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -max 2.543 [get_ports {mipi_dphy_tx_inst3_TX_READY_HS_LAN3}]
set_input_delay -clock mipi_dphy_tx_inst3_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst3_SLOWCLK~CLKOUT~2~520}] -min 1.695 [get_ports {mipi_dphy_tx_inst3_TX_READY_HS_LAN3}]
...
create_clock -period 6.4000 -name mipi_dphy_tx_inst4_SLOWCLK [get_ports {mipi_dphy_tx_inst4_SLOWCLK}]
...
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -max 1.764 [get_ports {mipi_dphy_tx_inst4_TX_DATA_HS_LAN2[*]}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -min 0.320 [get_ports {mipi_dphy_tx_inst4_TX_DATA_HS_LAN2[*]}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -max 1.695 [get_ports {mipi_dphy_tx_inst4_TX_DATA_HS_LAN3[*]}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -min 0.279 [get_ports {mipi_dphy_tx_inst4_TX_DATA_HS_LAN3[*]}]
...
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -max 1.394 [get_ports {mipi_dphy_tx_inst4_TX_WORD_VALID_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -min 0.273 [get_ports {mipi_dphy_tx_inst4_TX_WORD_VALID_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -max 1.590 [get_ports {mipi_dphy_tx_inst4_TX_WORD_VALID_HS_LAN3}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -min 0.241 [get_ports {mipi_dphy_tx_inst4_TX_WORD_VALID_HS_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -max 2.671 [get_ports {mipi_dphy_tx_inst4_TX_REQUEST_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -min 0.328 [get_ports {mipi_dphy_tx_inst4_TX_REQUEST_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -max 2.629 [get_ports {mipi_dphy_tx_inst4_TX_REQUEST_ESC_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -min 0.263 [get_ports {mipi_dphy_tx_inst4_TX_REQUEST_ESC_LAN3}]
...
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -max 1.804 [get_ports {mipi_dphy_tx_inst4_TX_REQUEST_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -min 0.213 [get_ports {mipi_dphy_tx_inst4_TX_REQUEST_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -max 1.680 [get_ports {mipi_dphy_tx_inst4_TX_REQUEST_HS_LAN3}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -min 0.193 [get_ports {mipi_dphy_tx_inst4_TX_REQUEST_HS_LAN3}]
...
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -max 1.545 [get_ports {mipi_dphy_tx_inst4_TX_SKEW_CAL_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -min 0.257 [get_ports {mipi_dphy_tx_inst4_TX_SKEW_CAL_HS_LAN2}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -max 1.520 [get_ports {mipi_dphy_tx_inst4_TX_SKEW_CAL_HS_LAN3}]
set_output_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -min 0.190 [get_ports {mipi_dphy_tx_inst4_TX_SKEW_CAL_HS_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -max 2.556 [get_ports {mipi_dphy_tx_inst4_TX_ULPS_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -min 0.293 [get_ports {mipi_dphy_tx_inst4_TX_ULPS_ESC_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -max 2.410 [get_ports {mipi_dphy_tx_inst4_TX_ULPS_ESC_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -min 0.273 [get_ports {mipi_dphy_tx_inst4_TX_ULPS_ESC_LAN3}]
...
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -max 2.395 [get_ports {mipi_dphy_tx_inst4_TX_ULPS_EXIT_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -min 0.386 [get_ports {mipi_dphy_tx_inst4_TX_ULPS_EXIT_LAN2}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -max 2.491 [get_ports {mipi_dphy_tx_inst4_TX_ULPS_EXIT_LAN3}]
set_output_delay -clock tx_escclk -reference_pin [get_ports {tx_escclk~CLKOUT~2~562}] -min 0.306 [get_ports {mipi_dphy_tx_inst4_TX_ULPS_EXIT_LAN3}]
...
set_input_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -max 2.610 [get_ports {mipi_dphy_tx_inst4_TX_READY_HS_LAN2}]
set_input_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -min 1.740 [get_ports {mipi_dphy_tx_inst4_TX_READY_HS_LAN2}]
set_input_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -max 2.543 [get_ports {mipi_dphy_tx_inst4_TX_READY_HS_LAN3}]
set_input_delay -clock mipi_dphy_tx_inst4_SLOWCLK -reference_pin [get_ports {mipi_dphy_tx_inst4_SLOWCLK~CLKOUT~1~563}] -min 1.695 [get_ports {mipi_dphy_tx_inst4_TX_READY_HS_LAN3}]
...
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 3.675 [get_ports {ddr_inst_ARST_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.000 [get_ports {ddr_inst_ARST_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_ARADDR_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_ARADDR_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_ARAPCMD_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_ARAPCMD_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_ARBURST_1[1] ddr_inst_ARBURST_1[0]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_ARBURST_1[1] ddr_inst_ARBURST_1[0]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_ARID_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_ARID_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_ARLEN_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_ARLEN_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_ARSIZE_1[2] ddr_inst_ARSIZE_1[1] ddr_inst_ARSIZE_1[0]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_ARSIZE_1[2] ddr_inst_ARSIZE_1[1] ddr_inst_ARSIZE_1[0]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_ARVALID_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_ARVALID_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_ARLOCK_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_ARLOCK_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_ARQOS_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_ARQOS_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWADDR_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_AWADDR_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWAPCMD_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.350 [get_ports {ddr_inst_AWAPCMD_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWALLSTRB_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_AWALLSTRB_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWBURST_1[1] ddr_inst_AWBURST_1[0]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_AWBURST_1[1] ddr_inst_AWBURST_1[0]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWCOBUF_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_AWCOBUF_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWID_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_AWID_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWLEN_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_AWLEN_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWSIZE_1[2] ddr_inst_AWSIZE_1[1] ddr_inst_AWSIZE_1[0]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_AWSIZE_1[2] ddr_inst_AWSIZE_1[1] ddr_inst_AWSIZE_1[0]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWVALID_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_AWVALID_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWLOCK_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_AWLOCK_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWCACHE_1[3] ddr_inst_AWCACHE_1[2] ddr_inst_AWCACHE_1[1] ddr_inst_AWCACHE_1[0]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_AWCACHE_1[3] ddr_inst_AWCACHE_1[2] ddr_inst_AWCACHE_1[1] ddr_inst_AWCACHE_1[0]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_AWQOS_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_AWQOS_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_BREADY_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_BREADY_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_RREADY_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_RREADY_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_WDATA_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_WDATA_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_WLAST_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_WLAST_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_WSTRB_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_WSTRB_1[*]}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.310 [get_ports {ddr_inst_WVALID_1}]
set_output_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min -0.140 [get_ports {ddr_inst_WVALID_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.625 [get_ports {ddr_inst_ARREADY_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min 1.750 [get_ports {ddr_inst_ARREADY_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.520 [get_ports {ddr_inst_AWREADY_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min 1.680 [get_ports {ddr_inst_AWREADY_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.520 [get_ports {ddr_inst_BID_1[*]}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min 1.680 [get_ports {ddr_inst_BID_1[*]}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.625 [get_ports {ddr_inst_BRESP_1[1] ddr_inst_BRESP_1[0]}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min 1.750 [get_ports {ddr_inst_BRESP_1[1] ddr_inst_BRESP_1[0]}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.625 [get_ports {ddr_inst_BVALID_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min 1.750 [get_ports {ddr_inst_BVALID_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.625 [get_ports {ddr_inst_RDATA_1[*]}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min 1.750 [get_ports {ddr_inst_RDATA_1[*]}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.625 [get_ports {ddr_inst_RID_1[*]}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min 1.750 [get_ports {ddr_inst_RID_1[*]}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.625 [get_ports {ddr_inst_RLAST_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min 1.750 [get_ports {ddr_inst_RLAST_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.625 [get_ports {ddr_inst_RRESP_1[1] ddr_inst_RRESP_1[0]}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min 1.750 [get_ports {ddr_inst_RRESP_1[1] ddr_inst_RRESP_1[0]}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.625 [get_ports {ddr_inst_RVALID_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min 1.750 [get_ports {ddr_inst_RVALID_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -max 2.625 [get_ports {ddr_inst_WREADY_1}]
set_input_delay -clock i_axi1_mem_clk -reference_pin [get_ports {i_axi1_mem_clk~CLKOUT~1~338}] -min 1.750 [get_ports {ddr_inst_WREADY_1}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -max 1.890 [get_ports {ddr_inst_CTRL_REFRESH}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -min 1.260 [get_ports {ddr_inst_CTRL_REFRESH}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -max 1.890 [get_ports {ddr_inst_CTRL_CKE[1] ddr_inst_CTRL_CKE[0]}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -min 1.260 [get_ports {ddr_inst_CTRL_CKE[1] ddr_inst_CTRL_CKE[0]}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -max 1.890 [get_ports {ddr_inst_CTRL_BUSY}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -min 1.260 [get_ports {ddr_inst_CTRL_BUSY}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -max 1.890 [get_ports {ddr_inst_CTRL_CMD_Q_ALMOST_FULL}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -min 1.260 [get_ports {ddr_inst_CTRL_CMD_Q_ALMOST_FULL}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -max 1.890 [get_ports {ddr_inst_CTRL_DP_IDLE}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -min 1.260 [get_ports {ddr_inst_CTRL_DP_IDLE}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -max 1.890 [get_ports {ddr_inst_CTRL_PORT_BUSY[1] ddr_inst_CTRL_PORT_BUSY[0]}]
set_input_delay -clock i_axi0_mem_clk -reference_pin [get_ports {i_axi0_mem_clk~CLKOUT~1~491}] -min 1.260 [get_ports {ddr_inst_CTRL_PORT_BUSY[1] ddr_inst_CTRL_PORT_BUSY[0]}]
...
# set_clock_latency -source -setup <board_max + 0.828> [get_ports {tx_escclk}]
# set_clock_latency -source -hold <board_min + 0.552> [get_ports {tx_escclk}]
# set_clock_latency -source -setup <board_max + 0.828> [get_ports {i_pixel_clk_tx}]
# set_clock_latency -source -hold <board_min + 0.552> [get_ports {i_pixel_clk_tx}]
...
# set_clock_latency -source -setup <pll_clk_latency_mipi_clk_max + 2.386> [get_ports {i_sd_clk}]
# set_clock_latency -source -hold <pll_clk_latency_mipi_clk_min + 1.545> [get_ports {i_sd_clk}]
...
# set_clock_latency -source -setup <board_max -0.479> [get_ports {i_hdmi_clk}]
# set_clock_latency -source -hold <board_min -0.273> [get_ports {i_hdmi_clk}]
...
# set_clock_latency -source -setup <board_max + 1.907> [get_ports {i_axi1_mem_clk}]
# set_clock_latency -source -hold <board_min + 1.271> [get_ports {i_axi1_mem_clk}]
