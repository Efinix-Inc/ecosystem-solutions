...
package csi2_rx_cfg_pkg;
	...
	localparam int TX_HSP  = 80; //200 ;// H-Sync Pulse
	localparam int TX_HBP  =  22;  // H-Back Porch
	localparam int TX_HACT = (3840/4);// H-Active Area (The Max. Pixel Clock of All channel)
	localparam int TX_HFP  = 60; //122; // H-Front Porch
    ...
    localparam csi2_cfg_t SENSOR_ARRAY [NUM_CHANNEL] = '{
        '{LINE_WIDTH: 3840, FRAME_HEIGHT: 2160, PIXEL_PER_CLK: 4, DATA_WIDTH: 64, NUM_LINES: 8, DEFAULT_DT: 6'h2B}, // CH0
        '{LINE_WIDTH: 3840, FRAME_HEIGHT: 2160, PIXEL_PER_CLK: 4, DATA_WIDTH: 64, NUM_LINES: 8, DEFAULT_DT: 6'h2B}, // CH0
		'{LINE_WIDTH: 3840, FRAME_HEIGHT: 2160, PIXEL_PER_CLK: 4, DATA_WIDTH: 64, NUM_LINES: 8, DEFAULT_DT: 6'h2B}, // CH0
		'{LINE_WIDTH: 3840, FRAME_HEIGHT: 2160, PIXEL_PER_CLK: 4, DATA_WIDTH: 64, NUM_LINES: 8, DEFAULT_DT: 6'h2B} // CH0
...
package csi2_rx_sim_pkg;
    ...
    localparam csi2_sim_t SIM_SENSOR_ARRAY [NUM_SIM] = '{
       '{H_RES :3840, V_RES :2160, HSP   :44, HBP   :148, HFP   :88, VSP   :1, VBP   :36, VFP   :1, INIT_DLY : 1000, CLK:20, NUM_FRAME:4}, // CH0
       '{H_RES :3840, V_RES :2160, HSP   :44, HBP   :148, HFP   :88, VSP   :1, VBP   :36, VFP   :1, INIT_DLY : 1000, CLK:20, NUM_FRAME:4}, // CH0
       '{H_RES :3840, V_RES :2160, HSP   :44, HBP   :148, HFP   :88, VSP   :1, VBP   :36, VFP   :1, INIT_DLY : 1000, CLK:20, NUM_FRAME:4}, // CH0
       '{H_RES :3840, V_RES :2160, HSP   :44, HBP   :148, HFP   :88, VSP   :1, VBP   :36, VFP   :1, INIT_DLY : 1000, CLK:20, NUM_FRAME:4} // CH0
