...
- [Titanium&#8482; Ti180J484-DK](https://www.efinixinc.com/products-devkits-titaniumti180j484.html)
  ...
  - 2 x [IMX477 Camera Module ](https://www.raspberrypi.com/products/camera-module-v2/)
...
1. **Prepare the daughter cards**  
   - Connect the two IMX477 Camera Module to both top connector (FPC2) and bottom connector (FPC1) of IMX477 Camera Connector Daughter Card using a 22‑pin FFC Cable (Type B).

2. **Insert the daughter cards onto the Ti180J484 Development Board**  
   - Attach the daughter cards onto to QSE connectors **P1** on the Ti180J484 development board.  
...
5. **FPGA Configuration**  
   ...
   - Choose the efx-gmsl-sensorhub-line-2x4K_combined in efx-gmsl-video-line-2x4K/prebuild/quickstart folder (from release build)
