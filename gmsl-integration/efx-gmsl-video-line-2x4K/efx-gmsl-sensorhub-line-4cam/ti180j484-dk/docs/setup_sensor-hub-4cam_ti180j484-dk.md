...
1. **Prepare the daughter cards**  
   - Connect the two IMX477 Camera Modules to both top connector (FPC2) and bottom connector (FPC1) of IMX477 Camera Connector Daughter Card using a 22‑pin FFC Cable (Type B).

2. **Insert the daughter cards onto the Ti180J484 Development Board**  
   - Attach the daughter cards onto QSE connectors **P1** on the Ti180J484 development board.  
...
5. **FPGA Configuration**  
   ...
   - Choose the efx-gmsl-sensorhub-line-2x4K_combined.hex in prebuild/efx-gmsl-video-line-2x4K/quickstart folder (from release build)
