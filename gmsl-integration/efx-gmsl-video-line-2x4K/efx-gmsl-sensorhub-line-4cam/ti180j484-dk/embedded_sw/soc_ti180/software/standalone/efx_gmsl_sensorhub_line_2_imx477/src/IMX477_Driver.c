...
static const struct imx477_reg imx477_reg_autoI2c[] = {
			{0x0100, 0x00},
			{0x0136, 0x18},
			{0x0137, 0x00},
			{0xe000, 0x00},
...
int imx477_init_raw(void)
{
	...
	if(imx477_WriteRegs(imx477_reg_autoI2c, sizeof (imx477_reg_autoI2c)  /sizeof(struct imx477_reg )))
		return 1;
	else
		return 0;
}
...
//	   return 3;
   #ifdef STREAM_RX_4K
   	   if (imx477_WriteRegs(imx477_mode_3840x2160_30fps, sizeof (imx477_mode_3840x2160_30fps)  /sizeof(struct imx477_reg )) )
   		   return 3;
   #else
   	   if (imx477_WriteRegs(imx477_mode_1920x1080_60fps, sizeof (imx477_mode_1920x1080_60fps)  /sizeof(struct imx477_reg )) )
   		   return 3;
