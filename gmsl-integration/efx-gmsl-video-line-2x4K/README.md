...
# Getting Start
### Configurating GMSL Sensor Hub (2 IMX477 Cameras)
...
* The Video View would be show on 1920x1080 output, which would be cropped center of Cameara Image @ 3840x2160. 
...
* two cameras were attached the daughter cards onto to QSE connectors **P1** on the Ti180J484 development board, the view of the cameras will be show on CAM0 and CAM1. 
* LED7: Initialization done
