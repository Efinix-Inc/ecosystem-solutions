...
(
	...
	output 			out_hs,
	output 			out_vs, 
    output [nCHANNEL-1:0] out_channel,
    output [nCHANNEL-1:0] out_next_Channel,
    output [nCHANNEL-1:0] out_hs_ch,
    output [nCHANNEL-1:0] out_vs_ch
...
reg			r_de;
reg	        r_hs;
reg [nCHANNEL-1:0] r_Channel;
reg [nCHANNEL-1:0] r_next_Channel;

reg			r_de_1P;
reg			r_hs_1P;
reg			r_vs_1P;
reg			r_valid_1P;
reg [nCHANNEL-1:0] r_Channel_1P;
reg [nCHANNEL-1:0] r_next_Channel_1P;

reg			r_de_2P;
reg			r_hs_2P;
reg			r_vs_2P;
reg			r_valid_2P;
reg [nCHANNEL-1:0] r_Channel_2P;
reg [nCHANNEL-1:0] r_next_Channel_2P;
reg [nCHANNEL-1:0] r_hs_ch_2P;
reg [nCHANNEL-1:0] r_vs_ch_2P;
...
//		r_p_cnt			<= 3'd1;
		...
		r_vs_2P			<= 1'b1;
        r_Channel_2P      <= 'd1;
        r_next_Channel_2P <= 'd1;

        
        r_hs_ch_2P      <= 'd1;//{nCHANNEL{1'b1}};
        r_vs_ch_2P      <= 'd1;//{nCHANNEL{1'b1}};
	...
	begin
	    ...
	    r_hs_1P			<= r_hs;
		r_vs_1P			<= r_vs;
        r_Channel_1P    <= r_Channel;
        r_next_Channel_1P <= r_next_Channel;

        
		r_de_2P			<= r_de_1P;
	    r_hs_2P			<= r_hs_1P;
		r_vs_2P			<= r_vs_1P;
        r_Channel_2P    <= r_Channel_1P;
        r_next_Channel_2P <= r_next_Channel_1P;
        
        r_hs_ch_2P      <= {nCHANNEL{r_hs_1P}} & r_Channel_1P;
        r_vs_ch_2P      <= {nCHANNEL{r_vs_1P}} & r_Channel_1P;
	...
	begin
		...
		begin
			...
			begin
				r_y_cnt <= 12'b0;
				r_vs <= 1'b0;
                r_Channel <= {r_Channel[nCHANNEL-2:0],r_Channel[nCHANNEL-1]};  
        ...
        begin
			r_vs <= 1'b1;
            r_next_Channel <= {r_next_Channel[nCHANNEL-2:0],r_next_Channel[nCHANNEL-1]};  
        end 
...
assign  out_Channel      = r_Channel_2P;
assign  out_next_Channel = r_next_Channel_2P;
assign	out_vs_ch	     = r_vs_ch_2P;
assign	out_hs_ch	     = r_hs_ch_2P;
