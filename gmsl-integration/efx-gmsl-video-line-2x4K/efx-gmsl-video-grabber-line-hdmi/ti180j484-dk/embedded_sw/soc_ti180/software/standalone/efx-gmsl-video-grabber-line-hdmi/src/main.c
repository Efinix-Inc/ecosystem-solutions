...
#define START_MEM_ADDR			0x1000000
#define START_DESCRIPTOR_ADDR	START_MEM_ADDR
#define START_FRAMEBUFFER_ADDR	START_DESCRIPTOR_ADDR + 0x1000000
...
void inital_video_stream()
{
	...
	APB3_REGW(OOB_APB_SLV, APB3_SLV_REG12_I2C_CAM_SEL, 0);

//	int i2c_slv_rd = I2C_SLV_ReadRegData(0);
//	bsp_printf("Version = 0x%x!\n\r",i2c_slv_rd );


//	i2c_slv_rd = I2C_SLV_ReadRegData(1);
//	bsp_printf("status = 0x%x!\n\r",i2c_slv_rd );
	APB3_REGW(OOB_APB_SLV, APB3_SLV_REG12_I2C_CAM_SEL, 0);
    ...
    APB3_REGW(OOB_APB_SLV, APB3_SLV_REG_FRAMESIZE_CH0, (FRAME_SIZE_RX) -1);
	APB3_REGW(OOB_APB_SLV, APB3_SLV_REG_FRAMESIZE_CH1, (FRAME_SIZE_RX) -1);
	APB3_REGW(OOB_APB_SLV, APB3_SLV_REG_FRAMESIZE_CH2, (FRAME_SIZE_RX) -1);
	APB3_REGW(OOB_APB_SLV, APB3_SLV_REG_FRAMESIZE_CH3, (FRAME_SIZE_RX) -1);
	...
	dma_video_out_scrop_frame(framebuffer_ptr[DMASG_CHANNEL0],3840/2, 2160/4 ,descriptors0 );
	...
	APB3_REGW(OOB_APB_SLV, APB3_SLV_REG_STREAM_OUT, 0x0f);
...
void cmd_operation(uint8_t key )
{
	if(key == '1')
	{
		...
		APB3_REGW(OOB_APB_SLV, APB3_SLV_REG_STREAM_OUT, 0x00);
     	bsp_uDelay(200000);
       	dma_video_out_scrop_frame(framebuffer_ptr[DMASG_CHANNEL0],3840/4, 2160/4, descriptors0 );
	...
	else if (key == '2')
	{
		...
		APB3_REGW(OOB_APB_SLV, APB3_SLV_REG_STREAM_OUT, 0x00);
		bsp_uDelay(200000);
		dma_video_out_scrop_frame(framebuffer_ptr[DMASG_CHANNEL1],3840/4, 2160/4, descriptors0 );
    	APB3_REGW(OOB_APB_SLV, APB3_SLV_REG_STREAM_OUT, 0x05);
	}
	else if (key == '3')
	{
		...
		APB3_REGW(OOB_APB_SLV, APB3_SLV_REG_STREAM_OUT, 0x00);
		bsp_uDelay(200000);
		dma_video_out_scrop_frame(framebuffer_ptr[DMASG_CHANNEL2],3840/4, 2160/4,descriptors0 );
	...
	else if (key == '4')
	{
		...
		APB3_REGW(OOB_APB_SLV, APB3_SLV_REG_STREAM_OUT, 0x00);
		bsp_uDelay(200000);
		dma_video_out_scrop_frame(framebuffer_ptr[DMASG_CHANNEL3],3840/4, 2160/4, descriptors0 );
