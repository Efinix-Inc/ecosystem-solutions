...
module EfxDMA (
  ...
  output wire [5:0]    ctrl_interrupts,
  ...
  input  wire          dat4_i_tvalid,
  output wire          dat4_i_tready,
  input  wire [31:0]   dat4_i_tdata,
  input  wire [3:0]    dat4_i_tkeep,
  input  wire [3:0]    dat4_i_tdest,
  input  wire          dat4_i_tlast,
  input  wire          dat5_i_tvalid,
  output wire          dat5_i_tready,
  input  wire [31:0]   dat5_i_tdata,
  input  wire [3:0]    dat5_i_tkeep,
  input  wire [3:0]    dat5_i_tdest,
  input  wire          dat5_i_tlast,
  ...
  output wire          sg_cmd_valid,
  input  wire          sg_cmd_ready,
  output wire          sg_cmd_read,
  output wire          sg_cmd_write,
  output wire [2:0]    sg_cmd_channelId,
  output wire [26:0]   sg_cmd_bytesDone,
  output wire          sg_cmd_endOfPacket,
  output wire          sg_cmd_completed,
  input  wire          sg_rsp_valid,
  input  wire [2:0]    sg_rsp_channelId,
  input  wire [31:0]   sg_rsp_srcAddress,
  input  wire [31:0]   sg_rsp_dstAddress,
  input  wire [25:0]   sg_rsp_bytes,
  input  wire          sg_rsp_last,
  input  wire          sg_rsp_stall,
  ...
  input  wire          dat4_i_clk,
  input  wire          dat4_i_reset,
  input  wire          dat5_i_clk,
  input  wire          dat5_i_reset,
  ...
  wire                core_io_inputs_3_ready;
  wire       [5:0]    core_io_interrupts;
  wire                core_io_ctrl_PREADY;
  wire       [31:0]   core_io_ctrl_PRDATA;
  wire                core_io_ctrl_PSLVERROR;
  wire                core_io_sg_cmd_valid;
  wire                core_io_sg_cmd_payload_read;
  wire                core_io_sg_cmd_payload_write;
  wire       [2:0]    core_io_sg_cmd_payload_channelId;
  wire       [26:0]   core_io_sg_cmd_payload_bytesDone;
  wire                core_io_sg_cmd_payload_endOfPacket;
  wire                core_io_sg_cmd_payload_completed;
  ...
  wire       [5:0]    io_interrupts_buffercc_io_dataOut;
  ...
  wire       [63:0]   inputsAdapter_2_upsizer_logic_io_output_payload_data;
  wire       [7:0]    inputsAdapter_2_upsizer_logic_io_output_payload_mask;
  ...
  wire       [63:0]   inputsAdapter_2_crossclock_fifo_io_pop_payload_data;
  wire       [7:0]    inputsAdapter_2_crossclock_fifo_io_pop_payload_mask;
  ...
  wire                inputsAdapter_3_upsizer_logic_io_input_ready;
  wire                inputsAdapter_3_upsizer_logic_io_output_valid;
  wire       [63:0]   inputsAdapter_3_upsizer_logic_io_output_payload_data;
  wire       [7:0]    inputsAdapter_3_upsizer_logic_io_output_payload_mask;
  wire       [3:0]    inputsAdapter_3_upsizer_logic_io_output_payload_sink;
  wire                inputsAdapter_3_upsizer_logic_io_output_payload_last;
  wire                inputsAdapter_3_crossclock_fifo_io_push_ready;
  wire                inputsAdapter_3_crossclock_fifo_io_pop_valid;
  wire       [63:0]   inputsAdapter_3_crossclock_fifo_io_pop_payload_data;
  wire       [7:0]    inputsAdapter_3_crossclock_fifo_io_pop_payload_mask;
  wire       [3:0]    inputsAdapter_3_crossclock_fifo_io_pop_payload_sink;
  wire                inputsAdapter_3_crossclock_fifo_io_pop_payload_last;
  wire       [4:0]    inputsAdapter_3_crossclock_fifo_io_pushOccupancy;
  wire       [4:0]    inputsAdapter_3_crossclock_fifo_io_popOccupancy;
  ...
  wire       [11:0]   interconnect_read_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_length;
  wire       [21:0]   interconnect_read_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_context;
  ...
  wire       [127:0]  interconnect_read_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_rsp_payload_fragment_data;
  wire       [21:0]   interconnect_read_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_rsp_payload_fragment_context;
  ...
  wire       [1:0]    interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_source;
  ...
  wire       [11:0]   interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_length;
  ...
  wire       [14:0]   interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_context;
  ...
  wire       [1:0]    interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_rsp_payload_fragment_source;
  wire       [0:0]    interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_rsp_payload_fragment_opcode;
  wire       [14:0]   interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_rsp_payload_fragment_context;
  wire                io_write_cmd_s2mPipe_valid;
  reg                 io_write_cmd_s2mPipe_ready;
  wire                io_write_cmd_s2mPipe_payload_last;
  wire       [1:0]    io_write_cmd_s2mPipe_payload_fragment_source;
  ...
  reg        [1:0]    io_write_cmd_rData_fragment_source;
  ...
  wire       [1:0]    io_write_cmd_s2mPipe_m2sPipe_payload_fragment_source;
  ...
  reg        [1:0]    io_write_cmd_s2mPipe_rData_fragment_source;
  ...
  wire       [127:0]  interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_0_decoder_cmd_payload_fragment_data;
  wire       [15:0]   interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_0_decoder_cmd_payload_fragment_mask;
  ...
  wire       [2:0]    writeLogic_resized_cmd_payload_fragment_source;
  ...
  wire       [2:0]    writeLogic_resized_rsp_payload_fragment_source;
  ...
  reg        [2:0]    interconnect_write_aggregated_cmd_rData_fragment_source;
  ...
  wire       [2:0]    writeLogic_resized_rsp_combStage_payload_fragment_source;
  ...
  wire       [7:0]    io_pop_s2mPipe_payload_mask_2;
  wire       [3:0]    io_pop_s2mPipe_payload_sink_2;
  wire                io_pop_s2mPipe_payload_last_2;
  reg                 io_pop_rValidN_2;
  reg        [63:0]   io_pop_rData_data_2;
  reg        [7:0]    io_pop_rData_mask_2;
  reg        [3:0]    io_pop_rData_sink_2;
  ...
  wire       [7:0]    io_pop_s2mPipe_m2sPipe_payload_mask_2;
  wire       [3:0]    io_pop_s2mPipe_m2sPipe_payload_sink_2;
  wire                io_pop_s2mPipe_m2sPipe_payload_last_2;
  reg                 io_pop_s2mPipe_rValid_2;
  reg        [63:0]   io_pop_s2mPipe_rData_data_2;
  reg        [7:0]    io_pop_s2mPipe_rData_mask_2;
  reg        [3:0]    io_pop_s2mPipe_rData_sink_2;
  reg                 io_pop_s2mPipe_rData_last_2;
  wire                when_Stream_l375_6;
  wire                io_pop_s2mPipe_valid_3;
  reg                 io_pop_s2mPipe_ready_3;
  wire       [63:0]   io_pop_s2mPipe_payload_data_3;
  wire       [7:0]    io_pop_s2mPipe_payload_mask_3;
  wire       [3:0]    io_pop_s2mPipe_payload_sink_3;
  wire                io_pop_s2mPipe_payload_last_3;
  reg                 io_pop_rValidN_3;
  reg        [63:0]   io_pop_rData_data_3;
  reg        [7:0]    io_pop_rData_mask_3;
  reg        [3:0]    io_pop_rData_sink_3;
  reg                 io_pop_rData_last_3;
  wire                io_pop_s2mPipe_m2sPipe_valid_3;
  wire                io_pop_s2mPipe_m2sPipe_ready_3;
  wire       [63:0]   io_pop_s2mPipe_m2sPipe_payload_data_3;
  wire       [7:0]    io_pop_s2mPipe_m2sPipe_payload_mask_3;
  wire       [3:0]    io_pop_s2mPipe_m2sPipe_payload_sink_3;
  wire                io_pop_s2mPipe_m2sPipe_payload_last_3;
  reg                 io_pop_s2mPipe_rValid_3;
  reg        [63:0]   io_pop_s2mPipe_rData_data_3;
  reg        [7:0]    io_pop_s2mPipe_rData_mask_3;
  reg        [3:0]    io_pop_s2mPipe_rData_sink_3;
  reg                 io_pop_s2mPipe_rData_last_3;
  ...
  EfxDMA_Core core (
    ...
    .io_sgRead_rsp_payload_fragment_data     (interconnect_read_aggregated_slaveModel_arbiterGen_logic_sorted_0_decoder_rsp_payload_fragment_data[127:0]   ), //i
    ...
    .io_read_rsp_payload_fragment_data       (interconnect_read_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_rsp_payload_fragment_data[127:0]   ), //i
    .io_read_rsp_payload_fragment_context    (interconnect_read_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_rsp_payload_fragment_context[21:0] ), //i
    ...
    .io_write_rsp_payload_fragment_source    (interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_rsp_payload_fragment_source[1:0]  ), //i
    ...
    .io_write_rsp_payload_fragment_context   (interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_rsp_payload_fragment_context[14:0]), //i
    ...
    .io_inputs_2_valid                       (io_pop_s2mPipe_m2sPipe_valid_2                                                                               ), //i
    .io_inputs_2_ready                       (core_io_inputs_2_ready                                                                                       ), //o
    .io_inputs_2_payload_data                (io_pop_s2mPipe_m2sPipe_payload_data_2[63:0]                                                                  ), //i
    .io_inputs_2_payload_mask                (io_pop_s2mPipe_m2sPipe_payload_mask_2[7:0]                                                                   ), //i
    .io_inputs_2_payload_sink                (io_pop_s2mPipe_m2sPipe_payload_sink_2[3:0]                                                                   ), //i
    .io_inputs_2_payload_last                (io_pop_s2mPipe_m2sPipe_payload_last_2                                                                        ), //i
    .io_inputs_3_valid                       (io_pop_s2mPipe_m2sPipe_valid_3                                                                               ), //i
    .io_inputs_3_ready                       (core_io_inputs_3_ready                                                                                       ), //o
    .io_inputs_3_payload_data                (io_pop_s2mPipe_m2sPipe_payload_data_3[63:0]                                                                  ), //i
    .io_inputs_3_payload_mask                (io_pop_s2mPipe_m2sPipe_payload_mask_3[7:0]                                                                   ), //i
    .io_inputs_3_payload_sink                (io_pop_s2mPipe_m2sPipe_payload_sink_3[3:0]                                                                   ), //i
    .io_inputs_3_payload_last                (io_pop_s2mPipe_m2sPipe_payload_last_3                                                                        ), //i
    ...
    .io_sg_cmd_valid                         (core_io_sg_cmd_valid                                                                                         ), //o
    .io_sg_cmd_ready                         (sg_cmd_ready                                                                                                 ), //i
    .io_sg_cmd_payload_read                  (core_io_sg_cmd_payload_read                                                                                  ), //o
    .io_sg_cmd_payload_write                 (core_io_sg_cmd_payload_write                                                                                 ), //o
    .io_sg_cmd_payload_channelId             (core_io_sg_cmd_payload_channelId[2:0]                                                                        ), //o
    .io_sg_cmd_payload_bytesDone             (core_io_sg_cmd_payload_bytesDone[26:0]                                                                       ), //o
    .io_sg_cmd_payload_endOfPacket           (core_io_sg_cmd_payload_endOfPacket                                                                           ), //o
    .io_sg_cmd_payload_completed             (core_io_sg_cmd_payload_completed                                                                             ), //o
    .io_sg_rsp_valid                         (sg_rsp_valid                                                                                                 ), //i
    .io_sg_rsp_payload_channelId             (sg_rsp_channelId[2:0]                                                                                        ), //i
    .io_sg_rsp_payload_srcAddress            (sg_rsp_srcAddress[31:0]                                                                                      ), //i
    .io_sg_rsp_payload_dstAddress            (sg_rsp_dstAddress[31:0]                                                                                      ), //i
    .io_sg_rsp_payload_bytes                 (sg_rsp_bytes[25:0]                                                                                           ), //i
    .io_sg_rsp_payload_last                  (sg_rsp_last                                                                                                  ), //i
    .io_sg_rsp_payload_stall                 (sg_rsp_stall                                                                                                 ), //i
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_14 io_interrupts_buffercc (
  ...
  EfxDMA_BmbSourceRemover_1 writeLogic_sourceRemover (
    ...
    .io_input_cmd_payload_fragment_source   (writeLogic_resized_cmd_payload_fragment_source[2:0]                  ), //i
  ...
  EfxDMA_BsbUpSizerDense_1 inputsAdapter_2_upsizer_logic (
    .io_input_valid         (dat4_i_tvalid                                             ), //i
    .io_input_ready         (inputsAdapter_2_upsizer_logic_io_input_ready              ), //o
    .io_input_payload_data  (dat4_i_tdata[31:0]                                        ), //i
    .io_input_payload_mask  (dat4_i_tkeep[3:0]                                         ), //i
    .io_input_payload_sink  (dat4_i_tdest[3:0]                                         ), //i
    .io_input_payload_last  (dat4_i_tlast                                              ), //i
    ...
    .io_output_payload_data (inputsAdapter_2_upsizer_logic_io_output_payload_data[63:0]), //o
    .io_output_payload_mask (inputsAdapter_2_upsizer_logic_io_output_payload_mask[7:0] ), //o
    ...
    .dat4_i_clk             (dat4_i_clk                                                ), //i
    .dat4_i_reset           (dat4_i_reset                                              )  //i
  );
  EfxDMA_StreamFifoCC_2 inputsAdapter_2_crossclock_fifo (
    ...
    .io_push_payload_data (inputsAdapter_2_upsizer_logic_io_output_payload_data[63:0]), //i
    .io_push_payload_mask (inputsAdapter_2_upsizer_logic_io_output_payload_mask[7:0] ), //i
    ...
    .io_pop_payload_data  (inputsAdapter_2_crossclock_fifo_io_pop_payload_data[63:0] ), //o
    .io_pop_payload_mask  (inputsAdapter_2_crossclock_fifo_io_pop_payload_mask[7:0]  ), //o
  ...
  EfxDMA_BsbUpSizerDense_2 inputsAdapter_3_upsizer_logic (
    .io_input_valid         (dat5_i_tvalid                                             ), //i
    .io_input_ready         (inputsAdapter_3_upsizer_logic_io_input_ready              ), //o
    .io_input_payload_data  (dat5_i_tdata[31:0]                                        ), //i
    .io_input_payload_mask  (dat5_i_tkeep[3:0]                                         ), //i
    .io_input_payload_sink  (dat5_i_tdest[3:0]                                         ), //i
    .io_input_payload_last  (dat5_i_tlast                                              ), //i
    .io_output_valid        (inputsAdapter_3_upsizer_logic_io_output_valid             ), //o
    .io_output_ready        (inputsAdapter_3_crossclock_fifo_io_push_ready             ), //i
    .io_output_payload_data (inputsAdapter_3_upsizer_logic_io_output_payload_data[63:0]), //o
    .io_output_payload_mask (inputsAdapter_3_upsizer_logic_io_output_payload_mask[7:0] ), //o
    .io_output_payload_sink (inputsAdapter_3_upsizer_logic_io_output_payload_sink[3:0] ), //o
    .io_output_payload_last (inputsAdapter_3_upsizer_logic_io_output_payload_last      ), //o
    .dat5_i_clk             (dat5_i_clk                                                ), //i
    .dat5_i_reset           (dat5_i_reset                                              )  //i
  );
  EfxDMA_StreamFifoCC_3 inputsAdapter_3_crossclock_fifo (
    .io_push_valid        (inputsAdapter_3_upsizer_logic_io_output_valid             ), //i
    .io_push_ready        (inputsAdapter_3_crossclock_fifo_io_push_ready             ), //o
    .io_push_payload_data (inputsAdapter_3_upsizer_logic_io_output_payload_data[63:0]), //i
    .io_push_payload_mask (inputsAdapter_3_upsizer_logic_io_output_payload_mask[7:0] ), //i
    .io_push_payload_sink (inputsAdapter_3_upsizer_logic_io_output_payload_sink[3:0] ), //i
    .io_push_payload_last (inputsAdapter_3_upsizer_logic_io_output_payload_last      ), //i
    .io_pop_valid         (inputsAdapter_3_crossclock_fifo_io_pop_valid              ), //o
    .io_pop_ready         (io_pop_rValidN_3                                          ), //i
    .io_pop_payload_data  (inputsAdapter_3_crossclock_fifo_io_pop_payload_data[63:0] ), //o
    .io_pop_payload_mask  (inputsAdapter_3_crossclock_fifo_io_pop_payload_mask[7:0]  ), //o
    .io_pop_payload_sink  (inputsAdapter_3_crossclock_fifo_io_pop_payload_sink[3:0]  ), //o
    .io_pop_payload_last  (inputsAdapter_3_crossclock_fifo_io_pop_payload_last       ), //o
    .io_pushOccupancy     (inputsAdapter_3_crossclock_fifo_io_pushOccupancy[4:0]     ), //o
    .io_popOccupancy      (inputsAdapter_3_crossclock_fifo_io_popOccupancy[4:0]      ), //o
    .dat5_i_clk           (dat5_i_clk                                                ), //i
    .dat5_i_reset         (dat5_i_reset                                              ), //i
    .clk                  (clk                                                       ), //i
    .reset                (reset                                                     )  //i
  );
  EfxDMA_StreamFifoCC_4 outputsAdapter_0_crossclock_fifo (
  ...
  EfxDMA_StreamFifoCC_5 outputsAdapter_1_crossclock_fifo (
  ...
  EfxDMA_BmbArbiter interconnect_read_aggregated_arbiter (
    ...
    .io_inputs_1_cmd_payload_fragment_length  (interconnect_read_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_length[11:0] ), //i
    .io_inputs_1_cmd_payload_fragment_context (interconnect_read_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_context[21:0]), //i
  ...
  EfxDMA_BmbArbiter_1 interconnect_write_aggregated_arbiter (
    ...
    .io_inputs_0_cmd_payload_fragment_data    (interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_0_decoder_cmd_payload_fragment_data[127:0]  ), //i
    .io_inputs_0_cmd_payload_fragment_mask    (interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_0_decoder_cmd_payload_fragment_mask[15:0]   ), //i
    ...
    .io_inputs_1_cmd_payload_fragment_source  (interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_source[1:0]  ), //i
    ...
    .io_inputs_1_cmd_payload_fragment_length  (interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_length[11:0] ), //i
    .io_inputs_1_cmd_payload_fragment_data    (interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_data[127:0]  ), //i
    .io_inputs_1_cmd_payload_fragment_mask    (interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_mask[15:0]   ), //i
    .io_inputs_1_cmd_payload_fragment_context (interconnect_write_aggregated_slaveModel_arbiterGen_logic_sorted_1_decoder_cmd_payload_fragment_context[14:0]), //i
  ...
  assign dat4_i_tready = inputsAdapter_2_upsizer_logic_io_input_ready;
  assign io_pop_s2mPipe_valid_2 = (inputsAdapter_2_crossclock_fifo_io_pop_valid || (! io_pop_rValidN_2));
  assign io_pop_s2mPipe_payload_data_2 = (io_pop_rValidN_2 ? inputsAdapter_2_crossclock_fifo_io_pop_payload_data : io_pop_rData_data_2);
  assign io_pop_s2mPipe_payload_mask_2 = (io_pop_rValidN_2 ? inputsAdapter_2_crossclock_fifo_io_pop_payload_mask : io_pop_rData_mask_2);
  assign io_pop_s2mPipe_payload_sink_2 = (io_pop_rValidN_2 ? inputsAdapter_2_crossclock_fifo_io_pop_payload_sink : io_pop_rData_sink_2);
  assign io_pop_s2mPipe_payload_last_2 = (io_pop_rValidN_2 ? inputsAdapter_2_crossclock_fifo_io_pop_payload_last : io_pop_rData_last_2);
  always @(*) begin
  ...
  assign io_pop_s2mPipe_m2sPipe_payload_mask_2 = io_pop_s2mPipe_rData_mask_2;
  assign io_pop_s2mPipe_m2sPipe_payload_sink_2 = io_pop_s2mPipe_rData_sink_2;
  assign io_pop_s2mPipe_m2sPipe_payload_last_2 = io_pop_s2mPipe_rData_last_2;
  assign io_pop_s2mPipe_m2sPipe_ready_2 = core_io_inputs_2_ready;
  assign dat5_i_tready = inputsAdapter_3_upsizer_logic_io_input_ready;
  assign io_pop_s2mPipe_valid_3 = (inputsAdapter_3_crossclock_fifo_io_pop_valid || (! io_pop_rValidN_3));
  assign io_pop_s2mPipe_payload_data_3 = (io_pop_rValidN_3 ? inputsAdapter_3_crossclock_fifo_io_pop_payload_data : io_pop_rData_data_3);
  assign io_pop_s2mPipe_payload_mask_3 = (io_pop_rValidN_3 ? inputsAdapter_3_crossclock_fifo_io_pop_payload_mask : io_pop_rData_mask_3);
  assign io_pop_s2mPipe_payload_sink_3 = (io_pop_rValidN_3 ? inputsAdapter_3_crossclock_fifo_io_pop_payload_sink : io_pop_rData_sink_3);
  assign io_pop_s2mPipe_payload_last_3 = (io_pop_rValidN_3 ? inputsAdapter_3_crossclock_fifo_io_pop_payload_last : io_pop_rData_last_3);
  always @(*) begin
    io_pop_s2mPipe_ready_3 = io_pop_s2mPipe_m2sPipe_ready_3;
    if(when_Stream_l375_7) begin
      io_pop_s2mPipe_ready_3 = 1'b1;
    end
  end

  assign when_Stream_l375_7 = (! io_pop_s2mPipe_m2sPipe_valid_3);
  assign io_pop_s2mPipe_m2sPipe_valid_3 = io_pop_s2mPipe_rValid_3;
  assign io_pop_s2mPipe_m2sPipe_payload_data_3 = io_pop_s2mPipe_rData_data_3;
  assign io_pop_s2mPipe_m2sPipe_payload_mask_3 = io_pop_s2mPipe_rData_mask_3;
  assign io_pop_s2mPipe_m2sPipe_payload_sink_3 = io_pop_s2mPipe_rData_sink_3;
  assign io_pop_s2mPipe_m2sPipe_payload_last_3 = io_pop_s2mPipe_rData_last_3;
  assign io_pop_s2mPipe_m2sPipe_ready_3 = core_io_inputs_3_ready;
  ...
  assign when_Stream_l375_8 = (! outputsAdapter_0_ptr_valid);
  ...
  assign when_Stream_l375_9 = (! outputsAdapter_1_ptr_valid);
  ...
  assign sg_cmd_valid = core_io_sg_cmd_valid;
  assign sg_cmd_read = core_io_sg_cmd_payload_read;
  assign sg_cmd_write = core_io_sg_cmd_payload_write;
  assign sg_cmd_channelId = core_io_sg_cmd_payload_channelId;
  assign sg_cmd_bytesDone = core_io_sg_cmd_payload_bytesDone;
  assign sg_cmd_endOfPacket = core_io_sg_cmd_payload_endOfPacket;
  assign sg_cmd_completed = core_io_sg_cmd_payload_completed;
  ...
  always @(posedge clk) begin
    if(reset) begin
      ...
      io_pop_rValidN_3 <= 1'b1;
      io_pop_s2mPipe_rValid_3 <= 1'b0;
      ...
      if(inputsAdapter_3_crossclock_fifo_io_pop_valid) begin
        io_pop_rValidN_3 <= 1'b0;
      end
      if(io_pop_s2mPipe_ready_3) begin
        io_pop_rValidN_3 <= 1'b1;
      end
      if(io_pop_s2mPipe_ready_3) begin
        io_pop_s2mPipe_rValid_3 <= io_pop_s2mPipe_valid_3;
      end
  ...
  always @(posedge clk) begin
    ...
    if(io_pop_rValidN_2) begin
      io_pop_rData_data_2 <= inputsAdapter_2_crossclock_fifo_io_pop_payload_data;
      io_pop_rData_mask_2 <= inputsAdapter_2_crossclock_fifo_io_pop_payload_mask;
      io_pop_rData_sink_2 <= inputsAdapter_2_crossclock_fifo_io_pop_payload_sink;
      io_pop_rData_last_2 <= inputsAdapter_2_crossclock_fifo_io_pop_payload_last;
    end
    if(io_pop_s2mPipe_ready_2) begin
      io_pop_s2mPipe_rData_data_2 <= io_pop_s2mPipe_payload_data_2;
      io_pop_s2mPipe_rData_mask_2 <= io_pop_s2mPipe_payload_mask_2;
      io_pop_s2mPipe_rData_sink_2 <= io_pop_s2mPipe_payload_sink_2;
      io_pop_s2mPipe_rData_last_2 <= io_pop_s2mPipe_payload_last_2;
    end
    if(io_pop_rValidN_3) begin
      io_pop_rData_data_3 <= inputsAdapter_3_crossclock_fifo_io_pop_payload_data;
      io_pop_rData_mask_3 <= inputsAdapter_3_crossclock_fifo_io_pop_payload_mask;
      io_pop_rData_sink_3 <= inputsAdapter_3_crossclock_fifo_io_pop_payload_sink;
      io_pop_rData_last_3 <= inputsAdapter_3_crossclock_fifo_io_pop_payload_last;
    end
    if(io_pop_s2mPipe_ready_3) begin
      io_pop_s2mPipe_rData_data_3 <= io_pop_s2mPipe_payload_data_3;
      io_pop_s2mPipe_rData_mask_3 <= io_pop_s2mPipe_payload_mask_3;
      io_pop_s2mPipe_rData_sink_3 <= io_pop_s2mPipe_payload_sink_3;
      io_pop_s2mPipe_rData_last_3 <= io_pop_s2mPipe_payload_last_3;
    end
...
module EfxDMA_BmbArbiter_1 (
  ...
  input  wire [11:0]   io_inputs_1_cmd_payload_fragment_length,
  input  wire [127:0]  io_inputs_1_cmd_payload_fragment_data,
  input  wire [15:0]   io_inputs_1_cmd_payload_fragment_mask,
  input  wire [14:0]   io_inputs_1_cmd_payload_fragment_context,
  ...
  output wire [14:0]   io_inputs_1_rsp_payload_fragment_context,
  ...
  wire       [11:0]   memory_arbiter_io_inputs_0_payload_fragment_length;
  wire       [14:0]   memory_arbiter_io_inputs_0_payload_fragment_context;
  ...
  EfxDMA_StreamArbiter_1 memory_arbiter (
    ...
    .io_inputs_0_payload_fragment_length  (memory_arbiter_io_inputs_0_payload_fragment_length[11:0] ), //i
    ...
    .io_inputs_0_payload_fragment_context (memory_arbiter_io_inputs_0_payload_fragment_context[14:0]), //i
  ...
  assign memory_arbiter_io_inputs_0_payload_fragment_length = {10'd0, io_inputs_0_cmd_payload_fragment_length};
  assign memory_arbiter_io_inputs_0_payload_fragment_context = {14'd0, io_inputs_0_cmd_payload_fragment_context};
...
module EfxDMA_BmbArbiter (
  ...
  output wire          io_inputs_0_rsp_payload_last,
  output wire [0:0]    io_inputs_0_rsp_payload_fragment_opcode,
  output wire [127:0]  io_inputs_0_rsp_payload_fragment_data,
  output wire [0:0]    io_inputs_0_rsp_payload_fragment_context,
  input  wire          io_inputs_1_cmd_valid,
  output wire          io_inputs_1_cmd_ready,
  input  wire          io_inputs_1_cmd_payload_last,
  ...
  input  wire [31:0]   io_inputs_1_cmd_payload_fragment_address,
  input  wire [11:0]   io_inputs_1_cmd_payload_fragment_length,
  input  wire [21:0]   io_inputs_1_cmd_payload_fragment_context,
  output wire          io_inputs_1_rsp_valid,
  input  wire          io_inputs_1_rsp_ready,
  output wire          io_inputs_1_rsp_payload_last,
  output wire [0:0]    io_inputs_1_rsp_payload_fragment_source,
  output wire [0:0]    io_inputs_1_rsp_payload_fragment_opcode,
  output wire [127:0]  io_inputs_1_rsp_payload_fragment_data,
  output wire [21:0]   io_inputs_1_rsp_payload_fragment_context,
  output wire          io_output_cmd_valid,
  input  wire          io_output_cmd_ready,
  output wire          io_output_cmd_payload_last,
  ...
  output wire [31:0]   io_output_cmd_payload_fragment_address,
  output wire [11:0]   io_output_cmd_payload_fragment_length,
  output wire [21:0]   io_output_cmd_payload_fragment_context,
  input  wire          io_output_rsp_valid,
  output wire          io_output_rsp_ready,
  input  wire          io_output_rsp_payload_last,
  ...
  input  wire [21:0]   io_output_rsp_payload_fragment_context,
  input  wire          clk,
  input  wire          reset
);

  wire       [11:0]   memory_arbiter_io_inputs_0_payload_fragment_length;
  wire       [21:0]   memory_arbiter_io_inputs_0_payload_fragment_context;
  ...
  EfxDMA_StreamArbiter memory_arbiter (
    ...
    .io_inputs_0_payload_fragment_address (io_inputs_0_cmd_payload_fragment_address[31:0]           ), //i
    .io_inputs_0_payload_fragment_length  (memory_arbiter_io_inputs_0_payload_fragment_length[11:0] ), //i
    .io_inputs_0_payload_fragment_context (memory_arbiter_io_inputs_0_payload_fragment_context[21:0]), //i
    .io_inputs_1_valid                    (io_inputs_1_cmd_valid                                    ), //i
    .io_inputs_1_ready                    (memory_arbiter_io_inputs_1_ready                         ), //o
    .io_inputs_1_payload_last             (io_inputs_1_cmd_payload_last                             ), //i
  ...
  assign io_inputs_0_cmd_ready = memory_arbiter_io_inputs_0_ready;
  assign memory_arbiter_io_inputs_0_payload_fragment_length = {7'd0, io_inputs_0_cmd_payload_fragment_length};
  assign memory_arbiter_io_inputs_0_payload_fragment_context = {21'd0, io_inputs_0_cmd_payload_fragment_context};
  assign io_inputs_1_cmd_ready = memory_arbiter_io_inputs_1_ready;
  assign memory_arbiter_io_inputs_1_payload_fragment_source = {1'd0, io_inputs_1_cmd_payload_fragment_source};
  assign io_output_cmd_valid = memory_arbiter_io_output_valid;
  assign io_output_cmd_payload_last = memory_arbiter_io_output_payload_last;
...
module EfxDMA_StreamFifoCC_5 (
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_13 pushToPopGray_buffercc (
...
module EfxDMA_StreamFifoCC_3 (
  ...
  assign _zz_popCC_popPtrGray = (popCC_popPtr >>> 1'b1);
  assign _zz_ram_port_1 = {io_push_payload_last,{io_push_payload_sink,{io_push_payload_mask,io_push_payload_data}}};
  always @(posedge dat5_i_clk) begin
    if(_zz_1) begin
      ram[_zz_ram_port] <= _zz_ram_port_1;
    end
  end
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_8 popToPushGray_buffercc (
    .io_dataIn    (popToPushGray[4:0]                    ), //i
    .io_dataOut   (popToPushGray_buffercc_io_dataOut[4:0]), //o
    .dat5_i_clk   (dat5_i_clk                            ), //i
    .dat5_i_reset (dat5_i_reset                          )  //i
...
module EfxDMA_BsbUpSizerDense_2 (
...
module EfxDMA_StreamFifoCC_2 (
  ...
  assign _zz_popCC_popPtrGray = (popCC_popPtr >>> 1'b1);
  assign _zz_ram_port_1 = {io_push_payload_last,{io_push_payload_sink,{io_push_payload_mask,io_push_payload_data}}};
  always @(posedge dat4_i_clk) begin
    if(_zz_1) begin
      ram[_zz_ram_port] <= _zz_ram_port_1;
    end
  end
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_6 popToPushGray_buffercc (
    .io_dataIn    (popToPushGray[4:0]                    ), //i
    .io_dataOut   (popToPushGray_buffercc_io_dataOut[4:0]), //o
    .dat4_i_clk   (dat4_i_clk                            ), //i
    .dat4_i_reset (dat4_i_reset                          )  //i
...
module EfxDMA_BmbSourceRemover_1 (
  ...
  assign rspContext_source = _zz_rspContext_source[2 : 0];
  assign rspContext_context = _zz_rspContext_source[17 : 3];
...
module EfxDMA_BmbSourceRemover (
  ...
  assign rspContext_context = _zz_rspContext_source[23 : 2];
  assign io_input_rsp_valid = io_output_rsp_valid;
  assign io_output_rsp_ready = io_input_rsp_ready;
  assign io_input_rsp_payload_last = io_output_rsp_payload_last;
  assign io_input_rsp_payload_fragment_opcode = io_output_rsp_payload_fragment_opcode;
...
module EfxDMA_Core (
  ...
  input  wire [127:0]  io_sgRead_rsp_payload_fragment_data,
  ...
  output wire [1:0]    io_write_cmd_payload_fragment_source,
  ...
  input  wire [1:0]    io_write_rsp_payload_fragment_source,
  ...
  input  wire [3:0]    io_inputs_2_payload_sink,
  input  wire          io_inputs_2_payload_last,
  input  wire          io_inputs_3_valid,
  output reg           io_inputs_3_ready,
  input  wire [63:0]   io_inputs_3_payload_data,
  input  wire [7:0]    io_inputs_3_payload_mask,
  input  wire [3:0]    io_inputs_3_payload_sink,
  ...
  output wire          io_sg_cmd_valid,
  input  wire          io_sg_cmd_ready,
  output wire          io_sg_cmd_payload_read,
  output wire          io_sg_cmd_payload_write,
  output wire [2:0]    io_sg_cmd_payload_channelId,
  output wire [26:0]   io_sg_cmd_payload_bytesDone,
  output wire          io_sg_cmd_payload_endOfPacket,
  output wire          io_sg_cmd_payload_completed,
  input  wire          io_sg_rsp_valid,
  input  wire [2:0]    io_sg_rsp_payload_channelId,
  input  wire [31:0]   io_sg_rsp_payload_srcAddress,
  input  wire [31:0]   io_sg_rsp_payload_dstAddress,
  input  wire [25:0]   io_sg_rsp_payload_bytes,
  input  wire          io_sg_rsp_payload_last,
  input  wire          io_sg_rsp_payload_stall,
  ...
  wire       [6:0]    memory_core_io_writes_3_cmd_payload_context;
  wire       [12:0]   memory_core_io_writes_4_cmd_payload_address;
  reg        [15:0]   memory_core_io_writes_4_cmd_payload_mask;
  wire       [7:0]    memory_core_io_writes_4_cmd_payload_context;
  ...
  wire       [6:0]    memory_core_io_writes_3_rsp_payload_context;
  wire                memory_core_io_writes_4_cmd_ready;
  wire                memory_core_io_writes_4_rsp_valid;
  wire       [7:0]    memory_core_io_writes_4_rsp_payload_context;
  ...
  wire       [16:0]   _zz_channels_4_fifo_pop_withOverride_backupNext;
  wire       [16:0]   _zz_channels_4_fifo_pop_withOverride_exposed;
  wire       [26:0]   _zz_channels_4_pop_b2m_selfFlush;
  wire       [16:0]   _zz_channels_4_pop_b2m_request;
  wire       [13:0]   _zz_channels_4_pop_b2m_request_1;
  wire       [12:0]   _zz_channels_4_pop_b2m_request_2;
  wire       [3:0]    _zz_channels_4_pop_b2m_memPending;
  wire       [3:0]    _zz_channels_4_pop_b2m_memPending_1;
  wire       [0:0]    _zz_channels_4_pop_b2m_memPending_2;
  wire       [3:0]    _zz_channels_4_pop_b2m_memPending_3;
  wire       [0:0]    _zz_channels_4_pop_b2m_memPending_4;
  wire       [13:0]   _zz_channels_4_fifo_push_available;
  wire       [16:0]   _zz_channels_5_fifo_pop_withOverride_backupNext;
  wire       [16:0]   _zz_channels_5_fifo_pop_withOverride_exposed;
  wire       [26:0]   _zz_channels_5_pop_b2m_selfFlush;
  wire       [16:0]   _zz_channels_5_pop_b2m_request;
  wire       [13:0]   _zz_channels_5_pop_b2m_request_1;
  wire       [12:0]   _zz_channels_5_pop_b2m_request_2;
  wire       [3:0]    _zz_channels_5_pop_b2m_memPending;
  wire       [3:0]    _zz_channels_5_pop_b2m_memPending_1;
  wire       [0:0]    _zz_channels_5_pop_b2m_memPending_2;
  wire       [3:0]    _zz_channels_5_pop_b2m_memPending_3;
  wire       [0:0]    _zz_channels_5_pop_b2m_memPending_4;
  ...
  wire       [3:0]    _zz_s2b_2_cmd_byteCount_8;
  reg        [3:0]    _zz_s2b_2_cmd_byteCount_9;
  wire       [2:0]    _zz_s2b_2_cmd_byteCount_10;
  reg        [3:0]    _zz_s2b_2_cmd_byteCount_11;
  wire       [2:0]    _zz_s2b_2_cmd_byteCount_12;
  reg        [3:0]    _zz_s2b_2_cmd_byteCount_13;
  wire       [2:0]    _zz_s2b_2_cmd_byteCount_14;
  wire       [1:0]    _zz_s2b_2_cmd_byteCount_15;
  wire       [0:0]    _zz_s2b_3_cmd_firsts;
  wire       [4:0]    _zz_s2b_3_cmd_firsts_1;
  wire       [3:0]    _zz_s2b_3_cmd_byteCount_8;
  reg        [3:0]    _zz_s2b_3_cmd_byteCount_9;
  wire       [2:0]    _zz_s2b_3_cmd_byteCount_10;
  reg        [3:0]    _zz_s2b_3_cmd_byteCount_11;
  wire       [2:0]    _zz_s2b_3_cmd_byteCount_12;
  reg        [3:0]    _zz_s2b_3_cmd_byteCount_13;
  wire       [2:0]    _zz_s2b_3_cmd_byteCount_14;
  wire       [1:0]    _zz_s2b_3_cmd_byteCount_15;
  ...
  reg        [13:0]   _zz_io_writes_4_cmd_payload_address;
  wire       [7:0]    _zz__zz_b2m_fsm_arbiter_logic_priority_chosenOh_2;
  wire       [7:0]    _zz__zz_b2m_fsm_arbiter_logic_priority_chosenOh_2_1;
  wire       [3:0]    _zz__zz_b2m_fsm_arbiter_logic_priority_chosenOh_2_2;
  reg        [3:0]    _zz__zz_b2m_fsm_arbiter_logic_priority_chosenOh_2_3;
  ...
  wire       [0:0]    _zz_channels_4_interrupts_s2mPacket_valid;
  ...
  wire       [0:0]    _zz_channels_5_interrupts_s2mPacket_valid;
  ...
  wire       [0:0]    _zz_channels_4_fifo_push_ptrIncr_value_1;
  wire       [16:0]   _zz_channels_4_fifo_pop_bytesIncr_value_1;
  wire       [3:0]    _zz_channels_4_fifo_pop_bytesIncr_value_2;
  wire       [13:0]   _zz_channels_4_fifo_pop_ptrIncr_value;
  wire       [1:0]    _zz_channels_4_fifo_pop_ptrIncr_value_1;
  wire       [13:0]   _zz_channels_5_fifo_push_ptrIncr_value;
  wire       [0:0]    _zz_channels_5_fifo_push_ptrIncr_value_1;
  wire       [16:0]   _zz_channels_5_fifo_pop_bytesIncr_value_1;
  wire       [3:0]    _zz_channels_5_fifo_pop_bytesIncr_value_2;
  wire       [13:0]   _zz_channels_5_fifo_pop_ptrIncr_value;
  wire       [1:0]    _zz_channels_5_fifo_pop_ptrIncr_value_1;
  ...
  reg        [0:0]    channels_2_pop_b2s_portId;
  ...
  wire       [13:0]   channels_4_fifo_push_availableDecr;
  ...
  reg        [16:0]   channels_4_fifo_pop_withOverride_backup;
  wire       [16:0]   channels_4_fifo_pop_withOverride_backupNext;
  reg                 channels_4_fifo_pop_withOverride_load;
  reg                 channels_4_fifo_pop_withOverride_unload;
  reg        [16:0]   channels_4_fifo_pop_withOverride_exposed;
  reg                 channels_4_fifo_pop_withOverride_valid;
  wire                when_DmaSg_l409_2;
  wire                channels_4_fifo_empty;
  reg                 channels_4_push_memory;
  reg                 channels_4_push_s2b_completionOnLast;
  reg                 channels_4_push_s2b_packetEvent;
  reg                 channels_4_push_s2b_packetLock;
  reg                 channels_4_push_s2b_waitFirst;
  wire                when_DmaSg_l457_2;
  reg                 channels_4_pop_memory;
  wire       [11:0]   channels_4_pop_b2m_bytePerBurst;
  reg                 channels_4_pop_b2m_fire;
  reg                 channels_4_pop_b2m_waitFinalRsp;
  reg                 channels_4_pop_b2m_flush;
  reg                 channels_4_pop_b2m_packetSync;
  reg                 channels_4_pop_b2m_packet;
  wire                when_DmaSg_l505_2;
  reg                 channels_4_pop_b2m_memRsp;
  reg        [3:0]    channels_4_pop_b2m_memPending;
  reg        [31:0]   channels_4_pop_b2m_address;
  reg        [26:0]   channels_4_pop_b2m_bytesLeft;
  wire                channels_4_pop_b2m_selfFlush;
  wire                channels_4_pop_b2m_request;
  reg        [3:0]    channels_4_pop_b2m_bytesToSkip;
  reg        [16:0]   channels_4_pop_b2m_decrBytes;
  reg                 channels_4_pop_b2m_memPendingInc;
  wire                when_DmaSg_l523_2;
  wire                when_DmaSg_l532_2;
  wire                when_DmaSg_l547_2;
  wire                when_DmaSg_l563_2;
  wire                channels_4_readyForChannelCompletion;
  ...
  reg                 channels_4_interrupts_s2mPacket_enable;
  reg                 channels_4_interrupts_s2mPacket_valid;
  wire                when_DmaSg_l255_24;
  ...
  wire       [13:0]   channels_5_fifo_push_availableDecr;
  ...
  reg        [16:0]   channels_5_fifo_pop_withOverride_backup;
  wire       [16:0]   channels_5_fifo_pop_withOverride_backupNext;
  reg                 channels_5_fifo_pop_withOverride_load;
  reg                 channels_5_fifo_pop_withOverride_unload;
  reg        [16:0]   channels_5_fifo_pop_withOverride_exposed;
  reg                 channels_5_fifo_pop_withOverride_valid;
  wire                when_DmaSg_l409_3;
  wire                channels_5_fifo_empty;
  reg                 channels_5_push_memory;
  reg                 channels_5_push_s2b_completionOnLast;
  reg                 channels_5_push_s2b_packetEvent;
  reg                 channels_5_push_s2b_packetLock;
  reg                 channels_5_push_s2b_waitFirst;
  wire                when_DmaSg_l457_3;
  reg                 channels_5_pop_memory;
  wire       [11:0]   channels_5_pop_b2m_bytePerBurst;
  reg                 channels_5_pop_b2m_fire;
  reg                 channels_5_pop_b2m_waitFinalRsp;
  reg                 channels_5_pop_b2m_flush;
  reg                 channels_5_pop_b2m_packetSync;
  reg                 channels_5_pop_b2m_packet;
  wire                when_DmaSg_l505_3;
  reg                 channels_5_pop_b2m_memRsp;
  reg        [3:0]    channels_5_pop_b2m_memPending;
  reg        [31:0]   channels_5_pop_b2m_address;
  reg        [26:0]   channels_5_pop_b2m_bytesLeft;
  wire                channels_5_pop_b2m_selfFlush;
  wire                channels_5_pop_b2m_request;
  reg        [3:0]    channels_5_pop_b2m_bytesToSkip;
  reg        [16:0]   channels_5_pop_b2m_decrBytes;
  reg                 channels_5_pop_b2m_memPendingInc;
  wire                when_DmaSg_l523_3;
  wire                when_DmaSg_l532_3;
  wire                when_DmaSg_l547_3;
  wire                when_DmaSg_l563_3;
  wire                channels_5_readyForChannelCompletion;
  wire                when_DmaSg_l575_5;
  ...
  reg                 channels_5_interrupts_s2mPacket_enable;
  reg                 channels_5_interrupts_s2mPacket_valid;
  wire                when_DmaSg_l255_29;
  ...
  wire       [63:0]   io_inputs_2_thrown_payload_data;
  wire       [7:0]    io_inputs_2_thrown_payload_mask;
  ...
  wire       [63:0]   s2b_2_cmd_sinkHalted_payload_data;
  wire       [7:0]    s2b_2_cmd_sinkHalted_payload_mask;
  wire       [3:0]    s2b_2_cmd_sinkHalted_payload_sink;
  wire                s2b_2_cmd_sinkHalted_payload_last;
  wire       [3:0]    _zz_s2b_2_cmd_byteCount;
  wire       [3:0]    _zz_s2b_2_cmd_byteCount_1;
  wire       [3:0]    _zz_s2b_2_cmd_byteCount_2;
  wire       [3:0]    _zz_s2b_2_cmd_byteCount_3;
  wire       [3:0]    _zz_s2b_2_cmd_byteCount_4;
  wire       [3:0]    _zz_s2b_2_cmd_byteCount_5;
  wire       [3:0]    _zz_s2b_2_cmd_byteCount_6;
  wire       [3:0]    _zz_s2b_2_cmd_byteCount_7;
  wire       [3:0]    s2b_2_cmd_byteCount;
  wire       [0:0]    s2b_2_cmd_context_channel;
  wire       [3:0]    s2b_2_cmd_context_bytes;
  wire                s2b_2_cmd_context_flush;
  wire                s2b_2_cmd_context_packet;
  wire                memory_core_io_writes_2_cmd_fire;
  wire                when_DmaSg_l665_2;
  wire       [0:0]    s2b_2_rsp_context_channel;
  wire       [3:0]    s2b_2_rsp_context_bytes;
  wire                s2b_2_rsp_context_flush;
  wire                s2b_2_rsp_context_packet;
  wire       [6:0]    _zz_s2b_2_rsp_context_channel;
  wire                _zz_channels_4_fifo_pop_bytesIncr_value;
  wire                when_DmaSg_l679_2;
  wire                when_DmaSg_l681_2;
  wire                when_DmaSg_l682_2;
  wire                io_inputs_3_fire;
  wire                when_package_l12_48;
  reg                 io_inputs_3_payload_last_regNextWhen;
  wire                when_package_l12_49;
  reg                 io_inputs_3_payload_last_regNextWhen_1;
  wire                when_package_l12_50;
  reg                 io_inputs_3_payload_last_regNextWhen_2;
  wire                when_package_l12_51;
  reg                 io_inputs_3_payload_last_regNextWhen_3;
  wire                when_package_l12_52;
  reg                 io_inputs_3_payload_last_regNextWhen_4;
  wire                when_package_l12_53;
  reg                 io_inputs_3_payload_last_regNextWhen_5;
  wire                when_package_l12_54;
  reg                 io_inputs_3_payload_last_regNextWhen_6;
  wire                when_package_l12_55;
  reg                 io_inputs_3_payload_last_regNextWhen_7;
  wire                when_package_l12_56;
  reg                 io_inputs_3_payload_last_regNextWhen_8;
  wire                when_package_l12_57;
  reg                 io_inputs_3_payload_last_regNextWhen_9;
  wire                when_package_l12_58;
  reg                 io_inputs_3_payload_last_regNextWhen_10;
  wire                when_package_l12_59;
  reg                 io_inputs_3_payload_last_regNextWhen_11;
  wire                when_package_l12_60;
  reg                 io_inputs_3_payload_last_regNextWhen_12;
  wire                when_package_l12_61;
  reg                 io_inputs_3_payload_last_regNextWhen_13;
  wire                when_package_l12_62;
  reg                 io_inputs_3_payload_last_regNextWhen_14;
  wire                when_package_l12_63;
  reg                 io_inputs_3_payload_last_regNextWhen_15;
  wire       [15:0]   s2b_3_cmd_firsts;
  wire                s2b_3_cmd_first;
  wire       [0:0]    s2b_3_cmd_channelsOh;
  wire                s2b_3_cmd_noHit;
  wire       [0:0]    s2b_3_cmd_channelsFull;
  reg                 io_inputs_3_thrown_valid;
  wire                io_inputs_3_thrown_ready;
  wire       [63:0]   io_inputs_3_thrown_payload_data;
  wire       [7:0]    io_inputs_3_thrown_payload_mask;
  wire       [3:0]    io_inputs_3_thrown_payload_sink;
  wire                io_inputs_3_thrown_payload_last;
  wire                _zz_io_inputs_3_thrown_ready;
  wire                s2b_3_cmd_sinkHalted_valid;
  wire                s2b_3_cmd_sinkHalted_ready;
  wire       [63:0]   s2b_3_cmd_sinkHalted_payload_data;
  wire       [7:0]    s2b_3_cmd_sinkHalted_payload_mask;
  wire       [3:0]    s2b_3_cmd_sinkHalted_payload_sink;
  wire                s2b_3_cmd_sinkHalted_payload_last;
  wire       [3:0]    _zz_s2b_3_cmd_byteCount;
  wire       [3:0]    _zz_s2b_3_cmd_byteCount_1;
  wire       [3:0]    _zz_s2b_3_cmd_byteCount_2;
  wire       [3:0]    _zz_s2b_3_cmd_byteCount_3;
  wire       [3:0]    _zz_s2b_3_cmd_byteCount_4;
  wire       [3:0]    _zz_s2b_3_cmd_byteCount_5;
  wire       [3:0]    _zz_s2b_3_cmd_byteCount_6;
  wire       [3:0]    _zz_s2b_3_cmd_byteCount_7;
  wire       [3:0]    s2b_3_cmd_byteCount;
  wire       [0:0]    s2b_3_cmd_context_channel;
  wire       [3:0]    s2b_3_cmd_context_bytes;
  wire                s2b_3_cmd_context_flush;
  wire                s2b_3_cmd_context_packet;
  wire                memory_core_io_writes_3_cmd_fire;
  wire                when_DmaSg_l665_3;
  wire       [0:0]    s2b_3_rsp_context_channel;
  wire       [3:0]    s2b_3_rsp_context_bytes;
  wire                s2b_3_rsp_context_flush;
  wire                s2b_3_rsp_context_packet;
  wire       [6:0]    _zz_s2b_3_rsp_context_channel;
  wire                _zz_channels_5_fifo_pop_bytesIncr_value;
  wire                when_DmaSg_l679_3;
  wire                when_DmaSg_l681_3;
  wire                when_DmaSg_l682_3;
  ...
  wire                memory_core_io_writes_4_cmd_fire;
  ...
  wire                _zz_b2m_fsm_arbiter_logic_priority_masked_4;
  wire       [1:0]    _zz_b2m_fsm_arbiter_logic_priority_masked_5;
  wire                _zz_b2m_fsm_arbiter_logic_priority_masked_6;
  wire       [1:0]    _zz_b2m_fsm_arbiter_logic_priority_masked_7;
  wire                _zz_b2m_fsm_arbiter_logic_priority_masked_8;
  wire       [1:0]    _zz_b2m_fsm_arbiter_logic_priority_masked_9;
  wire                _zz_b2m_fsm_arbiter_logic_priority_masked_10;
  wire       [1:0]    _zz_b2m_fsm_arbiter_logic_priority_masked_11;
  wire       [1:0]    _zz_b2m_fsm_arbiter_logic_priority_masked_12;
  wire       [3:0]    b2m_fsm_arbiter_logic_priority_masked;
  reg        [3:0]    b2m_fsm_arbiter_logic_priority_roundRobins_0;
  reg        [3:0]    b2m_fsm_arbiter_logic_priority_roundRobins_1;
  reg        [3:0]    b2m_fsm_arbiter_logic_priority_roundRobins_2;
  reg        [3:0]    b2m_fsm_arbiter_logic_priority_roundRobins_3;
  reg        [1:0]    b2m_fsm_arbiter_logic_priority_counter;
  wire       [3:0]    _zz_b2m_fsm_arbiter_logic_priority_chosenOh;
  wire       [7:0]    _zz_b2m_fsm_arbiter_logic_priority_chosenOh_1;
  wire       [7:0]    _zz_b2m_fsm_arbiter_logic_priority_chosenOh_2;
  wire       [3:0]    b2m_fsm_arbiter_logic_priority_chosenOh;
  wire                _zz_b2m_fsm_arbiter_logic_priority_chosen;
  wire                _zz_b2m_fsm_arbiter_logic_priority_chosen_1;
  wire                _zz_b2m_fsm_arbiter_logic_priority_chosen_2;
  wire       [1:0]    b2m_fsm_arbiter_logic_priority_chosen;
  wire                b2m_fsm_arbiter_logic_priority_weightLast;
  wire       [3:0]    b2m_fsm_arbiter_logic_priority_contextNext;
  ...
  wire                when_DmaSg_l996_2;
  wire                when_DmaSg_l1001_2;
  wire                when_DmaSg_l996_3;
  wire                when_DmaSg_l1001_3;
  reg                 b2m_fsm_toggle;
  ...
  wire                when_DmaSg_l1116_2;
  wire                when_DmaSg_l1116_3;
  ...
  wire       [2:0]    ll_cmd_sgStreamLogic_channelId;
  wire                io_sg_cmd_fire;
  ...
  wire       [7:0]    ll_sgRsp_oh;
  wire                when_DmaSg_l1285;
  wire                when_DmaSg_l1285_1;
  ...
  wire                when_Apb3SlaveFactory_l81_6;
  wire                when_Apb3SlaveFactory_l81_7;
  ...
  assign _zz_channels_0_bytesProbe_value_1 = {15'd0, channels_0_bytesProbe_incr_payload};
  ...
  assign _zz_channels_1_bytesProbe_value_1 = {15'd0, channels_1_bytesProbe_incr_payload};
  ...
  assign _zz_channels_4_fifo_pop_withOverride_backupNext = (channels_4_fifo_pop_withOverride_backup + channels_4_fifo_pop_bytesIncr_value);
  assign _zz_channels_4_fifo_pop_withOverride_exposed = (channels_4_fifo_pop_withOverride_exposed - channels_4_fifo_pop_bytesDecr_value);
  assign _zz_channels_4_pop_b2m_selfFlush = {10'd0, channels_4_fifo_pop_bytes};
  assign _zz_channels_4_pop_b2m_request = {5'd0, channels_4_pop_b2m_bytePerBurst};
  assign _zz_channels_4_pop_b2m_request_2 = (channels_4_fifo_words >>> 1'd1);
  assign _zz_channels_4_pop_b2m_request_1 = {1'd0, _zz_channels_4_pop_b2m_request_2};
  assign _zz_channels_4_pop_b2m_memPending = (channels_4_pop_b2m_memPending + _zz_channels_4_pop_b2m_memPending_1);
  assign _zz_channels_4_pop_b2m_memPending_2 = channels_4_pop_b2m_memPendingInc;
  assign _zz_channels_4_pop_b2m_memPending_1 = {3'd0, _zz_channels_4_pop_b2m_memPending_2};
  assign _zz_channels_4_pop_b2m_memPending_4 = channels_4_pop_b2m_memRsp;
  assign _zz_channels_4_pop_b2m_memPending_3 = {3'd0, _zz_channels_4_pop_b2m_memPending_4};
  assign _zz_channels_4_fifo_push_available = (channels_4_fifo_push_available + channels_4_fifo_pop_ptrIncr_value_regNext);
  assign _zz_channels_5_fifo_pop_withOverride_backupNext = (channels_5_fifo_pop_withOverride_backup + channels_5_fifo_pop_bytesIncr_value);
  assign _zz_channels_5_fifo_pop_withOverride_exposed = (channels_5_fifo_pop_withOverride_exposed - channels_5_fifo_pop_bytesDecr_value);
  assign _zz_channels_5_pop_b2m_selfFlush = {10'd0, channels_5_fifo_pop_bytes};
  assign _zz_channels_5_pop_b2m_request = {5'd0, channels_5_pop_b2m_bytePerBurst};
  assign _zz_channels_5_pop_b2m_request_2 = (channels_5_fifo_words >>> 1'd1);
  assign _zz_channels_5_pop_b2m_request_1 = {1'd0, _zz_channels_5_pop_b2m_request_2};
  assign _zz_channels_5_pop_b2m_memPending = (channels_5_pop_b2m_memPending + _zz_channels_5_pop_b2m_memPending_1);
  assign _zz_channels_5_pop_b2m_memPending_2 = channels_5_pop_b2m_memPendingInc;
  assign _zz_channels_5_pop_b2m_memPending_1 = {3'd0, _zz_channels_5_pop_b2m_memPending_2};
  assign _zz_channels_5_pop_b2m_memPending_4 = channels_5_pop_b2m_memRsp;
  assign _zz_channels_5_pop_b2m_memPending_3 = {3'd0, _zz_channels_5_pop_b2m_memPending_4};
  ...
  assign _zz_s2b_2_cmd_byteCount_8 = (_zz_s2b_2_cmd_byteCount_9 + _zz_s2b_2_cmd_byteCount_11);
  assign _zz_s2b_2_cmd_byteCount_15 = {s2b_2_cmd_sinkHalted_payload_mask[7],s2b_2_cmd_sinkHalted_payload_mask[6]};
  assign _zz_s2b_2_cmd_byteCount_14 = {1'd0, _zz_s2b_2_cmd_byteCount_15};
  assign _zz_s2b_3_cmd_byteCount_8 = (_zz_s2b_3_cmd_byteCount_9 + _zz_s2b_3_cmd_byteCount_11);
  assign _zz_s2b_3_cmd_byteCount_15 = {s2b_3_cmd_sinkHalted_payload_mask[7],s2b_3_cmd_sinkHalted_payload_mask[6]};
  assign _zz_s2b_3_cmd_byteCount_14 = {1'd0, _zz_s2b_3_cmd_byteCount_15};
  ...
  assign _zz__zz_b2m_fsm_arbiter_logic_priority_chosenOh_2_1 = {4'd0, _zz__zz_b2m_fsm_arbiter_logic_priority_chosenOh_2_2};
  ...
  assign _zz_channels_4_interrupts_s2mPacket_valid = 1'b0;
  ...
  assign _zz_channels_5_interrupts_s2mPacket_valid = 1'b0;
  ...
  assign _zz_channels_2_fifo_push_ptrIncr_value_1 = ((memory_core_io_writes_4_cmd_fire && (m2b_rsp_context_channel == 1'b1)) ? 2'b10 : 2'b00);
  ...
  assign _zz_channels_3_fifo_pop_ptrIncr_value_1 = ((b2m_fsm_cmd_doPtrIncr && (b2m_fsm_sel_channel == 2'b01)) ? 2'b10 : 2'b00);
  assign _zz_channels_3_fifo_pop_ptrIncr_value = {12'd0, _zz_channels_3_fifo_pop_ptrIncr_value_1};
  assign _zz_channels_4_fifo_push_ptrIncr_value_1 = ((when_DmaSg_l665_2 && (|s2b_2_cmd_sinkHalted_payload_mask)) ? 1'b1 : 1'b0);
  assign _zz_channels_4_fifo_push_ptrIncr_value = {13'd0, _zz_channels_4_fifo_push_ptrIncr_value_1};
  assign _zz_channels_4_fifo_pop_bytesIncr_value_2 = (_zz_channels_4_fifo_pop_bytesIncr_value ? s2b_2_rsp_context_bytes : 4'b0000);
  assign _zz_channels_4_fifo_pop_bytesIncr_value_1 = {13'd0, _zz_channels_4_fifo_pop_bytesIncr_value_2};
  assign _zz_channels_4_fifo_pop_ptrIncr_value_1 = ((b2m_fsm_cmd_doPtrIncr && (b2m_fsm_sel_channel == 2'b10)) ? 2'b10 : 2'b00);
  assign _zz_channels_4_fifo_pop_ptrIncr_value = {12'd0, _zz_channels_4_fifo_pop_ptrIncr_value_1};
  assign _zz_channels_5_fifo_push_ptrIncr_value_1 = ((when_DmaSg_l665_3 && (|s2b_3_cmd_sinkHalted_payload_mask)) ? 1'b1 : 1'b0);
  assign _zz_channels_5_fifo_push_ptrIncr_value = {13'd0, _zz_channels_5_fifo_push_ptrIncr_value_1};
  assign _zz_channels_5_fifo_pop_bytesIncr_value_2 = (_zz_channels_5_fifo_pop_bytesIncr_value ? s2b_3_rsp_context_bytes : 4'b0000);
  assign _zz_channels_5_fifo_pop_bytesIncr_value_1 = {13'd0, _zz_channels_5_fifo_pop_bytesIncr_value_2};
  assign _zz_channels_5_fifo_pop_ptrIncr_value_1 = ((b2m_fsm_cmd_doPtrIncr && (b2m_fsm_sel_channel == 2'b11)) ? 2'b10 : 2'b00);
  ...
  assign _zz_s2b_2_cmd_byteCount_10 = {s2b_2_cmd_sinkHalted_payload_mask[2],{s2b_2_cmd_sinkHalted_payload_mask[1],s2b_2_cmd_sinkHalted_payload_mask[0]}};
  assign _zz_s2b_2_cmd_byteCount_12 = {s2b_2_cmd_sinkHalted_payload_mask[5],{s2b_2_cmd_sinkHalted_payload_mask[4],s2b_2_cmd_sinkHalted_payload_mask[3]}};
  assign _zz_s2b_3_cmd_byteCount_10 = {s2b_3_cmd_sinkHalted_payload_mask[2],{s2b_3_cmd_sinkHalted_payload_mask[1],s2b_3_cmd_sinkHalted_payload_mask[0]}};
  assign _zz_s2b_3_cmd_byteCount_12 = {s2b_3_cmd_sinkHalted_payload_mask[5],{s2b_3_cmd_sinkHalted_payload_mask[4],s2b_3_cmd_sinkHalted_payload_mask[3]}};
  ...
  assign _zz_s2b_3_cmd_firsts = io_inputs_3_payload_last_regNextWhen_5;
  assign _zz_s2b_3_cmd_firsts_1 = {io_inputs_3_payload_last_regNextWhen_4,{io_inputs_3_payload_last_regNextWhen_3,{io_inputs_3_payload_last_regNextWhen_2,{io_inputs_3_payload_last_regNextWhen_1,io_inputs_3_payload_last_regNextWhen}}}};
  ...
  EfxDMA_DmaMemoryCore memory_core (
    ...
    .io_writes_2_cmd_payload_data     (s2b_2_cmd_sinkHalted_payload_data[63:0]          ), //i
    .io_writes_2_cmd_payload_mask     (s2b_2_cmd_sinkHalted_payload_mask[7:0]           ), //i
    .io_writes_2_cmd_payload_priority (channels_4_priority[1:0]                         ), //i
    ...
    .io_writes_3_cmd_valid            (s2b_3_cmd_sinkHalted_valid                       ), //i
    ...
    .io_writes_3_cmd_payload_data     (s2b_3_cmd_sinkHalted_payload_data[63:0]          ), //i
    .io_writes_3_cmd_payload_mask     (s2b_3_cmd_sinkHalted_payload_mask[7:0]           ), //i
    .io_writes_3_cmd_payload_priority (channels_5_priority[1:0]                         ), //i
    .io_writes_3_cmd_payload_context  (memory_core_io_writes_3_cmd_payload_context[6:0] ), //i
    .io_writes_3_rsp_valid            (memory_core_io_writes_3_rsp_valid                ), //o
    .io_writes_3_rsp_payload_context  (memory_core_io_writes_3_rsp_payload_context[6:0] ), //o
    .io_writes_4_cmd_valid            (io_read_rsp_valid                                ), //i
    .io_writes_4_cmd_ready            (memory_core_io_writes_4_cmd_ready                ), //o
    .io_writes_4_cmd_payload_address  (memory_core_io_writes_4_cmd_payload_address[12:0]), //i
    .io_writes_4_cmd_payload_data     (io_read_rsp_payload_fragment_data[127:0]         ), //i
    .io_writes_4_cmd_payload_mask     (memory_core_io_writes_4_cmd_payload_mask[15:0]   ), //i
    .io_writes_4_cmd_payload_context  (memory_core_io_writes_4_cmd_payload_context[7:0] ), //i
    .io_writes_4_rsp_valid            (memory_core_io_writes_4_rsp_valid                ), //o
    .io_writes_4_rsp_payload_context  (memory_core_io_writes_4_rsp_payload_context[7:0] ), //o
  ...
  always @(*) begin
    case(_zz_s2b_2_cmd_byteCount_10)
      3'b000 : _zz_s2b_2_cmd_byteCount_9 = _zz_s2b_2_cmd_byteCount;
      3'b001 : _zz_s2b_2_cmd_byteCount_9 = _zz_s2b_2_cmd_byteCount_1;
      3'b010 : _zz_s2b_2_cmd_byteCount_9 = _zz_s2b_2_cmd_byteCount_2;
      3'b011 : _zz_s2b_2_cmd_byteCount_9 = _zz_s2b_2_cmd_byteCount_3;
      3'b100 : _zz_s2b_2_cmd_byteCount_9 = _zz_s2b_2_cmd_byteCount_4;
      3'b101 : _zz_s2b_2_cmd_byteCount_9 = _zz_s2b_2_cmd_byteCount_5;
      3'b110 : _zz_s2b_2_cmd_byteCount_9 = _zz_s2b_2_cmd_byteCount_6;
      default : _zz_s2b_2_cmd_byteCount_9 = _zz_s2b_2_cmd_byteCount_7;
    endcase
  end

  always @(*) begin
    case(_zz_s2b_2_cmd_byteCount_12)
      3'b000 : _zz_s2b_2_cmd_byteCount_11 = _zz_s2b_2_cmd_byteCount;
      3'b001 : _zz_s2b_2_cmd_byteCount_11 = _zz_s2b_2_cmd_byteCount_1;
      3'b010 : _zz_s2b_2_cmd_byteCount_11 = _zz_s2b_2_cmd_byteCount_2;
      3'b011 : _zz_s2b_2_cmd_byteCount_11 = _zz_s2b_2_cmd_byteCount_3;
      3'b100 : _zz_s2b_2_cmd_byteCount_11 = _zz_s2b_2_cmd_byteCount_4;
      3'b101 : _zz_s2b_2_cmd_byteCount_11 = _zz_s2b_2_cmd_byteCount_5;
      3'b110 : _zz_s2b_2_cmd_byteCount_11 = _zz_s2b_2_cmd_byteCount_6;
      default : _zz_s2b_2_cmd_byteCount_11 = _zz_s2b_2_cmd_byteCount_7;
    endcase
  end

  always @(*) begin
    case(_zz_s2b_2_cmd_byteCount_14)
      3'b000 : _zz_s2b_2_cmd_byteCount_13 = _zz_s2b_2_cmd_byteCount;
      3'b001 : _zz_s2b_2_cmd_byteCount_13 = _zz_s2b_2_cmd_byteCount_1;
      3'b010 : _zz_s2b_2_cmd_byteCount_13 = _zz_s2b_2_cmd_byteCount_2;
      3'b011 : _zz_s2b_2_cmd_byteCount_13 = _zz_s2b_2_cmd_byteCount_3;
      3'b100 : _zz_s2b_2_cmd_byteCount_13 = _zz_s2b_2_cmd_byteCount_4;
      3'b101 : _zz_s2b_2_cmd_byteCount_13 = _zz_s2b_2_cmd_byteCount_5;
      3'b110 : _zz_s2b_2_cmd_byteCount_13 = _zz_s2b_2_cmd_byteCount_6;
      default : _zz_s2b_2_cmd_byteCount_13 = _zz_s2b_2_cmd_byteCount_7;
    endcase
  end

  always @(*) begin
    case(_zz_s2b_3_cmd_byteCount_10)
      3'b000 : _zz_s2b_3_cmd_byteCount_9 = _zz_s2b_3_cmd_byteCount;
      3'b001 : _zz_s2b_3_cmd_byteCount_9 = _zz_s2b_3_cmd_byteCount_1;
      3'b010 : _zz_s2b_3_cmd_byteCount_9 = _zz_s2b_3_cmd_byteCount_2;
      3'b011 : _zz_s2b_3_cmd_byteCount_9 = _zz_s2b_3_cmd_byteCount_3;
      3'b100 : _zz_s2b_3_cmd_byteCount_9 = _zz_s2b_3_cmd_byteCount_4;
      3'b101 : _zz_s2b_3_cmd_byteCount_9 = _zz_s2b_3_cmd_byteCount_5;
      3'b110 : _zz_s2b_3_cmd_byteCount_9 = _zz_s2b_3_cmd_byteCount_6;
      default : _zz_s2b_3_cmd_byteCount_9 = _zz_s2b_3_cmd_byteCount_7;
    endcase
  end

  always @(*) begin
    case(_zz_s2b_3_cmd_byteCount_12)
      3'b000 : _zz_s2b_3_cmd_byteCount_11 = _zz_s2b_3_cmd_byteCount;
      3'b001 : _zz_s2b_3_cmd_byteCount_11 = _zz_s2b_3_cmd_byteCount_1;
      3'b010 : _zz_s2b_3_cmd_byteCount_11 = _zz_s2b_3_cmd_byteCount_2;
      3'b011 : _zz_s2b_3_cmd_byteCount_11 = _zz_s2b_3_cmd_byteCount_3;
      3'b100 : _zz_s2b_3_cmd_byteCount_11 = _zz_s2b_3_cmd_byteCount_4;
      3'b101 : _zz_s2b_3_cmd_byteCount_11 = _zz_s2b_3_cmd_byteCount_5;
      3'b110 : _zz_s2b_3_cmd_byteCount_11 = _zz_s2b_3_cmd_byteCount_6;
      default : _zz_s2b_3_cmd_byteCount_11 = _zz_s2b_3_cmd_byteCount_7;
    endcase
  end

  always @(*) begin
    case(_zz_s2b_3_cmd_byteCount_14)
      3'b000 : _zz_s2b_3_cmd_byteCount_13 = _zz_s2b_3_cmd_byteCount;
      3'b001 : _zz_s2b_3_cmd_byteCount_13 = _zz_s2b_3_cmd_byteCount_1;
      3'b010 : _zz_s2b_3_cmd_byteCount_13 = _zz_s2b_3_cmd_byteCount_2;
      3'b011 : _zz_s2b_3_cmd_byteCount_13 = _zz_s2b_3_cmd_byteCount_3;
      3'b100 : _zz_s2b_3_cmd_byteCount_13 = _zz_s2b_3_cmd_byteCount_4;
      3'b101 : _zz_s2b_3_cmd_byteCount_13 = _zz_s2b_3_cmd_byteCount_5;
      3'b110 : _zz_s2b_3_cmd_byteCount_13 = _zz_s2b_3_cmd_byteCount_6;
      default : _zz_s2b_3_cmd_byteCount_13 = _zz_s2b_3_cmd_byteCount_7;
    endcase
  end
  ...
  always @(*) begin
    case(m2b_cmd_s0_priority_chosen)
      ...
      default : _zz_m2b_cmd_s0_priority_weightLast = (channels_2_weight == m2b_cmd_s0_priority_counter);
    endcase
  end
  ...
  always @(*) begin
    case(m2b_rsp_context_channel)
      1'b0 : _zz_io_writes_4_cmd_payload_address = channels_1_fifo_push_ptrWithBase;
      default : _zz_io_writes_4_cmd_payload_address = channels_2_fifo_push_ptrWithBase;
    endcase
  end

  always @(*) begin
    case(_zz_b2m_fsm_arbiter_logic_priority_masked_12)
  ...
  always @(*) begin
    case(b2m_fsm_arbiter_logic_priority_chosen)
      2'b00 : _zz_b2m_fsm_arbiter_logic_priority_weightLast = (channels_0_weight == b2m_fsm_arbiter_logic_priority_counter);
      2'b01 : _zz_b2m_fsm_arbiter_logic_priority_weightLast = (channels_3_weight == b2m_fsm_arbiter_logic_priority_counter);
      2'b10 : _zz_b2m_fsm_arbiter_logic_priority_weightLast = (channels_4_weight == b2m_fsm_arbiter_logic_priority_counter);
      default : _zz_b2m_fsm_arbiter_logic_priority_weightLast = (channels_5_weight == b2m_fsm_arbiter_logic_priority_counter);
    endcase
  end
  ...
  always @(*) begin
    case(b2m_fsm_arbiter_logic_chosen)
      ...
      2'b10 : begin
        _zz_b2m_fsm_sel_address = channels_4_pop_b2m_address;
        _zz_b2m_fsm_sel_ptr = channels_4_fifo_pop_ptrWithBase;
        _zz_b2m_fsm_sel_ptrMask = channels_4_fifo_words;
        _zz_b2m_fsm_sel_bytePerBurst = channels_4_pop_b2m_bytePerBurst;
        _zz_b2m_fsm_sel_bytesInFifo = channels_4_fifo_pop_bytes;
        _zz_b2m_fsm_sel_flush = channels_4_pop_b2m_flush;
        _zz_b2m_fsm_sel_packet = channels_4_pop_b2m_packet;
        _zz_b2m_fsm_sel_bytesLeft = channels_4_pop_b2m_bytesLeft;
      end
      default : begin
        _zz_b2m_fsm_sel_address = channels_5_pop_b2m_address;
        _zz_b2m_fsm_sel_ptr = channels_5_fifo_pop_ptrWithBase;
        _zz_b2m_fsm_sel_ptrMask = channels_5_fifo_words;
        _zz_b2m_fsm_sel_bytePerBurst = channels_5_pop_b2m_bytePerBurst;
        _zz_b2m_fsm_sel_bytesInFifo = channels_5_fifo_pop_bytes;
        _zz_b2m_fsm_sel_flush = channels_5_pop_b2m_flush;
        _zz_b2m_fsm_sel_packet = channels_5_pop_b2m_packet;
        _zz_b2m_fsm_sel_bytesLeft = channels_5_pop_b2m_bytesLeft;
      end
    endcase
  end
  ...
  always @(*) begin
    case(b2m_fsm_sel_channel)
      ...
      2'b10 : begin
        _zz_b2m_fsm_fetch_context_ptr = channels_4_fifo_pop_ptr;
        _zz_b2m_fsm_aggregate_bytesToSkip = channels_4_pop_b2m_bytesToSkip;
      end
      default : begin
        _zz_b2m_fsm_fetch_context_ptr = channels_5_fifo_pop_ptr;
        _zz_b2m_fsm_aggregate_bytesToSkip = channels_5_pop_b2m_bytesToSkip;
      end
    endcase
  end
  ...
  always @(*) begin
    ...
    case(io_ctrl_PADDR)
      ...
      14'h0254 : begin
        ...
        io_ctrl_PRDATA[4 : 4] = channels_4_interrupts_s2mPacket_valid;
      end
      14'h02ac : begin
      ...
      14'h02d4 : begin
        ...
        io_ctrl_PRDATA[4 : 4] = channels_5_interrupts_s2mPacket_valid;
      end
      default : begin
      end
    endcase
  ...
  always @(*) begin
    channels_0_bytesProbe_incr_payload = 12'bxxxxxxxxxxxx;
    if(io_write_rsp_fire) begin
      if(when_DmaSg_l1116) begin
  ...
  always @(*) begin
    channels_1_bytesProbe_incr_payload = 12'bxxxxxxxxxxxx;
    if(when_DmaSg_l874) begin
  ...
  assign when_DmaSg_l255_15 = (channels_3_descriptorValid && channels_3_descriptorCompletion);
  assign when_DmaSg_l255_16 = (! channels_3_interrupts_completion_enable);
  assign when_DmaSg_l255_17 = (channels_3_channelValid && channels_3_channelCompletion);
  assign when_DmaSg_l255_18 = (! channels_3_interrupts_onChannelCompletion_enable);
  assign when_DmaSg_l255_19 = (! channels_3_interrupts_s2mPacket_enable);
  always @(*) begin
  ...
  always @(*) begin
    ...
    if(channels_4_pop_b2m_packetSync) begin
      if(when_DmaSg_l532_2) begin
        if(channels_4_push_s2b_completionOnLast) begin
          channels_4_descriptorCompletion = 1'b1;
        end
      end
    end
    if(when_DmaSg_l547_2) begin
      channels_4_descriptorCompletion = 1'b1;
    end
    if(channels_4_channelValid) begin
      if(channels_4_channelStop) begin
  ...
  assign channels_4_fifo_push_availableDecr = 14'h0;
  ...
  assign channels_4_fifo_pop_withOverride_backupNext = (_zz_channels_4_fifo_pop_withOverride_backupNext - channels_4_fifo_pop_bytesDecr_value);
  always @(*) begin
    channels_4_fifo_pop_withOverride_load = 1'b0;
    if(when_DmaSg_l457_2) begin
      channels_4_fifo_pop_withOverride_load = 1'b1;
    end
  end

  always @(*) begin
    channels_4_fifo_pop_withOverride_unload = 1'b0;
    if(channels_4_pop_b2m_packetSync) begin
      channels_4_fifo_pop_withOverride_unload = 1'b1;
    end
  end

  assign when_DmaSg_l409_2 = (channels_4_channelStart || channels_4_fifo_pop_withOverride_unload);
  assign channels_4_fifo_pop_bytes = channels_4_fifo_pop_withOverride_exposed;
  assign channels_4_fifo_empty = (channels_4_fifo_push_ptr == channels_4_fifo_pop_ptr);
  always @(*) begin
    channels_4_push_s2b_packetEvent = 1'b0;
    if(when_DmaSg_l679_2) begin
      channels_4_push_s2b_packetEvent = 1'b1;
    end
  end

  assign when_DmaSg_l457_2 = (channels_4_push_s2b_packetEvent && channels_4_push_s2b_completionOnLast);
  assign channels_4_pop_b2m_bytePerBurst = 12'h1ff;
  always @(*) begin
    channels_4_pop_b2m_fire = 1'b0;
    if(when_DmaSg_l935) begin
      if(_zz_1[2]) begin
        channels_4_pop_b2m_fire = 1'b1;
      end
    end
  end

  always @(*) begin
    channels_4_pop_b2m_packetSync = 1'b0;
    if(when_DmaSg_l523_2) begin
      if(channels_4_pop_b2m_packet) begin
        channels_4_pop_b2m_packetSync = 1'b1;
      end
    end
    if(io_write_rsp_fire) begin
      if(when_DmaSg_l1116_2) begin
        if(b2m_rsp_context_doPacketSync) begin
          channels_4_pop_b2m_packetSync = 1'b1;
        end
      end
  ...
  assign when_DmaSg_l505_2 = (channels_4_channelStart || channels_4_pop_b2m_fire);
  always @(*) begin
    channels_4_pop_b2m_memRsp = 1'b0;
    if(io_write_rsp_fire) begin
      if(_zz_3[2]) begin
        channels_4_pop_b2m_memRsp = 1'b1;
      end
    end
  end

  assign channels_4_pop_b2m_selfFlush = (channels_4_pop_b2m_bytesLeft < _zz_channels_4_pop_b2m_selfFlush);
  assign channels_4_pop_b2m_request = ((((((channels_4_descriptorValid && (! channels_4_channelStop)) && (! channels_4_pop_b2m_waitFinalRsp)) && channels_4_pop_memory) && ((_zz_channels_4_pop_b2m_request < channels_4_fifo_pop_bytes) || (((channels_4_fifo_push_available < _zz_channels_4_pop_b2m_request_1) || channels_4_pop_b2m_flush) || channels_4_pop_b2m_selfFlush))) && (channels_4_fifo_pop_bytes != 17'h0)) && (channels_4_pop_b2m_memPending != 4'b1111));
  always @(*) begin
    channels_4_pop_b2m_memPendingInc = 1'b0;
    if(when_DmaSg_l758_1) begin
      if(when_DmaSg_l773_4) begin
        channels_4_pop_b2m_memPendingInc = 1'b1;
      end
    end
  end

  always @(*) begin
    channels_4_pop_b2m_decrBytes = 17'h0;
    if(b2m_fsm_s1) begin
      if(when_DmaSg_l996_2) begin
        channels_4_pop_b2m_decrBytes = {4'd0, b2m_fsm_bytesInBurstP1};
      end
    end
  end

  assign when_DmaSg_l523_2 = ((channels_4_pop_b2m_memPending == 4'b0000) && (channels_4_fifo_pop_bytes == 17'h0));
  assign when_DmaSg_l532_2 = (channels_4_descriptorValid && (! channels_4_push_memory));
  assign when_DmaSg_l547_2 = ((channels_4_descriptorValid && (channels_4_pop_b2m_memPending == 4'b0000)) && channels_4_pop_b2m_waitFinalRsp);
  assign when_DmaSg_l563_2 = (channels_4_pop_b2m_memPending != 4'b0000);
  assign channels_4_readyForChannelCompletion = 1'b1;
  ...
  assign when_DmaSg_l255_20 = (channels_4_descriptorValid && channels_4_descriptorCompletion);
  assign when_DmaSg_l255_21 = (! channels_4_interrupts_completion_enable);
  assign when_DmaSg_l255_22 = (channels_4_channelValid && channels_4_channelCompletion);
  assign when_DmaSg_l255_23 = (! channels_4_interrupts_onChannelCompletion_enable);
  assign when_DmaSg_l255_24 = (! channels_4_interrupts_s2mPacket_enable);
  always @(*) begin
  ...
  always @(*) begin
    ...
    if(channels_5_pop_b2m_packetSync) begin
      if(when_DmaSg_l532_3) begin
        if(channels_5_push_s2b_completionOnLast) begin
          channels_5_descriptorCompletion = 1'b1;
        end
      end
    end
    if(when_DmaSg_l547_3) begin
      channels_5_descriptorCompletion = 1'b1;
    end
    if(channels_5_channelValid) begin
      if(channels_5_channelStop) begin
  ...
  always @(*) begin
    ...
    if(when_DmaSg_l563_3) begin
      channels_5_readyToStop = 1'b0;
    end
  end

  assign channels_5_fifo_base = 14'h0500;
  assign channels_5_fifo_words = 14'h00ff;
  assign channels_5_fifo_push_availableDecr = 14'h0;
  ...
  assign channels_5_fifo_pop_withOverride_backupNext = (_zz_channels_5_fifo_pop_withOverride_backupNext - channels_5_fifo_pop_bytesDecr_value);
  always @(*) begin
    channels_5_fifo_pop_withOverride_load = 1'b0;
    if(when_DmaSg_l457_3) begin
      channels_5_fifo_pop_withOverride_load = 1'b1;
    end
  end

  always @(*) begin
    channels_5_fifo_pop_withOverride_unload = 1'b0;
    if(channels_5_pop_b2m_packetSync) begin
      channels_5_fifo_pop_withOverride_unload = 1'b1;
    end
  end

  assign when_DmaSg_l409_3 = (channels_5_channelStart || channels_5_fifo_pop_withOverride_unload);
  assign channels_5_fifo_pop_bytes = channels_5_fifo_pop_withOverride_exposed;
  assign channels_5_fifo_empty = (channels_5_fifo_push_ptr == channels_5_fifo_pop_ptr);
  always @(*) begin
    channels_5_push_s2b_packetEvent = 1'b0;
    if(when_DmaSg_l679_3) begin
      channels_5_push_s2b_packetEvent = 1'b1;
    end
  end

  assign when_DmaSg_l457_3 = (channels_5_push_s2b_packetEvent && channels_5_push_s2b_completionOnLast);
  assign channels_5_pop_b2m_bytePerBurst = 12'h1ff;
  always @(*) begin
    channels_5_pop_b2m_fire = 1'b0;
    if(when_DmaSg_l935) begin
      if(_zz_1[3]) begin
        channels_5_pop_b2m_fire = 1'b1;
      end
    end
  end

  always @(*) begin
    channels_5_pop_b2m_packetSync = 1'b0;
    if(when_DmaSg_l523_3) begin
      if(channels_5_pop_b2m_packet) begin
        channels_5_pop_b2m_packetSync = 1'b1;
      end
    end
    if(io_write_rsp_fire) begin
      if(when_DmaSg_l1116_3) begin
        if(b2m_rsp_context_doPacketSync) begin
          channels_5_pop_b2m_packetSync = 1'b1;
        end
      end
  ...
  assign when_DmaSg_l505_3 = (channels_5_channelStart || channels_5_pop_b2m_fire);
  always @(*) begin
    channels_5_pop_b2m_memRsp = 1'b0;
    if(io_write_rsp_fire) begin
      if(_zz_3[3]) begin
        channels_5_pop_b2m_memRsp = 1'b1;
      end
    end
  end

  assign channels_5_pop_b2m_selfFlush = (channels_5_pop_b2m_bytesLeft < _zz_channels_5_pop_b2m_selfFlush);
  assign channels_5_pop_b2m_request = ((((((channels_5_descriptorValid && (! channels_5_channelStop)) && (! channels_5_pop_b2m_waitFinalRsp)) && channels_5_pop_memory) && ((_zz_channels_5_pop_b2m_request < channels_5_fifo_pop_bytes) || (((channels_5_fifo_push_available < _zz_channels_5_pop_b2m_request_1) || channels_5_pop_b2m_flush) || channels_5_pop_b2m_selfFlush))) && (channels_5_fifo_pop_bytes != 17'h0)) && (channels_5_pop_b2m_memPending != 4'b1111));
  always @(*) begin
    channels_5_pop_b2m_memPendingInc = 1'b0;
    if(when_DmaSg_l758_1) begin
      if(when_DmaSg_l773_5) begin
        channels_5_pop_b2m_memPendingInc = 1'b1;
      end
    end
  end

  always @(*) begin
    channels_5_pop_b2m_decrBytes = 17'h0;
    if(b2m_fsm_s1) begin
      if(when_DmaSg_l996_3) begin
        channels_5_pop_b2m_decrBytes = {4'd0, b2m_fsm_bytesInBurstP1};
      end
    end
  end

  assign when_DmaSg_l523_3 = ((channels_5_pop_b2m_memPending == 4'b0000) && (channels_5_fifo_pop_bytes == 17'h0));
  assign when_DmaSg_l532_3 = (channels_5_descriptorValid && (! channels_5_push_memory));
  assign when_DmaSg_l547_3 = ((channels_5_descriptorValid && (channels_5_pop_b2m_memPending == 4'b0000)) && channels_5_pop_b2m_waitFinalRsp);
  assign when_DmaSg_l563_3 = (channels_5_pop_b2m_memPending != 4'b0000);
  assign channels_5_readyForChannelCompletion = 1'b1;
  assign when_DmaSg_l575_5 = (! channels_5_descriptorValid);
  always @(*) begin
    _zz_when_DmaSg_l593_5 = 1'b1;
    if(channels_5_ctrl_kick) begin
      _zz_when_DmaSg_l593_5 = 1'b0;
    end
  end
  ...
  assign when_DmaSg_l255_25 = (channels_5_descriptorValid && channels_5_descriptorCompletion);
  assign when_DmaSg_l255_26 = (! channels_5_interrupts_completion_enable);
  assign when_DmaSg_l255_27 = (channels_5_channelValid && channels_5_channelCompletion);
  assign when_DmaSg_l255_28 = (! channels_5_interrupts_onChannelCompletion_enable);
  assign when_DmaSg_l255_29 = (! channels_5_interrupts_s2mPacket_enable);
  ...
  assign when_package_l12_33 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b0001));
  assign when_package_l12_34 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b0010));
  assign when_package_l12_35 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b0011));
  assign when_package_l12_36 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b0100));
  assign when_package_l12_37 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b0101));
  assign when_package_l12_38 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b0110));
  assign when_package_l12_39 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b0111));
  assign when_package_l12_40 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b1000));
  assign when_package_l12_41 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b1001));
  assign when_package_l12_42 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b1010));
  assign when_package_l12_43 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b1011));
  assign when_package_l12_44 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b1100));
  assign when_package_l12_45 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b1101));
  assign when_package_l12_46 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b1110));
  assign when_package_l12_47 = (io_inputs_2_fire && (io_inputs_2_payload_sink == 4'b1111));
  ...
  assign s2b_2_cmd_channelsOh = ((((channels_4_channelValid && (s2b_2_cmd_first || (! channels_4_push_s2b_waitFirst))) && (! channels_4_push_memory)) && 1'b1) && (io_inputs_2_payload_sink == 4'b0000));
  assign s2b_2_cmd_noHit = (! (|s2b_2_cmd_channelsOh));
  assign s2b_2_cmd_channelsFull = (channels_4_s2b_full || (channels_4_push_s2b_packetLock && io_inputs_2_payload_last));
  always @(*) begin
  ...
  assign _zz_io_inputs_2_thrown_ready = (! (|(s2b_2_cmd_channelsOh & s2b_2_cmd_channelsFull)));
  ...
  assign _zz_s2b_2_cmd_byteCount = 4'b0000;
  assign _zz_s2b_2_cmd_byteCount_1 = 4'b0001;
  assign _zz_s2b_2_cmd_byteCount_2 = 4'b0001;
  assign _zz_s2b_2_cmd_byteCount_3 = 4'b0010;
  assign _zz_s2b_2_cmd_byteCount_4 = 4'b0001;
  assign _zz_s2b_2_cmd_byteCount_5 = 4'b0010;
  assign _zz_s2b_2_cmd_byteCount_6 = 4'b0010;
  assign _zz_s2b_2_cmd_byteCount_7 = 4'b0011;
  assign s2b_2_cmd_byteCount = (_zz_s2b_2_cmd_byteCount_8 + _zz_s2b_2_cmd_byteCount_13);
  ...
  assign memory_core_io_writes_2_cmd_payload_address = channels_4_fifo_push_ptrWithBase[12:0];
  ...
  assign s2b_2_rsp_context_bytes = _zz_s2b_2_rsp_context_channel[4 : 1];
  assign s2b_2_rsp_context_flush = _zz_s2b_2_rsp_context_channel[5];
  assign s2b_2_rsp_context_packet = _zz_s2b_2_rsp_context_channel[6];
  assign _zz_channels_4_fifo_pop_bytesIncr_value = (memory_core_io_writes_2_rsp_valid && s2b_2_rsp_context_channel[0]);
  assign when_DmaSg_l679_2 = (_zz_channels_4_fifo_pop_bytesIncr_value && s2b_2_rsp_context_packet);
  assign when_DmaSg_l681_2 = (_zz_channels_4_fifo_pop_bytesIncr_value && s2b_2_rsp_context_flush);
  assign when_DmaSg_l682_2 = (_zz_channels_4_fifo_pop_bytesIncr_value && s2b_2_rsp_context_packet);
  assign io_inputs_3_fire = (io_inputs_3_valid && io_inputs_3_ready);
  assign when_package_l12_48 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b0000));
  assign when_package_l12_49 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b0001));
  assign when_package_l12_50 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b0010));
  assign when_package_l12_51 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b0011));
  assign when_package_l12_52 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b0100));
  assign when_package_l12_53 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b0101));
  assign when_package_l12_54 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b0110));
  assign when_package_l12_55 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b0111));
  assign when_package_l12_56 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b1000));
  assign when_package_l12_57 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b1001));
  assign when_package_l12_58 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b1010));
  assign when_package_l12_59 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b1011));
  assign when_package_l12_60 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b1100));
  assign when_package_l12_61 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b1101));
  assign when_package_l12_62 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b1110));
  assign when_package_l12_63 = (io_inputs_3_fire && (io_inputs_3_payload_sink == 4'b1111));
  assign s2b_3_cmd_firsts = {io_inputs_3_payload_last_regNextWhen_15,{io_inputs_3_payload_last_regNextWhen_14,{io_inputs_3_payload_last_regNextWhen_13,{io_inputs_3_payload_last_regNextWhen_12,{io_inputs_3_payload_last_regNextWhen_11,{io_inputs_3_payload_last_regNextWhen_10,{io_inputs_3_payload_last_regNextWhen_9,{io_inputs_3_payload_last_regNextWhen_8,{io_inputs_3_payload_last_regNextWhen_7,{io_inputs_3_payload_last_regNextWhen_6,{_zz_s2b_3_cmd_firsts,_zz_s2b_3_cmd_firsts_1}}}}}}}}}}};
  assign s2b_3_cmd_first = s2b_3_cmd_firsts[io_inputs_3_payload_sink];
  assign s2b_3_cmd_channelsOh = ((((channels_5_channelValid && (s2b_3_cmd_first || (! channels_5_push_s2b_waitFirst))) && (! channels_5_push_memory)) && 1'b1) && (io_inputs_3_payload_sink == 4'b0000));
  assign s2b_3_cmd_noHit = (! (|s2b_3_cmd_channelsOh));
  assign s2b_3_cmd_channelsFull = (channels_5_s2b_full || (channels_5_push_s2b_packetLock && io_inputs_3_payload_last));
  always @(*) begin
    io_inputs_3_thrown_valid = io_inputs_3_valid;
    if(s2b_3_cmd_noHit) begin
      io_inputs_3_thrown_valid = 1'b0;
    end
  end

  always @(*) begin
    io_inputs_3_ready = io_inputs_3_thrown_ready;
    if(s2b_3_cmd_noHit) begin
      io_inputs_3_ready = 1'b1;
    end
  end

  assign io_inputs_3_thrown_payload_data = io_inputs_3_payload_data;
  assign io_inputs_3_thrown_payload_mask = io_inputs_3_payload_mask;
  assign io_inputs_3_thrown_payload_sink = io_inputs_3_payload_sink;
  assign io_inputs_3_thrown_payload_last = io_inputs_3_payload_last;
  assign _zz_io_inputs_3_thrown_ready = (! (|(s2b_3_cmd_channelsOh & s2b_3_cmd_channelsFull)));
  assign s2b_3_cmd_sinkHalted_valid = (io_inputs_3_thrown_valid && _zz_io_inputs_3_thrown_ready);
  assign io_inputs_3_thrown_ready = (s2b_3_cmd_sinkHalted_ready && _zz_io_inputs_3_thrown_ready);
  assign s2b_3_cmd_sinkHalted_payload_data = io_inputs_3_thrown_payload_data;
  assign s2b_3_cmd_sinkHalted_payload_mask = io_inputs_3_thrown_payload_mask;
  assign s2b_3_cmd_sinkHalted_payload_sink = io_inputs_3_thrown_payload_sink;
  assign s2b_3_cmd_sinkHalted_payload_last = io_inputs_3_thrown_payload_last;
  assign _zz_s2b_3_cmd_byteCount = 4'b0000;
  assign _zz_s2b_3_cmd_byteCount_1 = 4'b0001;
  assign _zz_s2b_3_cmd_byteCount_2 = 4'b0001;
  assign _zz_s2b_3_cmd_byteCount_3 = 4'b0010;
  assign _zz_s2b_3_cmd_byteCount_4 = 4'b0001;
  assign _zz_s2b_3_cmd_byteCount_5 = 4'b0010;
  assign _zz_s2b_3_cmd_byteCount_6 = 4'b0010;
  assign _zz_s2b_3_cmd_byteCount_7 = 4'b0011;
  assign s2b_3_cmd_byteCount = (_zz_s2b_3_cmd_byteCount_8 + _zz_s2b_3_cmd_byteCount_13);
  assign s2b_3_cmd_context_channel = s2b_3_cmd_channelsOh;
  assign s2b_3_cmd_context_bytes = s2b_3_cmd_byteCount;
  assign s2b_3_cmd_context_flush = io_inputs_3_payload_last;
  assign s2b_3_cmd_context_packet = io_inputs_3_payload_last;
  assign s2b_3_cmd_sinkHalted_ready = memory_core_io_writes_3_cmd_ready;
  assign memory_core_io_writes_3_cmd_payload_address = channels_5_fifo_push_ptrWithBase[12:0];
  assign memory_core_io_writes_3_cmd_payload_context = {s2b_3_cmd_context_packet,{s2b_3_cmd_context_flush,{s2b_3_cmd_context_bytes,s2b_3_cmd_context_channel}}};
  assign memory_core_io_writes_3_cmd_fire = (s2b_3_cmd_sinkHalted_valid && memory_core_io_writes_3_cmd_ready);
  assign when_DmaSg_l665_3 = (s2b_3_cmd_channelsOh[0] && memory_core_io_writes_3_cmd_fire);
  assign _zz_s2b_3_rsp_context_channel = memory_core_io_writes_3_rsp_payload_context;
  assign s2b_3_rsp_context_channel = _zz_s2b_3_rsp_context_channel[0 : 0];
  assign s2b_3_rsp_context_bytes = _zz_s2b_3_rsp_context_channel[4 : 1];
  assign s2b_3_rsp_context_flush = _zz_s2b_3_rsp_context_channel[5];
  assign s2b_3_rsp_context_packet = _zz_s2b_3_rsp_context_channel[6];
  assign _zz_channels_5_fifo_pop_bytesIncr_value = (memory_core_io_writes_3_rsp_valid && s2b_3_rsp_context_channel[0]);
  assign when_DmaSg_l679_3 = (_zz_channels_5_fifo_pop_bytesIncr_value && s2b_3_rsp_context_packet);
  assign when_DmaSg_l681_3 = (_zz_channels_5_fifo_pop_bytesIncr_value && s2b_3_rsp_context_flush);
  assign when_DmaSg_l682_3 = (_zz_channels_5_fifo_pop_bytesIncr_value && s2b_3_rsp_context_packet);
  ...
  assign b2s_1_cmd_channelsOh = (((channels_2_channelValid && (! channels_2_pop_memory)) && (channels_2_pop_b2s_portId == 1'b0)) && (! channels_2_fifo_pop_empty));
  ...
  assign _zz_m2b_cmd_s0_priority_masked_2 = (((! channels_2_push_m2b_loadRequest) || (channels_1_push_m2b_loadRequest && (_zz_m2b_cmd_s0_priority_masked_1 < _zz_m2b_cmd_s0_priority_masked))) ? _zz_m2b_cmd_s0_priority_masked : _zz_m2b_cmd_s0_priority_masked_1);
  assign m2b_cmd_s0_priority_masked = {(channels_2_push_m2b_loadRequest && (channels_2_priority == _zz_m2b_cmd_s0_priority_masked_2)),(channels_1_push_m2b_loadRequest && (channels_1_priority == _zz_m2b_cmd_s0_priority_masked_2))};
  ...
  assign when_DmaSg_l760 = (|{channels_2_push_m2b_loadRequest,channels_1_push_m2b_loadRequest});
  ...
  always @(*) begin
    memory_core_io_writes_4_cmd_payload_mask[0] = ((! (m2b_rsp_first && (4'b0000 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0000))));
    memory_core_io_writes_4_cmd_payload_mask[1] = ((! (m2b_rsp_first && (4'b0001 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0001))));
    memory_core_io_writes_4_cmd_payload_mask[2] = ((! (m2b_rsp_first && (4'b0010 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0010))));
    memory_core_io_writes_4_cmd_payload_mask[3] = ((! (m2b_rsp_first && (4'b0011 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0011))));
    memory_core_io_writes_4_cmd_payload_mask[4] = ((! (m2b_rsp_first && (4'b0100 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0100))));
    memory_core_io_writes_4_cmd_payload_mask[5] = ((! (m2b_rsp_first && (4'b0101 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0101))));
    memory_core_io_writes_4_cmd_payload_mask[6] = ((! (m2b_rsp_first && (4'b0110 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0110))));
    memory_core_io_writes_4_cmd_payload_mask[7] = ((! (m2b_rsp_first && (4'b0111 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0111))));
    memory_core_io_writes_4_cmd_payload_mask[8] = ((! (m2b_rsp_first && (4'b1000 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1000))));
    memory_core_io_writes_4_cmd_payload_mask[9] = ((! (m2b_rsp_first && (4'b1001 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1001))));
    memory_core_io_writes_4_cmd_payload_mask[10] = ((! (m2b_rsp_first && (4'b1010 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1010))));
    memory_core_io_writes_4_cmd_payload_mask[11] = ((! (m2b_rsp_first && (4'b1011 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1011))));
    memory_core_io_writes_4_cmd_payload_mask[12] = ((! (m2b_rsp_first && (4'b1100 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1100))));
    memory_core_io_writes_4_cmd_payload_mask[13] = ((! (m2b_rsp_first && (4'b1101 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1101))));
    memory_core_io_writes_4_cmd_payload_mask[14] = ((! (m2b_rsp_first && (4'b1110 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1110))));
    memory_core_io_writes_4_cmd_payload_mask[15] = ((! (m2b_rsp_first && (4'b1111 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1111))));
  end
  ...
  assign memory_core_io_writes_4_cmd_payload_address = _zz_io_writes_4_cmd_payload_address[12:0];
  assign io_read_rsp_ready = memory_core_io_writes_4_cmd_ready;
  assign memory_core_io_writes_4_cmd_payload_context = {m2b_rsp_writeContext_loadByteInNextBeat,{m2b_rsp_writeContext_channel,{m2b_rsp_writeContext_lastOfBurst,m2b_rsp_writeContext_last}}};
  assign memory_core_io_writes_4_cmd_fire = (io_read_rsp_valid && memory_core_io_writes_4_cmd_ready);
  assign _zz_channels_1_fifo_push_ptrIncr_value = (memory_core_io_writes_4_cmd_fire && (m2b_rsp_context_channel == 1'b0));
  assign when_DmaSg_l874 = (_zz_channels_1_fifo_push_ptrIncr_value && io_read_rsp_payload_last);
  assign _zz_m2b_writeRsp_context_last = memory_core_io_writes_4_rsp_payload_context;
  ...
  assign _zz_channels_1_fifo_pop_bytesIncr_value = (memory_core_io_writes_4_rsp_valid && (m2b_writeRsp_context_channel == 1'b0));
  assign when_DmaSg_l893 = (_zz_channels_1_fifo_pop_bytesIncr_value && m2b_writeRsp_context_lastOfBurst);
  assign _zz_channels_2_fifo_pop_bytesIncr_value = (memory_core_io_writes_4_rsp_valid && (m2b_writeRsp_context_channel == 1'b1));
  ...
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_2 = channels_3_pop_b2m_request;
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_3 = channels_3_priority;
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_4 = channels_4_pop_b2m_request;
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_5 = channels_4_priority;
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_6 = channels_5_pop_b2m_request;
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_7 = channels_5_priority;
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_8 = ((! _zz_b2m_fsm_arbiter_logic_priority_masked_2) || (_zz_b2m_fsm_arbiter_logic_priority_masked && (_zz_b2m_fsm_arbiter_logic_priority_masked_3 < _zz_b2m_fsm_arbiter_logic_priority_masked_1)));
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_9 = (_zz_b2m_fsm_arbiter_logic_priority_masked_8 ? _zz_b2m_fsm_arbiter_logic_priority_masked_1 : _zz_b2m_fsm_arbiter_logic_priority_masked_3);
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_10 = ((! _zz_b2m_fsm_arbiter_logic_priority_masked_6) || (_zz_b2m_fsm_arbiter_logic_priority_masked_4 && (_zz_b2m_fsm_arbiter_logic_priority_masked_7 < _zz_b2m_fsm_arbiter_logic_priority_masked_5)));
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_11 = (_zz_b2m_fsm_arbiter_logic_priority_masked_10 ? _zz_b2m_fsm_arbiter_logic_priority_masked_5 : _zz_b2m_fsm_arbiter_logic_priority_masked_7);
  assign _zz_b2m_fsm_arbiter_logic_priority_masked_12 = (((! (_zz_b2m_fsm_arbiter_logic_priority_masked_10 ? _zz_b2m_fsm_arbiter_logic_priority_masked_4 : _zz_b2m_fsm_arbiter_logic_priority_masked_6)) || ((_zz_b2m_fsm_arbiter_logic_priority_masked_8 ? _zz_b2m_fsm_arbiter_logic_priority_masked : _zz_b2m_fsm_arbiter_logic_priority_masked_2) && (_zz_b2m_fsm_arbiter_logic_priority_masked_11 < _zz_b2m_fsm_arbiter_logic_priority_masked_9))) ? _zz_b2m_fsm_arbiter_logic_priority_masked_9 : _zz_b2m_fsm_arbiter_logic_priority_masked_11);
  assign b2m_fsm_arbiter_logic_priority_masked = {(channels_5_pop_b2m_request && (channels_5_priority == _zz_b2m_fsm_arbiter_logic_priority_masked_12)),{(channels_4_pop_b2m_request && (channels_4_priority == _zz_b2m_fsm_arbiter_logic_priority_masked_12)),{(channels_3_pop_b2m_request && (channels_3_priority == _zz_b2m_fsm_arbiter_logic_priority_masked_12)),(channels_0_pop_b2m_request && (channels_0_priority == _zz_b2m_fsm_arbiter_logic_priority_masked_12))}}};
  ...
  assign b2m_fsm_arbiter_logic_priority_chosenOh = (_zz_b2m_fsm_arbiter_logic_priority_chosenOh_2[7 : 4] | _zz_b2m_fsm_arbiter_logic_priority_chosenOh_2[3 : 0]);
  assign _zz_b2m_fsm_arbiter_logic_priority_chosen = b2m_fsm_arbiter_logic_priority_chosenOh[3];
  assign _zz_b2m_fsm_arbiter_logic_priority_chosen_1 = (b2m_fsm_arbiter_logic_priority_chosenOh[1] || _zz_b2m_fsm_arbiter_logic_priority_chosen);
  assign _zz_b2m_fsm_arbiter_logic_priority_chosen_2 = (b2m_fsm_arbiter_logic_priority_chosenOh[2] || _zz_b2m_fsm_arbiter_logic_priority_chosen);
  assign b2m_fsm_arbiter_logic_priority_chosen = {_zz_b2m_fsm_arbiter_logic_priority_chosen_2,_zz_b2m_fsm_arbiter_logic_priority_chosen_1};
  assign b2m_fsm_arbiter_logic_priority_weightLast = _zz_b2m_fsm_arbiter_logic_priority_weightLast;
  assign b2m_fsm_arbiter_logic_priority_contextNext = (b2m_fsm_arbiter_logic_priority_weightLast ? {b2m_fsm_arbiter_logic_priority_chosenOh[2 : 0],b2m_fsm_arbiter_logic_priority_chosenOh[3 : 3]} : b2m_fsm_arbiter_logic_priority_chosenOh);
  assign when_DmaSg_l758_1 = (! b2m_fsm_arbiter_logic_valid);
  assign when_DmaSg_l760_1 = (|{channels_5_pop_b2m_request,{channels_4_pop_b2m_request,{channels_3_pop_b2m_request,channels_0_pop_b2m_request}}});
  assign when_DmaSg_l763_4 = (2'b00 == _zz_b2m_fsm_arbiter_logic_priority_masked_12);
  assign when_DmaSg_l763_5 = (2'b01 == _zz_b2m_fsm_arbiter_logic_priority_masked_12);
  assign when_DmaSg_l763_6 = (2'b10 == _zz_b2m_fsm_arbiter_logic_priority_masked_12);
  assign when_DmaSg_l763_7 = (2'b11 == _zz_b2m_fsm_arbiter_logic_priority_masked_12);
  assign when_DmaSg_l773_2 = (channels_0_pop_b2m_request && b2m_fsm_arbiter_logic_priority_chosenOh[0]);
  assign when_DmaSg_l773_3 = (channels_3_pop_b2m_request && b2m_fsm_arbiter_logic_priority_chosenOh[1]);
  assign when_DmaSg_l773_4 = (channels_4_pop_b2m_request && b2m_fsm_arbiter_logic_priority_chosenOh[2]);
  assign when_DmaSg_l773_5 = (channels_5_pop_b2m_request && b2m_fsm_arbiter_logic_priority_chosenOh[3]);
  ...
  assign when_DmaSg_l996 = (b2m_fsm_sel_channel == 2'b00);
  assign when_DmaSg_l1001 = (! b2m_fsm_fifoCompletion);
  assign when_DmaSg_l996_1 = (b2m_fsm_sel_channel == 2'b01);
  assign when_DmaSg_l1001_1 = (! b2m_fsm_fifoCompletion);
  assign when_DmaSg_l996_2 = (b2m_fsm_sel_channel == 2'b10);
  assign when_DmaSg_l1001_2 = (! b2m_fsm_fifoCompletion);
  assign when_DmaSg_l996_3 = (b2m_fsm_sel_channel == 2'b11);
  assign when_DmaSg_l1001_3 = (! b2m_fsm_fifoCompletion);
  ...
  assign b2m_rsp_context_length = _zz_b2m_rsp_context_channel[13 : 2];
  ...
  assign when_DmaSg_l1116 = (b2m_rsp_context_channel == 2'b00);
  assign when_DmaSg_l1116_1 = (b2m_rsp_context_channel == 2'b01);
  assign when_DmaSg_l1116_2 = (b2m_rsp_context_channel == 2'b10);
  assign when_DmaSg_l1116_3 = (b2m_rsp_context_channel == 2'b11);
  ...
  always @(*) begin
    ...
    io_sgWrite_cmd_payload_fragment_data[95 : 64] = 32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx;
    io_sgWrite_cmd_payload_fragment_data[127 : 96] = 32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx;
  ...
  assign ll_cmd_sgStreamLogic_channelId = ((ll_cmd_oh_0 ? 3'b000 : 3'b000) | (ll_cmd_oh_1 ? 3'b001 : 3'b000));
  assign io_sg_cmd_fire = (io_sg_cmd_valid && io_sg_cmd_ready);
  assign io_sg_cmd_valid = ((ll_cmd_valid && ((! ll_cmd_readFired) || (! ll_cmd_writeFired))) && ll_cmd_onSgStream);
  assign io_sg_cmd_payload_channelId = ll_cmd_sgStreamLogic_channelId;
  assign io_sg_cmd_payload_bytesDone = ll_cmd_bytesDone;
  assign io_sg_cmd_payload_endOfPacket = ll_cmd_endOfPacket;
  assign io_sg_cmd_payload_completed = ((! ll_cmd_isJustASink) && ll_cmd_doDescriptorStall);
  assign io_sg_cmd_payload_read = (! ll_cmd_readFired);
  assign io_sg_cmd_payload_write = (! ll_cmd_writeFired);
  ...
  assign when_DmaSg_l1248 = (1'b0 == ll_readRsp_beatCounter);
  assign when_DmaSg_l1248_1 = (1'b1 == ll_readRsp_beatCounter);
  assign when_DmaSg_l1248_2 = (1'b1 == ll_readRsp_beatCounter);
  assign when_DmaSg_l1248_3 = (1'b0 == ll_readRsp_beatCounter);
  assign when_DmaSg_l1248_4 = (1'b0 == ll_readRsp_beatCounter);
  assign when_DmaSg_l1248_5 = (1'b0 == ll_readRsp_beatCounter);
  assign when_DmaSg_l1248_6 = (1'b0 == ll_readRsp_beatCounter);
  assign when_DmaSg_l1271 = (io_sgRead_rsp_fire && io_sgRead_rsp_payload_last);
  assign ll_sgRsp_oh = (8'h01 <<< io_sg_rsp_payload_channelId);
  assign when_DmaSg_l1285 = (! channels_0_ll_readDone);
  assign when_DmaSg_l1285_1 = (! channels_1_ll_readDone);
  ...
  always @(*) begin
    ...
    if(channels_4_interrupts_s2mPacket_valid) begin
      io_interrupts[4] = 1'b1;
    end
    ...
    if(channels_5_interrupts_s2mPacket_valid) begin
      io_interrupts[5] = 1'b1;
    end
  end
  ...
  assign when_BusSlaveFactory_l347_9 = io_ctrl_PWDATA[0];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l347_10 = io_ctrl_PWDATA[2];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l347_11 = io_ctrl_PWDATA[4];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l379_12 = io_ctrl_PWDATA[0];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l379_13 = io_ctrl_PWDATA[0];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l347_12 = io_ctrl_PWDATA[0];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l347_13 = io_ctrl_PWDATA[2];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l347_14 = io_ctrl_PWDATA[4];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l379_14 = io_ctrl_PWDATA[0];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l379_15 = io_ctrl_PWDATA[0];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l347_15 = io_ctrl_PWDATA[0];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l347_16 = io_ctrl_PWDATA[2];
  always @(*) begin
  ...
  assign when_BusSlaveFactory_l347_17 = io_ctrl_PWDATA[4];
  ...
  assign when_Apb3SlaveFactory_l81_4 = ((io_ctrl_PADDR & (~ 14'h0003)) == 14'h0100);
  assign when_Apb3SlaveFactory_l81_5 = ((io_ctrl_PADDR & (~ 14'h0003)) == 14'h0190);
  assign when_Apb3SlaveFactory_l81_6 = ((io_ctrl_PADDR & (~ 14'h0003)) == 14'h0210);
  assign when_Apb3SlaveFactory_l81_7 = ((io_ctrl_PADDR & (~ 14'h0003)) == 14'h0290);
  ...
  assign channels_4_fifo_pop_bytesDecr_value = channels_4_pop_b2m_decrBytes;
  ...
  assign channels_5_fifo_pop_bytesDecr_value = channels_5_pop_b2m_decrBytes;
  ...
  always @(posedge clk) begin
    if(reset) begin
      ...
      channels_4_pop_b2m_memPending <= 4'b0000;
      ...
      channels_4_interrupts_s2mPacket_enable <= 1'b0;
      channels_4_interrupts_s2mPacket_valid <= 1'b0;
      ...
      channels_5_pop_b2m_memPending <= 4'b0000;
      ...
      channels_5_interrupts_s2mPacket_enable <= 1'b0;
      channels_5_interrupts_s2mPacket_valid <= 1'b0;
      ...
      io_inputs_3_payload_last_regNextWhen <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_1 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_2 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_3 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_4 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_5 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_6 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_7 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_8 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_9 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_10 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_11 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_12 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_13 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_14 <= 1'b1;
      io_inputs_3_payload_last_regNextWhen_15 <= 1'b1;
      ...
      b2m_fsm_arbiter_logic_priority_roundRobins_0 <= 4'b0001;
      b2m_fsm_arbiter_logic_priority_roundRobins_1 <= 4'b0001;
      b2m_fsm_arbiter_logic_priority_roundRobins_2 <= 4'b0001;
      b2m_fsm_arbiter_logic_priority_roundRobins_3 <= 4'b0001;
      ...
      channels_4_pop_b2m_memPending <= (_zz_channels_4_pop_b2m_memPending - _zz_channels_4_pop_b2m_memPending_3);
      ...
      if(when_DmaSg_l255_22) begin
        channels_4_interrupts_onChannelCompletion_valid <= 1'b1;
      end
      if(when_DmaSg_l255_23) begin
        channels_4_interrupts_onChannelCompletion_valid <= 1'b0;
      end
      if(channels_4_pop_b2m_packetSync) begin
        channels_4_interrupts_s2mPacket_valid <= 1'b1;
      end
      if(when_DmaSg_l255_24) begin
        channels_4_interrupts_s2mPacket_valid <= 1'b0;
      end
      ...
      channels_5_pop_b2m_memPending <= (_zz_channels_5_pop_b2m_memPending - _zz_channels_5_pop_b2m_memPending_3);
      if(when_DmaSg_l255_25) begin
        channels_5_interrupts_completion_valid <= 1'b1;
      end
      if(when_DmaSg_l255_26) begin
        channels_5_interrupts_completion_valid <= 1'b0;
      end
      if(when_DmaSg_l255_27) begin
        channels_5_interrupts_onChannelCompletion_valid <= 1'b1;
      end
      if(when_DmaSg_l255_28) begin
        channels_5_interrupts_onChannelCompletion_valid <= 1'b0;
      end
      if(channels_5_pop_b2m_packetSync) begin
        channels_5_interrupts_s2mPacket_valid <= 1'b1;
      end
      if(when_DmaSg_l255_29) begin
        channels_5_interrupts_s2mPacket_valid <= 1'b0;
      end
      ...
      if(when_package_l12_48) begin
        io_inputs_3_payload_last_regNextWhen <= io_inputs_3_payload_last;
      end
      if(when_package_l12_49) begin
        io_inputs_3_payload_last_regNextWhen_1 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_50) begin
        io_inputs_3_payload_last_regNextWhen_2 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_51) begin
        io_inputs_3_payload_last_regNextWhen_3 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_52) begin
        io_inputs_3_payload_last_regNextWhen_4 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_53) begin
        io_inputs_3_payload_last_regNextWhen_5 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_54) begin
        io_inputs_3_payload_last_regNextWhen_6 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_55) begin
        io_inputs_3_payload_last_regNextWhen_7 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_56) begin
        io_inputs_3_payload_last_regNextWhen_8 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_57) begin
        io_inputs_3_payload_last_regNextWhen_9 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_58) begin
        io_inputs_3_payload_last_regNextWhen_10 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_59) begin
        io_inputs_3_payload_last_regNextWhen_11 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_60) begin
        io_inputs_3_payload_last_regNextWhen_12 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_61) begin
        io_inputs_3_payload_last_regNextWhen_13 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_62) begin
        io_inputs_3_payload_last_regNextWhen_14 <= io_inputs_3_payload_last;
      end
      if(when_package_l12_63) begin
        io_inputs_3_payload_last_regNextWhen_15 <= io_inputs_3_payload_last;
      end
      if(when_DmaSg_l758) begin
      ...
      if(when_BusSlaveFactory_l341_14) begin
        if(when_BusSlaveFactory_l347_14) begin
          channels_4_interrupts_s2mPacket_valid <= _zz_channels_4_interrupts_s2mPacket_valid[0];
        end
      end
      ...
      if(when_BusSlaveFactory_l341_17) begin
        if(when_BusSlaveFactory_l347_17) begin
          channels_5_interrupts_s2mPacket_valid <= _zz_channels_5_interrupts_s2mPacket_valid[0];
        end
      end
      case(io_ctrl_PADDR)
        14'h0078 : begin
        ...
        14'h0250 : begin
          if(ctrl_doWrite) begin
            ...
            channels_4_interrupts_s2mPacket_enable <= io_ctrl_PWDATA[4];
          end
        end
        14'h02c4 : begin
          if(ctrl_doWrite) begin
        ...
        14'h02d0 : begin
          if(ctrl_doWrite) begin
            ...
            channels_5_interrupts_s2mPacket_enable <= io_ctrl_PWDATA[4];
          end
        end
        default : begin
        end
  ...
  always @(posedge clk) begin
    ...
    channels_4_fifo_pop_withOverride_backup <= channels_4_fifo_pop_withOverride_backupNext;
    if(when_DmaSg_l409_2) begin
      channels_4_fifo_pop_withOverride_valid <= 1'b0;
    end
    if(channels_4_fifo_pop_withOverride_load) begin
      channels_4_fifo_pop_withOverride_valid <= 1'b1;
    end
    channels_4_fifo_pop_withOverride_exposed <= ((! channels_4_fifo_pop_withOverride_valid) ? channels_4_fifo_pop_withOverride_backupNext : _zz_channels_4_fifo_pop_withOverride_exposed);
    if(channels_4_channelStart) begin
      channels_4_fifo_pop_withOverride_backup <= 17'h0;
      channels_4_fifo_pop_withOverride_valid <= 1'b0;
    end
    if(channels_4_channelStart) begin
      channels_4_push_s2b_packetLock <= 1'b0;
    end
    if(channels_4_pop_b2m_fire) begin
      channels_4_pop_b2m_flush <= 1'b0;
    end
    if(when_DmaSg_l505_2) begin
      channels_4_pop_b2m_packet <= 1'b0;
    end
    if(when_DmaSg_l523_2) begin
      channels_4_pop_b2m_flush <= 1'b0;
      channels_4_pop_b2m_packet <= 1'b0;
    ...
    if(channels_4_channelStart) begin
      channels_4_pop_b2m_bytesToSkip <= 4'b0000;
      channels_4_pop_b2m_flush <= 1'b0;
    end
    if(channels_4_descriptorStart) begin
      channels_4_pop_b2m_bytesLeft <= {1'd0, channels_4_bytes};
      channels_4_pop_b2m_waitFinalRsp <= 1'b0;
    end
    if(channels_4_channelValid) begin
      if(!channels_4_channelStop) begin
    ...
    channels_5_fifo_pop_withOverride_backup <= channels_5_fifo_pop_withOverride_backupNext;
    if(when_DmaSg_l409_3) begin
      channels_5_fifo_pop_withOverride_valid <= 1'b0;
    end
    if(channels_5_fifo_pop_withOverride_load) begin
      channels_5_fifo_pop_withOverride_valid <= 1'b1;
    end
    channels_5_fifo_pop_withOverride_exposed <= ((! channels_5_fifo_pop_withOverride_valid) ? channels_5_fifo_pop_withOverride_backupNext : _zz_channels_5_fifo_pop_withOverride_exposed);
    if(channels_5_channelStart) begin
      channels_5_fifo_pop_withOverride_backup <= 17'h0;
      channels_5_fifo_pop_withOverride_valid <= 1'b0;
    end
    if(channels_5_channelStart) begin
      channels_5_push_s2b_packetLock <= 1'b0;
    end
    if(channels_5_pop_b2m_fire) begin
      channels_5_pop_b2m_flush <= 1'b0;
    end
    if(when_DmaSg_l505_3) begin
      channels_5_pop_b2m_packet <= 1'b0;
    end
    if(when_DmaSg_l523_3) begin
      channels_5_pop_b2m_flush <= 1'b0;
      channels_5_pop_b2m_packet <= 1'b0;
    ...
    if(channels_5_channelStart) begin
      channels_5_pop_b2m_bytesToSkip <= 4'b0000;
      channels_5_pop_b2m_flush <= 1'b0;
    end
    if(channels_5_descriptorStart) begin
      channels_5_pop_b2m_bytesLeft <= {1'd0, channels_5_bytes};
      channels_5_pop_b2m_waitFinalRsp <= 1'b0;
    end
    if(channels_5_channelValid) begin
      if(!channels_5_channelStop) begin
        if(when_DmaSg_l575_5) begin
          if(when_DmaSg_l593_5) begin
    ...
    if(when_DmaSg_l665_2) begin
      channels_4_push_s2b_waitFirst <= 1'b0;
      if(io_inputs_2_payload_last) begin
        channels_4_push_s2b_packetLock <= 1'b1;
      end
    end
    if(when_DmaSg_l681_2) begin
      channels_4_pop_b2m_flush <= 1'b1;
    end
    if(when_DmaSg_l682_2) begin
      channels_4_pop_b2m_packet <= 1'b1;
    end
    if(when_DmaSg_l665_3) begin
      channels_5_push_s2b_waitFirst <= 1'b0;
      if(io_inputs_3_payload_last) begin
        channels_5_push_s2b_packetLock <= 1'b1;
      end
    end
    if(when_DmaSg_l681_3) begin
      channels_5_pop_b2m_flush <= 1'b1;
    end
    if(when_DmaSg_l682_3) begin
      channels_5_pop_b2m_packet <= 1'b1;
    end
    ...
    if(b2m_fsm_s1) begin
      ...
      if(when_DmaSg_l996_2) begin
        channels_4_pop_b2m_address <= b2m_fsm_addressNext;
        channels_4_pop_b2m_bytesLeft <= b2m_fsm_bytesLeftNext;
        if(b2m_fsm_isFinalCmd) begin
          channels_4_pop_b2m_waitFinalRsp <= 1'b1;
        end
        if(when_DmaSg_l1001_2) begin
          if(b2m_fsm_sel_flush) begin
            channels_4_pop_b2m_flush <= 1'b1;
          end
          if(b2m_fsm_sel_packet) begin
      ...
      if(when_DmaSg_l996_3) begin
        channels_5_pop_b2m_address <= b2m_fsm_addressNext;
        channels_5_pop_b2m_bytesLeft <= b2m_fsm_bytesLeftNext;
        if(b2m_fsm_isFinalCmd) begin
          channels_5_pop_b2m_waitFinalRsp <= 1'b1;
        end
        if(when_DmaSg_l1001_3) begin
          if(b2m_fsm_sel_flush) begin
            channels_5_pop_b2m_flush <= 1'b1;
          end
          if(b2m_fsm_sel_packet) begin
    ...
    if(when_DmaSg_l1102) begin
      ...
      if(_zz_2[2]) begin
        channels_4_pop_b2m_bytesToSkip <= _zz_channels_0_pop_b2m_bytesToSkip;
      end
      if(_zz_2[3]) begin
        channels_5_pop_b2m_bytesToSkip <= _zz_channels_0_pop_b2m_bytesToSkip;
      end
    end
    ...
    if(io_sg_rsp_valid) begin
      if(ll_sgRsp_oh[0]) begin
        if(when_DmaSg_l1285) begin
          channels_0_pop_b2m_address <= io_sg_rsp_payload_dstAddress;
          channels_0_bytes <= io_sg_rsp_payload_bytes;
          channels_0_ll_controlNoCompletion <= 1'b0;
          channels_0_ll_gotDescriptorStall <= io_sg_rsp_payload_stall;
        end
        channels_0_ll_readDone <= 1'b1;
        channels_0_ll_writeDone <= 1'b1;
      end
      if(ll_sgRsp_oh[1]) begin
        if(when_DmaSg_l1285_1) begin
          channels_1_push_m2b_address <= io_sg_rsp_payload_srcAddress;
          channels_1_bytes <= io_sg_rsp_payload_bytes;
          channels_1_ll_controlNoCompletion <= 1'b0;
          channels_1_pop_b2s_last <= io_sg_rsp_payload_last;
          channels_1_ll_gotDescriptorStall <= io_sg_rsp_payload_stall;
        end
        channels_1_ll_readDone <= 1'b1;
    ...
    case(io_ctrl_PADDR)
      ...
      14'h0118 : begin
        if(ctrl_doWrite) begin
          channels_2_pop_b2s_portId <= io_ctrl_PWDATA[0 : 0];
      ...
      14'h020c : begin
        if(ctrl_doWrite) begin
          ...
          channels_4_push_s2b_completionOnLast <= io_ctrl_PWDATA[13];
          channels_4_push_s2b_waitFirst <= io_ctrl_PWDATA[14];
        end
      end
      14'h021c : begin
        if(ctrl_doWrite) begin
      ...
      14'h028c : begin
        if(ctrl_doWrite) begin
          ...
          channels_5_push_s2b_completionOnLast <= io_ctrl_PWDATA[13];
          channels_5_push_s2b_waitFirst <= io_ctrl_PWDATA[14];
        end
      end
      14'h029c : begin
        if(ctrl_doWrite) begin
    ...
    if(when_Apb3SlaveFactory_l81_6) begin
      if(ctrl_doWrite) begin
        channels_4_pop_b2m_address[31 : 0] <= io_ctrl_PWDATA[31 : 0];
      end
    end
    if(when_Apb3SlaveFactory_l81_7) begin
      if(ctrl_doWrite) begin
        channels_5_pop_b2m_address[31 : 0] <= io_ctrl_PWDATA[31 : 0];
      end
    end
  end
...
module EfxDMA_StreamArbiter_1 (
  ...
  input  wire [11:0]   io_inputs_0_payload_fragment_length,
  input  wire [127:0]  io_inputs_0_payload_fragment_data,
  input  wire [15:0]   io_inputs_0_payload_fragment_mask,
  input  wire [14:0]   io_inputs_0_payload_fragment_context,
  input  wire          io_inputs_1_valid,
  ...
  input  wire [11:0]   io_inputs_1_payload_fragment_length,
  input  wire [127:0]  io_inputs_1_payload_fragment_data,
  input  wire [15:0]   io_inputs_1_payload_fragment_mask,
  input  wire [14:0]   io_inputs_1_payload_fragment_context,
  output wire          io_output_valid,
  input  wire          io_output_ready,
  output wire          io_output_payload_last,
  ...
  output wire [11:0]   io_output_payload_fragment_length,
  output wire [127:0]  io_output_payload_fragment_data,
  output wire [15:0]   io_output_payload_fragment_mask,
  output wire [14:0]   io_output_payload_fragment_context,
...
module EfxDMA_StreamArbiter (
  ...
  input  wire [31:0]   io_inputs_0_payload_fragment_address,
  input  wire [11:0]   io_inputs_0_payload_fragment_length,
  input  wire [21:0]   io_inputs_0_payload_fragment_context,
  input  wire          io_inputs_1_valid,
  output wire          io_inputs_1_ready,
  input  wire          io_inputs_1_payload_last,
  ...
  input  wire [31:0]   io_inputs_1_payload_fragment_address,
  input  wire [11:0]   io_inputs_1_payload_fragment_length,
  input  wire [21:0]   io_inputs_1_payload_fragment_context,
  output wire          io_output_valid,
  input  wire          io_output_ready,
  output wire          io_output_payload_last,
  ...
  output wire [31:0]   io_output_payload_fragment_address,
  output wire [11:0]   io_output_payload_fragment_length,
  output wire [21:0]   io_output_payload_fragment_context,
  output wire [0:0]    io_chosen,
  output wire [1:0]    io_chosenOH,
  input  wire          clk,
  input  wire          reset
...
//EfxDMA_BufferCC_12 replaced by EfxDMA_BufferCC_3
...
//EfxDMA_BufferCC_9 replaced by EfxDMA_BufferCC_3
...
//EfxDMA_BufferCC_7 replaced by EfxDMA_BufferCC_3
...
module EfxDMA_BmbContextRemover_1 (
  ...
  wire       [17:0]   fifoFork_thrown_translated_fifo_io_pop_payload_context;
  ...
  wire       [17:0]   fifoFork_payload_fragment_context;
  wire                cmdFork_valid;
  wire                cmdFork_ready;
  wire                cmdFork_payload_last;
  wire       [0:0]    cmdFork_payload_fragment_opcode;
  ...
  wire       [127:0]  cmdFork_payload_fragment_data;
  wire       [15:0]   cmdFork_payload_fragment_mask;
  wire       [17:0]   cmdFork_payload_fragment_context;
  ...
  wire       [17:0]   fifoFork_thrown_payload_fragment_context;
  wire                fifoFork_thrown_translated_valid;
  wire                fifoFork_thrown_translated_ready;
  wire       [17:0]   fifoFork_thrown_translated_payload_context;
  wire                popCtx_valid;
  wire                popCtx_ready;
  wire       [17:0]   popCtx_payload_context;
  reg                 fifoFork_thrown_translated_fifo_io_pop_rValid;
  reg        [17:0]   fifoFork_thrown_translated_fifo_io_pop_rData_context;
  wire                when_Stream_l375;
  ...
  EfxDMA_StreamFifo_1 fifoFork_thrown_translated_fifo (
    ...
    .io_push_payload_context (fifoFork_thrown_translated_payload_context[17:0]            ), //i
    .io_pop_valid            (fifoFork_thrown_translated_fifo_io_pop_valid                ), //o
    .io_pop_ready            (fifoFork_thrown_translated_fifo_io_pop_ready                ), //i
    .io_pop_payload_context  (fifoFork_thrown_translated_fifo_io_pop_payload_context[17:0]), //o
    .io_flush                (1'b0                                                        ), //i
...
module EfxDMA_DmaMemoryCore (
  ...
  input  wire [63:0]   io_writes_3_cmd_payload_data,
  input  wire [7:0]    io_writes_3_cmd_payload_mask,
  input  wire [1:0]    io_writes_3_cmd_payload_priority,
  input  wire [6:0]    io_writes_3_cmd_payload_context,
  output wire          io_writes_3_rsp_valid,
  output wire [6:0]    io_writes_3_rsp_payload_context,
  input  wire          io_writes_4_cmd_valid,
  output wire          io_writes_4_cmd_ready,
  input  wire [12:0]   io_writes_4_cmd_payload_address,
  input  wire [127:0]  io_writes_4_cmd_payload_data,
  input  wire [15:0]   io_writes_4_cmd_payload_mask,
  input  wire [7:0]    io_writes_4_cmd_payload_context,
  output wire          io_writes_4_rsp_valid,
  output wire [7:0]    io_writes_4_rsp_payload_context,
  ...
  wire       [15:0]   _zz_write_ports_0_priority_value;
  wire       [15:0]   _zz_write_ports_1_priority_value;
  wire       [15:0]   _zz_write_ports_2_priority_value;
  wire       [15:0]   _zz_write_ports_3_priority_value;
  ...
  wire       [12:0]   _zz_when_MemoryCore_l136_6;
  wire       [12:0]   _zz_when_MemoryCore_l136_7;
  ...
  wire       [71:0]   _zz__zz_banks_0_writeOr_value_valid_20;
  wire       [11:0]   _zz__zz_banks_0_writeOr_value_valid_20_1;
  wire       [71:0]   _zz__zz_banks_0_writeOr_value_valid_20_2;
  wire       [11:0]   _zz__zz_banks_0_writeOr_value_valid_20_3;
  wire       [71:0]   _zz__zz_banks_0_writeOr_value_valid_20_4;
  wire       [11:0]   _zz__zz_banks_0_writeOr_value_valid_20_5;
  wire       [71:0]   _zz__zz_banks_0_writeOr_value_valid_20_6;
  wire       [11:0]   _zz__zz_banks_0_writeOr_value_valid_20_7;
  wire       [71:0]   _zz__zz_banks_1_writeOr_value_valid_20;
  wire       [11:0]   _zz__zz_banks_1_writeOr_value_valid_20_1;
  wire       [71:0]   _zz__zz_banks_1_writeOr_value_valid_20_2;
  wire       [11:0]   _zz__zz_banks_1_writeOr_value_valid_20_3;
  wire       [71:0]   _zz__zz_banks_1_writeOr_value_valid_20_4;
  wire       [11:0]   _zz__zz_banks_1_writeOr_value_valid_20_5;
  wire       [71:0]   _zz__zz_banks_1_writeOr_value_valid_20_6;
  wire       [11:0]   _zz__zz_banks_1_writeOr_value_valid_20_7;
  reg                 _zz_1;
  reg                 _zz_2;
  ...
  reg        [15:0]   write_ports_0_priority_value;
  reg        [15:0]   write_ports_1_priority_value;
  reg        [15:0]   write_ports_2_priority_value;
  reg        [15:0]   write_ports_3_priority_value;
  ...
  wire                write_nodes_0_4_priority;
  wire                write_nodes_0_4_conflict;
  ...
  wire                write_nodes_1_4_priority;
  wire                write_nodes_1_4_conflict;
  ...
  wire                write_nodes_2_4_priority;
  wire                write_nodes_2_4_conflict;
  ...
  wire                write_nodes_3_4_priority;
  wire                write_nodes_3_4_conflict;
  wire                write_nodes_4_0_priority;
  wire                write_nodes_4_0_conflict;
  wire                write_nodes_4_1_priority;
  wire                write_nodes_4_1_conflict;
  wire                write_nodes_4_2_priority;
  wire                write_nodes_4_2_conflict;
  wire                write_nodes_4_3_priority;
  wire                write_nodes_4_3_conflict;
  wire                write_nodes_4_4_priority;
  wire                write_nodes_4_4_conflict;
  wire       [3:0]    write_arbiter_0_losedAgainst;
  ...
  wire       [3:0]    write_arbiter_1_losedAgainst;
  ...
  wire       [3:0]    write_arbiter_2_losedAgainst;
  ...
  wire       [3:0]    write_arbiter_3_losedAgainst;
  reg                 write_arbiter_3_doIt;
  reg                 _zz_banks_0_writeOr_value_valid_12;
  reg        [11:0]   _zz_banks_0_writeOr_value_valid_13;
  reg        [63:0]   _zz_banks_0_writeOr_value_valid_14;
  reg        [7:0]    _zz_banks_0_writeOr_value_valid_15;
  wire                when_MemoryCore_l136_6;
  reg                 _zz_banks_1_writeOr_value_valid_12;
  reg        [11:0]   _zz_banks_1_writeOr_value_valid_13;
  reg        [63:0]   _zz_banks_1_writeOr_value_valid_14;
  reg        [7:0]    _zz_banks_1_writeOr_value_valid_15;
  wire                when_MemoryCore_l136_7;
  reg                 write_arbiter_3_doIt_regNext;
  reg        [6:0]    io_writes_3_cmd_payload_context_regNext;
  wire       [3:0]    write_arbiter_4_losedAgainst;
  reg                 write_arbiter_4_doIt;
  reg                 _zz_banks_0_writeOr_value_valid_16;
  reg        [11:0]   _zz_banks_0_writeOr_value_valid_17;
  reg        [63:0]   _zz_banks_0_writeOr_value_valid_18;
  reg        [7:0]    _zz_banks_0_writeOr_value_valid_19;
  wire                when_MemoryCore_l136_8;
  reg                 _zz_banks_1_writeOr_value_valid_16;
  reg        [11:0]   _zz_banks_1_writeOr_value_valid_17;
  reg        [63:0]   _zz_banks_1_writeOr_value_valid_18;
  reg        [7:0]    _zz_banks_1_writeOr_value_valid_19;
  wire                when_MemoryCore_l136_9;
  reg                 write_arbiter_4_doIt_regNext;
  reg        [7:0]    io_writes_4_cmd_payload_context_regNext;
  ...
  wire       [84:0]   _zz_banks_0_writeOr_value_valid_20;
  ...
  wire       [84:0]   _zz_banks_1_writeOr_value_valid_20;
  ...
  assign _zz_write_ports_0_priority_value = {14'd0, io_writes_0_cmd_payload_priority};
  assign _zz_write_ports_1_priority_value = {14'd0, io_writes_1_cmd_payload_priority};
  assign _zz_write_ports_2_priority_value = {14'd0, io_writes_2_cmd_payload_priority};
  assign _zz_write_ports_3_priority_value = {14'd0, io_writes_3_cmd_payload_priority};
  ...
  assign _zz_when_MemoryCore_l136_6 = (io_writes_3_cmd_payload_address ^ 13'h0);
  assign _zz_when_MemoryCore_l136_7 = (io_writes_3_cmd_payload_address ^ 13'h0001);
  ...
  assign _zz__zz_banks_0_writeOr_value_valid_20 = {_zz_banks_0_writeOr_value_valid_3,_zz_banks_0_writeOr_value_valid_2};
  assign _zz__zz_banks_0_writeOr_value_valid_20_1 = _zz_banks_0_writeOr_value_valid_1;
  assign _zz__zz_banks_0_writeOr_value_valid_20_2 = {_zz_banks_0_writeOr_value_valid_7,_zz_banks_0_writeOr_value_valid_6};
  assign _zz__zz_banks_0_writeOr_value_valid_20_3 = _zz_banks_0_writeOr_value_valid_5;
  assign _zz__zz_banks_0_writeOr_value_valid_20_4 = {_zz_banks_0_writeOr_value_valid_11,_zz_banks_0_writeOr_value_valid_10};
  assign _zz__zz_banks_0_writeOr_value_valid_20_5 = _zz_banks_0_writeOr_value_valid_9;
  assign _zz__zz_banks_0_writeOr_value_valid_20_6 = {_zz_banks_0_writeOr_value_valid_15,_zz_banks_0_writeOr_value_valid_14};
  assign _zz__zz_banks_0_writeOr_value_valid_20_7 = _zz_banks_0_writeOr_value_valid_13;
  assign _zz__zz_banks_1_writeOr_value_valid_20 = {_zz_banks_1_writeOr_value_valid_3,_zz_banks_1_writeOr_value_valid_2};
  assign _zz__zz_banks_1_writeOr_value_valid_20_1 = _zz_banks_1_writeOr_value_valid_1;
  assign _zz__zz_banks_1_writeOr_value_valid_20_2 = {_zz_banks_1_writeOr_value_valid_7,_zz_banks_1_writeOr_value_valid_6};
  assign _zz__zz_banks_1_writeOr_value_valid_20_3 = _zz_banks_1_writeOr_value_valid_5;
  assign _zz__zz_banks_1_writeOr_value_valid_20_4 = {_zz_banks_1_writeOr_value_valid_11,_zz_banks_1_writeOr_value_valid_10};
  assign _zz__zz_banks_1_writeOr_value_valid_20_5 = _zz_banks_1_writeOr_value_valid_9;
  assign _zz__zz_banks_1_writeOr_value_valid_20_6 = {_zz_banks_1_writeOr_value_valid_15,_zz_banks_1_writeOr_value_valid_14};
  assign _zz__zz_banks_1_writeOr_value_valid_20_7 = _zz_banks_1_writeOr_value_valid_13;
  always @(posedge clk) begin
    if(_zz_2) begin
  ...
  `ifndef SYNTHESIS
    ...
    write_ports_2_priority_value = {$urandom};
    write_ports_3_priority_value = {$urandom};
  ...
  assign write_nodes_0_3_priority = (write_ports_3_priority_value < write_ports_0_priority_value);
  assign write_nodes_3_0_priority = (! write_nodes_0_3_priority);
  assign write_nodes_0_3_conflict = ((io_writes_0_cmd_valid && io_writes_3_cmd_valid) && (((io_writes_0_cmd_payload_address ^ io_writes_3_cmd_payload_address) & 13'h0001) == 13'h0));
  assign write_nodes_3_0_conflict = write_nodes_0_3_conflict;
  assign write_nodes_0_4_priority = 1'b0;
  assign write_nodes_4_0_priority = 1'b1;
  assign write_nodes_0_4_conflict = ((io_writes_0_cmd_valid && io_writes_4_cmd_valid) && (((io_writes_0_cmd_payload_address ^ io_writes_4_cmd_payload_address) & 13'h0) == 13'h0));
  assign write_nodes_4_0_conflict = write_nodes_0_4_conflict;
  ...
  assign write_nodes_1_3_priority = (write_ports_3_priority_value < write_ports_1_priority_value);
  assign write_nodes_3_1_priority = (! write_nodes_1_3_priority);
  assign write_nodes_1_3_conflict = ((io_writes_1_cmd_valid && io_writes_3_cmd_valid) && (((io_writes_1_cmd_payload_address ^ io_writes_3_cmd_payload_address) & 13'h0001) == 13'h0));
  assign write_nodes_3_1_conflict = write_nodes_1_3_conflict;
  assign write_nodes_1_4_priority = 1'b0;
  assign write_nodes_4_1_priority = 1'b1;
  assign write_nodes_1_4_conflict = ((io_writes_1_cmd_valid && io_writes_4_cmd_valid) && (((io_writes_1_cmd_payload_address ^ io_writes_4_cmd_payload_address) & 13'h0) == 13'h0));
  assign write_nodes_4_1_conflict = write_nodes_1_4_conflict;
  assign write_nodes_2_3_priority = (write_ports_3_priority_value < write_ports_2_priority_value);
  assign write_nodes_3_2_priority = (! write_nodes_2_3_priority);
  assign write_nodes_2_3_conflict = ((io_writes_2_cmd_valid && io_writes_3_cmd_valid) && (((io_writes_2_cmd_payload_address ^ io_writes_3_cmd_payload_address) & 13'h0001) == 13'h0));
  assign write_nodes_3_2_conflict = write_nodes_2_3_conflict;
  assign write_nodes_2_4_priority = 1'b0;
  assign write_nodes_4_2_priority = 1'b1;
  assign write_nodes_2_4_conflict = ((io_writes_2_cmd_valid && io_writes_4_cmd_valid) && (((io_writes_2_cmd_payload_address ^ io_writes_4_cmd_payload_address) & 13'h0) == 13'h0));
  assign write_nodes_4_2_conflict = write_nodes_2_4_conflict;
  assign write_nodes_3_4_priority = 1'b0;
  assign write_nodes_4_3_priority = 1'b1;
  assign write_nodes_3_4_conflict = ((io_writes_3_cmd_valid && io_writes_4_cmd_valid) && (((io_writes_3_cmd_payload_address ^ io_writes_4_cmd_payload_address) & 13'h0) == 13'h0));
  assign write_nodes_4_3_conflict = write_nodes_3_4_conflict;
  assign write_arbiter_0_losedAgainst = {(write_nodes_0_4_conflict && (! write_nodes_0_4_priority)),{(write_nodes_0_3_conflict && (! write_nodes_0_3_priority)),{(write_nodes_0_2_conflict && (! write_nodes_0_2_priority)),(write_nodes_0_1_conflict && (! write_nodes_0_1_priority))}}};
  always @(*) begin
    write_arbiter_0_doIt = (io_writes_0_cmd_valid && (write_arbiter_0_losedAgainst == 4'b0000));
    if(when_MemoryCore_l239) begin
  ...
  assign write_arbiter_1_losedAgainst = {(write_nodes_1_4_conflict && (! write_nodes_1_4_priority)),{(write_nodes_1_3_conflict && (! write_nodes_1_3_priority)),{(write_nodes_1_2_conflict && (! write_nodes_1_2_priority)),(write_nodes_1_0_conflict && (! write_nodes_1_0_priority))}}};
  always @(*) begin
    write_arbiter_1_doIt = (io_writes_1_cmd_valid && (write_arbiter_1_losedAgainst == 4'b0000));
    if(when_MemoryCore_l239) begin
  ...
  assign write_arbiter_2_losedAgainst = {(write_nodes_2_4_conflict && (! write_nodes_2_4_priority)),{(write_nodes_2_3_conflict && (! write_nodes_2_3_priority)),{(write_nodes_2_1_conflict && (! write_nodes_2_1_priority)),(write_nodes_2_0_conflict && (! write_nodes_2_0_priority))}}};
  always @(*) begin
    write_arbiter_2_doIt = (io_writes_2_cmd_valid && (write_arbiter_2_losedAgainst == 4'b0000));
    if(when_MemoryCore_l239) begin
      write_arbiter_2_doIt = 1'b0;
    end
  end

  assign when_MemoryCore_l136_4 = (write_arbiter_2_doIt && (_zz_when_MemoryCore_l136_4[0 : 0] == 1'b0));
  always @(*) begin
  ...
  assign when_MemoryCore_l136_5 = (write_arbiter_2_doIt && (_zz_when_MemoryCore_l136_5[0 : 0] == 1'b0));
  always @(*) begin
  ...
  always @(*) begin
    if(when_MemoryCore_l136_5) begin
      _zz_banks_1_writeOr_value_valid_10 = io_writes_2_cmd_payload_data[63 : 0];
    end else begin
  ...
  always @(*) begin
    if(when_MemoryCore_l136_5) begin
      _zz_banks_1_writeOr_value_valid_11 = io_writes_2_cmd_payload_mask[7 : 0];
    end else begin
  ...
  assign write_arbiter_3_losedAgainst = {(write_nodes_3_4_conflict && (! write_nodes_3_4_priority)),{(write_nodes_3_2_conflict && (! write_nodes_3_2_priority)),{(write_nodes_3_1_conflict && (! write_nodes_3_1_priority)),(write_nodes_3_0_conflict && (! write_nodes_3_0_priority))}}};
  always @(*) begin
    write_arbiter_3_doIt = (io_writes_3_cmd_valid && (write_arbiter_3_losedAgainst == 4'b0000));
    if(when_MemoryCore_l239) begin
      write_arbiter_3_doIt = 1'b0;
    end
  end

  assign when_MemoryCore_l136_6 = (write_arbiter_3_doIt && (_zz_when_MemoryCore_l136_6[0 : 0] == 1'b0));
  always @(*) begin
  ...
  always @(*) begin
    if(when_MemoryCore_l136_6) begin
      _zz_banks_0_writeOr_value_valid_14 = io_writes_3_cmd_payload_data[63 : 0];
    end else begin
      _zz_banks_0_writeOr_value_valid_14 = 64'h0;
    end
  end

  always @(*) begin
    if(when_MemoryCore_l136_6) begin
      _zz_banks_0_writeOr_value_valid_15 = io_writes_3_cmd_payload_mask[7 : 0];
    end else begin
      _zz_banks_0_writeOr_value_valid_15 = 8'h0;
    end
  end

  assign when_MemoryCore_l136_7 = (write_arbiter_3_doIt && (_zz_when_MemoryCore_l136_7[0 : 0] == 1'b0));
  always @(*) begin
  ...
  always @(*) begin
    if(when_MemoryCore_l136_7) begin
      _zz_banks_1_writeOr_value_valid_14 = io_writes_3_cmd_payload_data[63 : 0];
    end else begin
      _zz_banks_1_writeOr_value_valid_14 = 64'h0;
    end
  end

  always @(*) begin
    if(when_MemoryCore_l136_7) begin
      _zz_banks_1_writeOr_value_valid_15 = io_writes_3_cmd_payload_mask[7 : 0];
    end else begin
      _zz_banks_1_writeOr_value_valid_15 = 8'h0;
    end
  end
  ...
  assign write_arbiter_4_losedAgainst = {(write_nodes_4_3_conflict && (! write_nodes_4_3_priority)),{(write_nodes_4_2_conflict && (! write_nodes_4_2_priority)),{(write_nodes_4_1_conflict && (! write_nodes_4_1_priority)),(write_nodes_4_0_conflict && (! write_nodes_4_0_priority))}}};
  always @(*) begin
    write_arbiter_4_doIt = (io_writes_4_cmd_valid && (write_arbiter_4_losedAgainst == 4'b0000));
    if(when_MemoryCore_l239) begin
      write_arbiter_4_doIt = 1'b0;
    end
  end

  assign when_MemoryCore_l136_8 = (write_arbiter_4_doIt && 1'b1);
  always @(*) begin
    if(when_MemoryCore_l136_8) begin
      _zz_banks_0_writeOr_value_valid_16 = 1'b1;
    end else begin
      _zz_banks_0_writeOr_value_valid_16 = 1'b0;
    end
  end

  always @(*) begin
    if(when_MemoryCore_l136_8) begin
      _zz_banks_0_writeOr_value_valid_17 = (io_writes_4_cmd_payload_address >>> 1'd1);
    end else begin
      _zz_banks_0_writeOr_value_valid_17 = 12'h0;
    end
  end

  always @(*) begin
    if(when_MemoryCore_l136_8) begin
      _zz_banks_0_writeOr_value_valid_18 = io_writes_4_cmd_payload_data[63 : 0];
    end else begin
      _zz_banks_0_writeOr_value_valid_18 = 64'h0;
    end
  end

  always @(*) begin
    if(when_MemoryCore_l136_8) begin
      _zz_banks_0_writeOr_value_valid_19 = io_writes_4_cmd_payload_mask[7 : 0];
    end else begin
      _zz_banks_0_writeOr_value_valid_19 = 8'h0;
    end
  end

  assign when_MemoryCore_l136_9 = (write_arbiter_4_doIt && 1'b1);
  always @(*) begin
    if(when_MemoryCore_l136_9) begin
      _zz_banks_1_writeOr_value_valid_16 = 1'b1;
    end else begin
      _zz_banks_1_writeOr_value_valid_16 = 1'b0;
    end
  end

  always @(*) begin
    if(when_MemoryCore_l136_9) begin
      _zz_banks_1_writeOr_value_valid_17 = (io_writes_4_cmd_payload_address >>> 1'd1);
    end else begin
      _zz_banks_1_writeOr_value_valid_17 = 12'h0;
    end
  end

  always @(*) begin
    if(when_MemoryCore_l136_9) begin
      _zz_banks_1_writeOr_value_valid_18 = io_writes_4_cmd_payload_data[127 : 64];
    end else begin
      _zz_banks_1_writeOr_value_valid_18 = 64'h0;
    end
  end

  always @(*) begin
    if(when_MemoryCore_l136_9) begin
      _zz_banks_1_writeOr_value_valid_19 = io_writes_4_cmd_payload_mask[15 : 8];
    end else begin
      _zz_banks_1_writeOr_value_valid_19 = 8'h0;
    end
  end

  assign io_writes_4_cmd_ready = write_arbiter_4_doIt;
  assign io_writes_4_rsp_valid = write_arbiter_4_doIt_regNext;
  assign io_writes_4_rsp_payload_context = io_writes_4_cmd_payload_context_regNext;
  ...
  assign _zz_banks_0_writeOr_value_valid_20 = ((({{_zz__zz_banks_0_writeOr_value_valid_20,_zz__zz_banks_0_writeOr_value_valid_20_1},_zz_banks_0_writeOr_value_valid} | {{_zz__zz_banks_0_writeOr_value_valid_20_2,_zz__zz_banks_0_writeOr_value_valid_20_3},_zz_banks_0_writeOr_value_valid_4}) | ({{_zz__zz_banks_0_writeOr_value_valid_20_4,_zz__zz_banks_0_writeOr_value_valid_20_5},_zz_banks_0_writeOr_value_valid_8} | {{_zz__zz_banks_0_writeOr_value_valid_20_6,_zz__zz_banks_0_writeOr_value_valid_20_7},_zz_banks_0_writeOr_value_valid_12})) | {{{_zz_banks_0_writeOr_value_valid_19,_zz_banks_0_writeOr_value_valid_18},_zz_banks_0_writeOr_value_valid_17},_zz_banks_0_writeOr_value_valid_16});
  assign banks_0_writeOr_value_valid = _zz_banks_0_writeOr_value_valid_20[0];
  assign _zz_banks_0_writeOr_value_payload_address = _zz_banks_0_writeOr_value_valid_20[84 : 1];
  ...
  assign _zz_banks_1_writeOr_value_valid_20 = ((({{_zz__zz_banks_1_writeOr_value_valid_20,_zz__zz_banks_1_writeOr_value_valid_20_1},_zz_banks_1_writeOr_value_valid} | {{_zz__zz_banks_1_writeOr_value_valid_20_2,_zz__zz_banks_1_writeOr_value_valid_20_3},_zz_banks_1_writeOr_value_valid_4}) | ({{_zz__zz_banks_1_writeOr_value_valid_20_4,_zz__zz_banks_1_writeOr_value_valid_20_5},_zz_banks_1_writeOr_value_valid_8} | {{_zz__zz_banks_1_writeOr_value_valid_20_6,_zz__zz_banks_1_writeOr_value_valid_20_7},_zz_banks_1_writeOr_value_valid_12})) | {{{_zz_banks_1_writeOr_value_valid_19,_zz_banks_1_writeOr_value_valid_18},_zz_banks_1_writeOr_value_valid_17},_zz_banks_1_writeOr_value_valid_16});
  assign banks_1_writeOr_value_valid = _zz_banks_1_writeOr_value_valid_20[0];
  assign _zz_banks_1_writeOr_value_payload_address = _zz_banks_1_writeOr_value_valid_20[84 : 1];
  ...
  always @(posedge clk) begin
    if(io_writes_0_cmd_valid) begin
      ...
      if(io_writes_0_cmd_ready) begin
        write_ports_0_priority_value <= 16'h0;
      end
    end
    if(io_writes_1_cmd_valid) begin
      ...
      if(io_writes_1_cmd_ready) begin
        write_ports_1_priority_value <= 16'h0;
      end
    end
    if(io_writes_2_cmd_valid) begin
      ...
      if(io_writes_2_cmd_ready) begin
        write_ports_2_priority_value <= 16'h0;
      end
    end
    if(io_writes_3_cmd_valid) begin
      write_ports_3_priority_value <= (write_ports_3_priority_value + _zz_write_ports_3_priority_value);
      if(io_writes_3_cmd_ready) begin
        write_ports_3_priority_value <= 16'h0;
      end
    end
    ...
    io_writes_4_cmd_payload_context_regNext <= io_writes_4_cmd_payload_context;
  ...
  always @(posedge clk) begin
    if(reset) begin
      ...
      write_arbiter_4_doIt_regNext <= 1'b0;
      ...
      write_arbiter_4_doIt_regNext <= write_arbiter_4_doIt;
...
module EfxDMA_StreamFifo_1 (
  ...
  reg        [17:0]   logic_ram_spinal_port1;
  ...
  wire       [17:0]   logic_pop_sync_readPort_rsp_context;
  wire                logic_pop_sync_readArbitation_translated_valid;
  wire                logic_pop_sync_readArbitation_translated_ready;
  wire       [17:0]   logic_pop_sync_readArbitation_translated_payload_context;
  ...
  assign logic_pop_sync_readPort_rsp_context = logic_ram_spinal_port1[17 : 0];
