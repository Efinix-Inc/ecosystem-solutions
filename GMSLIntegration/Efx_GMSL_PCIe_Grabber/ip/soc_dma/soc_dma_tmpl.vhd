...
port (
    ...
    dat5_i_clk : in std_logic;
    dat5_i_reset : in std_logic;
    dat4_i_clk : in std_logic;
    dat4_i_reset : in std_logic;
    ...
    dat5_i_tvalid : in std_logic;
    dat5_i_tready : out std_logic;
    dat5_i_tdata : in std_logic_vector(31 downto 0);
    dat5_i_tkeep : in std_logic_vector(3 downto 0);
    dat5_i_tdest : in std_logic_vector(3 downto 0);
    dat5_i_tlast : in std_logic;
    dat4_i_tvalid : in std_logic;
    dat4_i_tready : out std_logic;
    dat4_i_tdata : in std_logic_vector(31 downto 0);
    dat4_i_tkeep : in std_logic_vector(3 downto 0);
    dat4_i_tdest : in std_logic_vector(3 downto 0);
    dat4_i_tlast : in std_logic;
    ...
    sg_cmd_valid : out std_logic;
    sg_cmd_ready : in std_logic;
    sg_cmd_bytesDone : out std_logic_vector(26 downto 0);
    sg_cmd_endOfPacket : out std_logic;
    sg_cmd_completed : out std_logic;
    sg_cmd_read : out std_logic;
    sg_cmd_write : out std_logic;
    sg_rsp_valid : in std_logic;
    sg_rsp_channelId : in std_logic_vector(2 downto 0);
    sg_rsp_srcAddress : in std_logic_vector(31 downto 0);
    sg_rsp_dstAddress : in std_logic_vector(31 downto 0);
    sg_rsp_bytes : in std_logic_vector(25 downto 0);
    sg_rsp_last : in std_logic;
    sg_rsp_stall : in std_logic;
    sg_cmd_channelId : out std_logic_vector(2 downto 0)
);
end component soc_dma;
...
port map (
    ...
    dat5_i_clk => dat5_i_clk,
    dat5_i_reset => dat5_i_reset,
    dat4_i_clk => dat4_i_clk,
    dat4_i_reset => dat4_i_reset,
    ...
    dat5_i_tvalid => dat5_i_tvalid,
    dat5_i_tready => dat5_i_tready,
    dat5_i_tdata => dat5_i_tdata,
    dat5_i_tkeep => dat5_i_tkeep,
    dat5_i_tdest => dat5_i_tdest,
    dat5_i_tlast => dat5_i_tlast,
    dat4_i_tvalid => dat4_i_tvalid,
    dat4_i_tready => dat4_i_tready,
    dat4_i_tdata => dat4_i_tdata,
    dat4_i_tkeep => dat4_i_tkeep,
    dat4_i_tdest => dat4_i_tdest,
    dat4_i_tlast => dat4_i_tlast,
