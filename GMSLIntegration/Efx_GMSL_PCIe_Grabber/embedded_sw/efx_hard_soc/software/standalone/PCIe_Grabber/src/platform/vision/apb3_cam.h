...
#define EXAMPLE_APB3_SLV_REG17_OFFSET  68 //PCIE Board Status
#define EXAMPLE_APB3_SLV_REG18_OFFSET  72 //Master Control Command input A
#define EXAMPLE_APB3_SLV_REG19_OFFSET  76 //Master Control Command Reply A

#define EXAMPLE_APB3_SLV_REG20_OFFSET  80 //Master Control Command input B
#define EXAMPLE_APB3_SLV_REG21_OFFSET  84 //Master Control Command Reply B

#define EXAMPLE_APB3_SLV_REG22_OFFSET  88 //Master Control Command input C
#define EXAMPLE_APB3_SLV_REG23_OFFSET  92 //Master Control Command Reply C
...
void example_register_write(u16 reg, u32 value)
{
	EXAMPLE_APB3_REGW(EXAMPLE_APB3_SLV, reg, value);
