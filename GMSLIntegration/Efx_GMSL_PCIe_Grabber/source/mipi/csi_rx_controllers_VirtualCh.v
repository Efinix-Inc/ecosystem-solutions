...
(
  ...
  // CSI controller ouptut interface port
    output  [NUM_CHANNEL*6-1:0]   rx_datatype,
	...
	output  [NUM_CHANNEL*64-1:0]   rx_out_data_full
...
generate 
	...
	begin:csi_rx
       ...
       csi2_hard_mipi_rx inst_efx_csi2_rx0
        ...
        assign rx_out_data_full[64*x +: 64] = w_rx_data; 
		assign rx_datatype[6*x +: 6] = w_datatype;
